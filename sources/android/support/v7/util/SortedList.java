...
public class SortedList<T> {
        ...
        if (findIndexOf != -1) {
            if (findIndexOf >= this.mSize) {
                ...
                if (!this.mCallback.areItemsTheSame(t2, t)) {
                    i = findIndexOf;
                } else if (!this.mCallback.areContentsTheSame(t2, t)) {
        ...
        while (true) {
            if (this.mOldDataStart < this.mOldDataSize || i2 < i) {
                if (this.mOldDataStart == this.mOldDataSize) {
                    ...
                    int i7 = this.mOldDataSize - this.mOldDataStart;
                    System.arraycopy(this.mOldData, this.mOldDataStart, this.mData, this.mMergedSize, i7);
                    this.mMergedSize = i7 + this.mMergedSize;
                    return;
                }
            } else {
                return;
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        if (i < this.mSize && i >= 0) {
            return (this.mOldData != null && i >= this.mMergedSize) ? this.mOldData[(i - this.mMergedSize) + this.mOldDataStart] : this.mData[i];
        }
