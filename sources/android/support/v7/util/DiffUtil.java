                ...
                if (!z) {
                    ...
                    while (i11 >= i10) {
                        if (!this.mCallback.areItemsTheSame(i4, i11)) {
                            ...
                            if (this.mCallback.areContentsTheSame(i4, i11)) {
                                i6 = 8;
                            }
                            this.mOldItemStatuses[i - 1] = (i11 << 5) | 16;
                            this.mNewItemStatuses[i11] = ((i - 1) << 5) | i6;
                            return true;
                        }
                    }
                    continue;
                    ...
                    while (true) {
                        ...
                        if (i8 < i9) {
                            ...
                            int i12 = !this.mCallback.areContentsTheSame(i8, i4) ? 4 : 8;
                            this.mNewItemStatuses[i4] = (i8 << 5) | 16;
                            this.mOldItemStatuses[i8] = i12 | (i4 << 5);
                            return true;
                        }
                    }
                }
