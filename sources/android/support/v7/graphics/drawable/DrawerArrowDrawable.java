...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float lerp4 = lerp(!z ? -180.0f : 0.0f, !z ? 0.0f : 180.0f, this.mProgress);
        ...
        canvas.translate((float) bounds.centerX(), (strokeWidth * 1.5f) + this.mBarGap + ((float) ((((int) ((((float) bounds.height()) - (3.0f * strokeWidth)) - (this.mBarGap * 2.0f))) / 4) * 2)));
        if (this.mSpin) {
