...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (i >= 0 && i < RecyclerView.this.mState.getItemCount()) {
                ...
                if (RecyclerView.this.mState.isPreLayout() && viewHolder2.isBound()) {
                    ...
                    z4 = (viewHolder2.isBound() && !viewHolder2.needsUpdate() && !viewHolder2.isInvalid()) ? false : tryBindViewHolderByDeadline(viewHolder2, RecyclerView.this.mAdapterHelper.findPositionOffset(i), i, j);
                }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            int i5 = height / 2;
            float distanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (((float) sqrt2) * 1.0f) / ((float) height))) * ((float) i5)) + ((float) i5);
            if (sqrt <= 0) {
                round = (int) (((((float) (!z ? abs2 : abs)) / ((float) height)) + 1.0f) * 300.0f);
            } else {
        ...
        public void run() {
            ...
            if (RecyclerView.this.mLayout != null) {
                ...
                if (overScroller.computeScrollOffset()) {
                    ...
                    if (!RecyclerView.this.dispatchNestedPreScroll(i8, i9, access$500, (int[]) null, 1)) {
                        i = i9;
                        i2 = i8;
                    } else {
                        int i10 = i8 - access$500[0];
                        i = i9 - access$500[1];
                        i2 = i10;
                    }
                    if (RecyclerView.this.mAdapter == null) {
                    ...
                    if (!RecyclerView.this.dispatchNestedScroll(i6, i7, i3, i5, (int[]) null, 1) && !(i3 == 0 && i5 == 0)) {
                        int currVelocity = (int) overScroller.getCurrVelocity();
                        int i16 = 0;
                        if (i3 != currX) {
                            i16 = i3 >= 0 ? i3 <= 0 ? 0 : currVelocity : -currVelocity;
                        }
                        if (i5 == currY) {
                            currVelocity = 0;
                        } else if (i5 < 0) {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        GapWorker.LayoutPrefetchRegistryImpl layoutPrefetchRegistryImpl = null;
        boolean z = true;
        ...
        this.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new GapWorker.LayoutPrefetchRegistryImpl() : layoutPrefetchRegistryImpl;
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        if (!isPreferredNextFocusAbsolute(view, view2, !(z2 ^ z) ? 17 : 66)) {
    ...
    private void recoverFocusFromState() {
        ...
        if (getDescendantFocusability() != 131072 || !isFocused()) {
            ...
            View findNextViewToFocus = (findViewHolderForItemId != null && !this.mChildHelper.isHidden(findViewHolderForItemId.itemView) && findViewHolderForItemId.itemView.hasFocusable()) ? findViewHolderForItemId.itemView : this.mChildHelper.getChildCount() <= 0 ? null : findNextViewToFocus();
            if (findNextViewToFocus != null) {
                if (!(((long) this.mState.mFocusedSubChildId) == -1 || (findViewById = findNextViewToFocus.findViewById(this.mState.mFocusedSubChildId)) == null || !findViewById.isFocusable())) {
    ...
    private void saveFocusInfo() {
        ...
        if (viewHolder != null) {
            this.mState.mFocusedItemId = !this.mAdapter.hasStableIds() ? -1 : viewHolder.getItemId();
            this.mState.mFocusedItemPosition = !this.mDataSetHasChangedAfterLayout ? !viewHolder.isRemoved() ? viewHolder.getAdapterPosition() : viewHolder.mOldPosition : -1;
    ...
    public View focusSearch(View view, int i) {
        ...
        requestChildOnScreen(findNextFocus, (View) null);
        return view;
    }
    ...
    public long getChangedHolderKey(ViewHolder viewHolder) {
        return !this.mAdapter.hasStableIds() ? (long) viewHolder.mPosition : viewHolder.getItemId();
    }
