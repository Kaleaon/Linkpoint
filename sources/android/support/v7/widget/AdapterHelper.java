...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void applyRemove(UpdateOp updateOp) {
        ...
        while (i6 < i5) {
            if (this.mCallback.findViewHolder(i6) == null && !canFindInPreLayout(i6)) {
                if (c != 1) {
                    ...
                    postponeAndUpdateViewHolders(obtainUpdateOp(2, i4, i7, (Object) null));
                    z = true;
                }
                c = 0;
            } else {
                if (c != 0) {
                    ...
                    dispatchAndUpdateViewHolders(obtainUpdateOp(2, i4, i7, (Object) null));
                    z2 = true;
                }
                c = 1;
            }
        ...
        if (i7 != updateOp.itemCount) {
            ...
            updateOp = obtainUpdateOp(2, i4, i7, (Object) null);
        }
        if (c != 0) {
            postponeAndUpdateViewHolders(updateOp);
        } else {
    ...
    public int findPositionOffset(int i, int i2) {
        ...
        while (i2 < size) {
            ...
            if (updateOp.cmd != 8) {
                ...
                } else if (i3 < updateOp.positionStart + updateOp.itemCount) {
                    return -1;
                } else {
                    i3 -= updateOp.itemCount;
                }
