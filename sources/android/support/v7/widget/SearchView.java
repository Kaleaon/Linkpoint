...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        String string = searchableInfo.getVoicePromptTextId() == 0 ? null : resources.getString(searchableInfo.getVoicePromptTextId());
        String string2 = searchableInfo.getVoiceLanguageId() == 0 ? null : resources.getString(searchableInfo.getVoiceLanguageId());
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            this.mSearchSrcTextView.setDropDownHorizontalOffset(!isLayoutRtl ? paddingLeft - (rect.left + i) : -rect.left);
