...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        ViewCompat.setBackground(this, Build.VERSION.SDK_INT < 21 ? new ActionBarBackgroundDrawable(this) : new ActionBarBackgroundDrawableV21(this));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                setMeasuredDimension(getMeasuredWidth(), Math.min((isCollapsed(this.mActionBarView) ? isCollapsed(this.mContextView) ? 0 : getMeasuredHeightWithMargins(this.mContextView) : getMeasuredHeightWithMargins(this.mActionBarView)) + getMeasuredHeightWithMargins(this.mTabContainer), mode != Integer.MIN_VALUE ? Integer.MAX_VALUE : View.MeasureSpec.getSize(i2)));
            }
        }
    }
