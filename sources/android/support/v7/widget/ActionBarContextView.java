    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i5), View.MeasureSpec.makeMeasureSpec(layoutParams.height < 0 ? i4 : Math.min(layoutParams.height, i4), i3));
            }
