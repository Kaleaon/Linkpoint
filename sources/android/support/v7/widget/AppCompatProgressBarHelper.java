...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileify(Drawable drawable, boolean z) {
        if (drawable instanceof DrawableWrapper) {
            ...
            return !z ? shapeDrawable : new ClipDrawable(shapeDrawable, 3, 1);
        }
        return drawable;
    }
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = 0; i < numberOfFrames; i++) {
            ...
            tileify.setLevel(Vr.VREvent.EventType.STREET_VIEW_COLLECTION);
            animationDrawable2.addFrame(tileify, animationDrawable.getDuration(i));
        }
        animationDrawable2.setLevel(Vr.VREvent.EventType.STREET_VIEW_COLLECTION);
