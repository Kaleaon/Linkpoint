...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void endAnimation(RecyclerView.ViewHolder viewHolder) {
        ...
        boolean remove = this.mRemoveAnimations.remove(viewHolder);
        boolean remove2 = this.mAddAnimations.remove(viewHolder);
        boolean remove3 = this.mChangeAnimations.remove(viewHolder);
        boolean remove4 = this.mMoveAnimations.remove(viewHolder);
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                long removeDuration = !z ? 0 : getRemoveDuration();
                long moveDuration = !z2 ? 0 : getMoveDuration();
                if (z3) {
                    j = getChangeDuration();
                }
                ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList3.get(0)).itemView, r10, Math.max(moveDuration, j) + removeDuration);
            }
        }
    }
}
