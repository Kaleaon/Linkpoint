...
public class MenuBuilder implements SupportMenu {
    ...
    public MenuItemImpl findItemWithShortcutForKey(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            char numericShortcut = !isQwertyMode ? menuItemImpl.getNumericShortcut() : menuItemImpl.getAlphabeticShortcut();
            if ((numericShortcut == keyData.meta[0] && (metaState & 2) == 0) || ((numericShortcut == keyData.meta[2] && (metaState & 2) != 0) || (isQwertyMode && numericShortcut == 8 && i == 67))) {
                return menuItemImpl;
            }
        }
        return null;
    ...
    public void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                char numericShortcut = !isQwertyMode ? menuItemImpl.getNumericShortcut() : menuItemImpl.getAlphabeticShortcut();
                if (((modifiers & SupportMenu.SUPPORTED_MODIFIERS_MASK) == ((!isQwertyMode ? menuItemImpl.getNumericModifiers() : menuItemImpl.getAlphabeticModifiers()) & SupportMenu.SUPPORTED_MODIFIERS_MASK)) && numericShortcut != 0 && ((numericShortcut == keyData.meta[0] || numericShortcut == keyData.meta[2] || (isQwertyMode && numericShortcut == 8 && i == 67)) && menuItemImpl.isEnabled())) {
    ...
    public void flagActionItems() {
        ...
        if (this.mIsActionItemsStale) {
            ...
            while (it.hasNext()) {
                ...
                MenuPresenter menuPresenter = (MenuPresenter) next.get();
                if (menuPresenter != null) {
                    z = menuPresenter.flagActionItems() | z2;
                } else {
                    this.mPresenters.remove(next);
                    z = z2;
                }
    ...
    public void saveActionViewStates(Bundle bundle) {
        ...
        if (sparseArray2 != null) {
            bundle.putSparseParcelableArray(getActionViewStatesKey(), sparseArray2);
        }
    }
    ...
    public void setGroupVisible(int i, boolean z) {
        ...
        while (i2 < size) {
            MenuItemImpl menuItemImpl = this.mItems.get(i2);
            i2++;
            z2 = menuItemImpl.getGroupId() != i ? z2 : !menuItemImpl.setVisibleInt(z) ? z2 : true;
        }
        if (z2) {
            onItemsChanged(true);
        }
