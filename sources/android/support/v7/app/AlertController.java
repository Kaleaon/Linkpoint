...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                r0 = this.mCursor == null ? this.mAdapter == null ? new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems) : this.mAdapter : new SimpleCursorAdapter(this.mContext, i, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
            } else if (this.mCursor != null) {
                final AlertController alertController2 = alertController;
                r0 = new CursorAdapter(this.mContext, this.mCursor, false) {
                ...
                r0 = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
    ...
    private int selectContentView() {
        return this.mButtonPanelSideLayout != 0 ? this.mButtonPanelLayoutHint != 1 ? this.mAlertDialogLayout : this.mButtonPanelSideLayout : this.mAlertDialogLayout;
    }
