...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double sin = ((double) f2) + (Math.sin((double) f2) * 0.03341960161924362d) + (Math.sin((double) (2.0f * f2)) * 3.4906598739326E-4d) + (Math.sin((double) (3.0f * f2)) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
        double d3 = (-d2) / 360.0d;
        double sin2 = (Math.sin((double) f2) * 0.0053d) + d3 + ((double) (((float) Math.round(((double) (f - J0)) - d3)) + J0)) + (Math.sin(2.0d * sin) * -0.0069d);
