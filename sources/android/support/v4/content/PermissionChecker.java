...
public final class PermissionChecker {
    ...
    public static int checkCallingOrSelfPermission(@NonNull Context context, @NonNull String str) {
        return checkPermission(context, str, Binder.getCallingPid(), Binder.getCallingUid(), Binder.getCallingPid() != Process.myPid() ? null : context.getPackageName());
    }
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i, int i2, String str2) {
        ...
        return AppOpsManagerCompat.noteProxyOp(context, permissionToOp, str2) == 0 ? 0 : -2;
    }
