...
public final class FingerprintManagerCompat {
    ...
    private static class Api23FingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        ...
        public void authenticate(Context context, CryptoObject cryptoObject, int i, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler) {
            Object obj = null;
            FingerprintManagerCompatApi23.CryptoObject wrapCryptoObject = wrapCryptoObject(cryptoObject);
            if (cancellationSignal != null) {
                obj = cancellationSignal.getCancellationSignalObject();
            }
            FingerprintManagerCompatApi23.authenticate(context, wrapCryptoObject, i, obj, wrapCallback(authenticationCallback), handler);
        }
