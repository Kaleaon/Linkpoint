...
public class AudioAttributesCompat {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mContentType == audioAttributesCompat.getContentType() && this.mFlags == audioAttributesCompat.getFlags() && this.mUsage == audioAttributesCompat.getUsage()) {
            if (this.mLegacyStream == null) {
                if (audioAttributesCompat.mLegacyStream == null) {
                    return true;
                }
            } else if (this.mLegacyStream.equals(audioAttributesCompat.mLegacyStream)) {
                return true;
            }
        }
        return false;
    ...
    public int getContentType() {
        return (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap().getContentType() : this.mContentType;
    }
    ...
    public int getLegacyStreamType() {
        return this.mLegacyStream == null ? (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior) ? AudioAttributesCompatApi21.toLegacyStreamType(this.mAudioAttributesWrapper) : toVolumeStreamType(false, this.mFlags, this.mUsage) : this.mLegacyStream.intValue();
    }

    public int getUsage() {
        return (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap().getUsage() : this.mUsage;
    }
