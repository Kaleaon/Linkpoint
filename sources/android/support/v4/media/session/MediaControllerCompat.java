...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onShuffleModeChangedDeprecated(boolean z) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(10, Boolean.valueOf(z), (Bundle) null);
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(4, parcelableVolumeInfo == null ? null : new PlaybackInfo(parcelableVolumeInfo.volumeType, parcelableVolumeInfo.audioStream, parcelableVolumeInfo.controlType, parcelableVolumeInfo.maxVolume, parcelableVolumeInfo.currentVolume), (Bundle) null);
                }
            }
        }
    ...
    public static void setMediaController(@NonNull Activity activity, MediaControllerCompat mediaControllerCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            MediaControllerCompatApi21.setMediaController(activity, mediaControllerCompat == null ? null : MediaControllerCompatApi21.fromToken(activity, mediaControllerCompat.getSessionToken().getToken()));
        }
    }
