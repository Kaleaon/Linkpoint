...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (!(this.mStopTime < 0)) {
                ...
                if (z) {
                    return (AutoScrollHelper.constrain(((float) (j - this.mStopTime)) / ((float) this.mEffectiveRampDown), 0.0f, 1.0f) * this.mStopValue) + (1.0f - this.mStopValue);
                }
            }
    ...
    public AutoScrollHelper(View view) {
        ...
        setRampUpDuration(TransitionView.TRANSITION_ANIMATION_DURATION_MS);
        setRampDownDuration(TransitionView.TRANSITION_ANIMATION_DURATION_MS);
    }
