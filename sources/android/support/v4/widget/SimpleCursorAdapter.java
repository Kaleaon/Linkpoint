...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (findViewById != null) {
                if (viewBinder == null ? false : viewBinder.setViewValue(findViewById, cursor, iArr[i])) {
                    continue;
                } else {
    ...
    public CharSequence convertToString(Cursor cursor) {
        return this.mCursorToStringConverter == null ? this.mStringConversionColumn <= -1 ? super.convertToString(cursor) : cursor.getString(this.mStringConversionColumn) : this.mCursorToStringConverter.convertToString(cursor);
    }
