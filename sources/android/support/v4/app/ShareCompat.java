...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public int getStreamCount() {
            ...
            return this.mStreams == null ? !this.mIntent.hasExtra("android.intent.extra.STREAM") ? 0 : 1 : this.mStreams.size();
        }
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        ShareActionProvider shareActionProvider = actionProvider instanceof ShareActionProvider ? (ShareActionProvider) actionProvider : new ShareActionProvider(intentBuilder.getActivity());
    ...
    public static ComponentName getCallingActivity(Activity activity) {
        ...
        return callingActivity != null ? callingActivity : (ComponentName) activity.getIntent().getParcelableExtra(EXTRA_CALLING_ACTIVITY);
    }

    public static String getCallingPackage(Activity activity) {
        String callingPackage = activity.getCallingPackage();
        return callingPackage != null ? callingPackage : activity.getIntent().getStringExtra(EXTRA_CALLING_PACKAGE);
    }
}
