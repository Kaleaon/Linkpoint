...
public abstract class JobIntentService extends Service {
    ...
    static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0017, code lost:
            r0.getIntent().setExtrasClassLoader(r3.mService.getClassLoader());
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0029, code lost:
            return new android.support.v4.app.JobIntentService.JobServiceEngineImpl.WrapperWorkItem(r3, r0);
         */
        ...
        public android.support.v4.app.JobIntentService.GenericWorkItem dequeueWork() {
            /*
                ...
                monitor-enter(r1)
                android.app.job.JobParameters r0 = r3.mParams     // Catch:{ all -> 0x0014 }
                if (r0 == 0) goto L_0x0012
                android.app.job.JobParameters r0 = r3.mParams     // Catch:{ all -> 0x0014 }
                android.app.job.JobWorkItem r0 = r0.dequeueWork()     // Catch:{ all -> 0x0014 }
