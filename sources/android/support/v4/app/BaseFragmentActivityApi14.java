...
abstract class BaseFragmentActivityApi14 extends SupportActivity {
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        return dispatchFragmentsOnCreateView != null ? dispatchFragmentsOnCreateView : super.onCreateView(view, str, context, attributeSet);
    }

    public View onCreateView(String str, Context context, AttributeSet attributeSet) {
        View dispatchFragmentsOnCreateView = dispatchFragmentsOnCreateView((View) null, str, context, attributeSet);
        return dispatchFragmentsOnCreateView != null ? dispatchFragmentsOnCreateView : super.onCreateView(str, context, attributeSet);
    }
