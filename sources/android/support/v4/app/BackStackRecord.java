...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    public boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            Op op = this.mOps.get(i2);
            int i3 = op.fragment == null ? 0 : op.fragment.mContainerId;
            if (i3 != 0 && i3 == i) {
                return true;
            }
        }
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i4 < size) {
            ...
            int i5 = op.fragment == null ? 0 : op.fragment.mContainerId;
            if (i5 == 0 || i5 == i3) {
                i5 = i3;
            } else {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        ...
                        if ((op2.fragment == null ? 0 : op2.fragment.mContainerId) == i5) {
                            return true;
                        }
                    }
                }
