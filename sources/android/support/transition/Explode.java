...
public class Explode extends Visibility {
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        float calculateMaxDistance = calculateMaxDistance(view, round - i, height - i2);
        iArr[0] = Math.round(calculateMaxDistance * (centerX / calculateDistance));
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        int i = rect.left;
        int i2 = rect.top;
        return TranslationAnimationCreator.createAnimation(view, transitionValues2, i, i2, translationX + ((float) this.mTempLoc[0]), translationY + ((float) this.mTempLoc[1]), translationX, translationY, sDecelerate);
    }
