...
final class Http2Reader implements Closeable {
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            this.flags = (byte) ((byte) (this.source.readByte() & UnsignedBytes.MAX_VALUE));
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & UnsignedBytes.MAX_VALUE) + 1, z);
    }
