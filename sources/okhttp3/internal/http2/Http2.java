...
public final class Http2 {
    ...
    static String formatFlags(byte b, byte b2) {
        ...
        switch (b) {
            ...
            case 4:
            case 6:
                return b2 != 1 ? BINARY[b2] : "ACK";
            default:
                String str = b2 >= FLAGS.length ? BINARY[b2] : FLAGS[b2];
                return (b == 5 && (b2 & 4) != 0) ? str.replace("HEADERS", "PUSH_PROMISE") : (b == 0 && (b2 & 32) != 0) ? str.replace("PRIORITY", "COMPRESSED") : str;
        }
    }

    static String frameLog(boolean z, int i, int i2, byte b, byte b2) {
        String format = b >= FRAME_NAMES.length ? Util.format("0x%02x", Byte.valueOf(b)) : FRAME_NAMES[b];
