...
public final class Address {
    ...
    public Address(String str, int i, Dns dns2, SocketFactory socketFactory2, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier2, CertificatePinner certificatePinner2, Authenticator authenticator, Proxy proxy2, List<Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector2) {
        this.url = new HttpUrl.Builder().scheme(sSLSocketFactory == null ? "http" : "https").host(str).port(i).build();
        if (dns2 != null) {
            this.dns = dns2;
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = ((this.hostnameVerifier == null ? 0 : this.hostnameVerifier.hashCode()) + (((this.sslSocketFactory == null ? 0 : this.sslSocketFactory.hashCode()) + (((this.proxy == null ? 0 : this.proxy.hashCode()) + ((((((((((((this.url.hashCode() + 527) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31)) * 31)) * 31)) * 31;
