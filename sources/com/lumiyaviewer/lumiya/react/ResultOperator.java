...
public abstract class ResultOperator<K, Tin, Tout> implements ResultHandler<K, Tin> {
    ...
    public ResultOperator(@Nonnull ResultHandler<K, Tout> resultHandler, @Nullable Executor executor2) {
        this.toHandler = resultHandler;
    ...
    public abstract Tout onData(Tin tin);
    ...
    public void onResultError(@Nonnull K k, Throwable th) {
        if (this.executor != null) {
            this.executor.execute(new Runnable(this, k, th) {

                /* renamed from: -$f0 */
                private final /* synthetic */ Object f32$f0;
...
/*
Method generation error in method: com.lumiyaviewer.lumiya.react.-$Lambda$rbwdofHzZNihI1HZoTkj8gWFECo.1.$m$0():void, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.react.-$Lambda$rbwdofHzZNihI1HZoTkj8gWFECo.1.$m$0():void, class status: UNLOADED
...
/*
Method generation error in method: com.lumiyaviewer.lumiya.react.-$Lambda$rbwdofHzZNihI1HZoTkj8gWFECo.1.run():void, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.react.-$Lambda$rbwdofHzZNihI1HZoTkj8gWFECo.1.run():void, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
