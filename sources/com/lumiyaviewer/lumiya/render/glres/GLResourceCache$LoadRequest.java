...
//            GLResourceCache, GLSizedResource, GLLoadQueue

private class this._cls0 extends ResourceRequest
    implements this._cls0, ResourceConsumer
{
    ...
    public int GLLoad(RenderContext rendercontext, ize ize)
    {
        this;
        JVM INSTR monitorenter ;
        Object obj;
...
_L3:
    ...
    public (Object obj, ResourceManager resourcemanager)
    {
