...
public class StreamingMediaService extends Service {
    ...
    private final AudioFocusChangeHandler mHandler = new AudioFocusChangeHandler(this, (AudioFocusChangeHandler) null);
    ...
    private static class AudioFocusChangeHandler extends Handler {
        ...
        private AudioFocusChangeHandler(StreamingMediaService streamingMediaService2) {
            this.streamingMediaService = new WeakReference<>(streamingMediaService2);
        }

        /* synthetic */ AudioFocusChangeHandler(StreamingMediaService streamingMediaService2, AudioFocusChangeHandler audioFocusChangeHandler) {
            this(streamingMediaService2);
        }

        public void handleMessage(Message message) {
            StreamingMediaService streamingMediaService2;
            if (message.what == 100 && (streamingMediaService2 = (StreamingMediaService) this.streamingMediaService.get()) != null) {
                streamingMediaService2.handleAudioFocusChange(message.arg1);
            }
        }
    }
