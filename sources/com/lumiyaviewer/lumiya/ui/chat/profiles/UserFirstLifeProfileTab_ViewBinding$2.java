...
//            UserFirstLifeProfileTab_ViewBinding, UserFirstLifeProfileTab
...
class val.target extends DebouncingOnClickListener
{
    ...
    {
        val$target.onChangePicClicked(view);
    }

    ()
    {
        this$0 = final_userfirstlifeprofiletab_viewbinding;
        val$target = UserFirstLifeProfileTab.this;
        super();
    }
}
