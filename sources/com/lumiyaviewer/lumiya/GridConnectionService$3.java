...
class this._cls0 extends BroadcastReceiver
{
    ...
    {
        if (Strings.nullToEmpty(intent.getData().getSchemeSpecificPart()).equals("com.lumiyaviewer.lumiya.voice") && GridConnectionService._2D_get1() != null && GridConnectionService._2D_get1().getConnectionState() == com.lumiyaviewer.lumiya.slproto.ionState.Connected)
        {
