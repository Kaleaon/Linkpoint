...
//            TestMessage, PacketAck, OpenCircuit, CloseCircuit, 
//            StartPingCheck, CompletePingCheck, AddCircuitCode, UseCircuitCode, 
//            NeighborList, AvatarTextureUpdate, SimulatorMapUpdate, SimulatorSetMap, 
//            SubscribeLoad, UnsubscribeLoad, SimulatorReady, TelehubInfo, 
//            SimulatorPresentAtLocation, SimulatorLoad, SimulatorShutdownRequest, RegionPresenceRequestByRegionID, 
//            RegionPresenceRequestByHandle, RegionPresenceResponse, UpdateSimulator, LogDwellTime, 
//            FeatureDisabled, LogFailedMoneyTransaction, UserReportInternal, SetSimStatusInDatabase, 
//            SetSimPresenceInDatabase, EconomyDataRequest, EconomyData, AvatarPickerRequest, 
//            AvatarPickerRequestBackend, AvatarPickerReply, PlacesQuery, PlacesReply, 
//            DirFindQuery, DirFindQueryBackend, DirPlacesQuery, DirPlacesQueryBackend, 
//            DirPlacesReply, DirPeopleReply, DirEventsReply, DirGroupsReply, 
//            DirClassifiedQuery, DirClassifiedQueryBackend, DirClassifiedReply, AvatarClassifiedReply, 
//            ClassifiedInfoRequest, ClassifiedInfoReply, ClassifiedInfoUpdate, ClassifiedDelete, 
//            ClassifiedGodDelete, DirLandQuery, DirLandQueryBackend, DirLandReply, 
//            DirPopularQuery, DirPopularQueryBackend, DirPopularReply, ParcelInfoRequest, 
//            ParcelInfoReply, ParcelObjectOwnersRequest, ParcelObjectOwnersReply, GroupNoticesListRequest, 
//            GroupNoticesListReply, GroupNoticeRequest, GroupNoticeAdd, TeleportRequest, 
//            TeleportLocationRequest, TeleportLocal, TeleportLandmarkRequest, TeleportProgress, 
//            DataHomeLocationRequest, DataHomeLocationReply, TeleportFinish, StartLure, 
//            TeleportLureRequest, TeleportCancel, TeleportStart, TeleportFailed, 
//            Undo, Redo, UndoLand, AgentPause, 
//            AgentResume, AgentUpdate, ChatFromViewer, AgentThrottle, 
//            AgentFOV, AgentHeightWidth, AgentSetAppearance, AgentAnimation, 
//            AgentRequestSit, AgentSit, AgentQuitCopy, RequestImage, 
//            ImageNotInDatabase, RebakeAvatarTextures, SetAlwaysRun, ObjectAdd, 
//            ObjectDelete, ObjectDuplicate, ObjectDuplicateOnRay, MultipleObjectUpdate, 
//            RequestMultipleObjects, ObjectPosition, ObjectScale, ObjectRotation, 
//            ObjectFlagUpdate, ObjectClickAction, ObjectImage, ObjectMaterial, 
//            ObjectShape, ObjectExtraParams, ObjectOwner, ObjectGroup, 
//            ObjectBuy, BuyObjectInventory, DerezContainer, ObjectPermissions, 
//            ObjectSaleInfo, ObjectName, ObjectDescription, ObjectCategory, 
//            ObjectSelect, ObjectDeselect, ObjectAttach, ObjectDetach, 
//            ObjectDrop, ObjectLink, ObjectDelink, ObjectGrab, 
//            ObjectGrabUpdate, ObjectDeGrab, ObjectSpinStart, ObjectSpinUpdate, 
//            ObjectSpinStop, ObjectExportSelected, ModifyLand, VelocityInterpolateOn, 
//            VelocityInterpolateOff, StateSave, ReportAutosaveCrash, SimWideDeletes, 
//            RequestObjectPropertiesFamily, TrackAgent, ViewerStats, ScriptAnswerYes, 
//            UserReport, AlertMessage, AgentAlertMessage, MeanCollisionAlert, 
//            ViewerFrozenMessage, HealthMessage, ChatFromSimulator, SimStats, 
//            RequestRegionInfo, RegionInfo, GodUpdateRegionInfo, NearestLandingRegionRequest, 
//            NearestLandingRegionReply, NearestLandingRegionUpdated, TeleportLandingStatusChanged, RegionHandshake, 
//            RegionHandshakeReply, CoarseLocationUpdate, ImageData, ImagePacket, 
//            LayerData, ObjectUpdate, ObjectUpdateCompressed, ObjectUpdateCached, 
//            ImprovedTerseObjectUpdate, KillObject, CrossedRegion, SimulatorViewerTimeMessage, 
//            EnableSimulator, DisableSimulator, ConfirmEnableSimulator, TransferRequest, 
//            TransferInfo, TransferPacket, TransferAbort, RequestXfer, 
//            SendXferPacket, ConfirmXferPacket, AbortXfer, AvatarAnimation, 
//            AvatarAppearance, AvatarSitResponse, SetFollowCamProperties, ClearFollowCamProperties, 
//            CameraConstraint, ObjectProperties, ObjectPropertiesFamily, RequestPayPrice, 
//            PayPriceReply, KickUser, KickUserAck, GodKickUser, 
//            SystemKickUser, EjectUser, FreezeUser, AvatarPropertiesRequest, 
//            AvatarPropertiesRequestBackend, AvatarPropertiesReply, AvatarInterestsReply, AvatarGroupsReply, 
//            AvatarPropertiesUpdate, AvatarInterestsUpdate, AvatarNotesReply, AvatarNotesUpdate, 
//            AvatarPicksReply, EventInfoRequest, EventInfoReply, EventNotificationAddRequest, 
//            EventNotificationRemoveRequest, EventGodDelete, PickInfoReply, PickInfoUpdate, 
//            PickDelete, PickGodDelete, ScriptQuestion, ScriptControlChange, 
//            ScriptDialog, ScriptDialogReply, ForceScriptControlRelease, RevokePermissions, 
//            LoadURL, ScriptTeleportRequest, ParcelOverlay, ParcelPropertiesRequest, 
//            ParcelPropertiesRequestByID, ParcelProperties, ParcelPropertiesUpdate, ParcelReturnObjects, 
//            ParcelSetOtherCleanTime, ParcelDisableObjects, ParcelSelectObjects, EstateCovenantRequest, 
//            EstateCovenantReply, ForceObjectSelect, ParcelBuyPass, ParcelDeedToGroup, 
//            ParcelReclaim, ParcelClaim, ParcelJoin, ParcelDivide, 
//            ParcelRelease, ParcelBuy, ParcelGodForceOwner, ParcelAccessListRequest, 
//            ParcelAccessListReply, ParcelAccessListUpdate, ParcelDwellRequest, ParcelDwellReply, 
//            RequestParcelTransfer, UpdateParcel, RemoveParcel, MergeParcel, 
//            LogParcelChanges, CheckParcelSales, ParcelSales, ParcelGodMarkAsContent, 
//            ViewerStartAuction, StartAuction, ConfirmAuctionStart, CompleteAuction, 
//            CancelAuction, CheckParcelAuctions, ParcelAuctions, UUIDNameRequest, 
//            UUIDNameReply, UUIDGroupNameRequest, UUIDGroupNameReply, ChatPass, 
//            EdgeDataPacket, SimStatus, ChildAgentUpdate, ChildAgentAlive, 
//            ChildAgentPositionUpdate, ChildAgentDying, ChildAgentUnknown, AtomicPassObject, 
//            KillChildAgents, GetScriptRunning, ScriptRunningReply, SetScriptRunning, 
//            ScriptReset, ScriptSensorRequest, ScriptSensorReply, CompleteAgentMovement, 
//            AgentMovementComplete, DataServerLogout, LogoutRequest, LogoutReply, 
//            ImprovedInstantMessage, RetrieveInstantMessages, FindAgent, RequestGodlikePowers, 
//            GrantGodlikePowers, GodlikeMessage, EstateOwnerMessage, GenericMessage, 
//            MuteListRequest, UpdateMuteListEntry, RemoveMuteListEntry, CopyInventoryFromNotecard, 
//            UpdateInventoryItem, UpdateCreateInventoryItem, MoveInventoryItem, CopyInventoryItem, 
//            RemoveInventoryItem, ChangeInventoryItemFlags, SaveAssetIntoInventory, CreateInventoryFolder, 
//            UpdateInventoryFolder, MoveInventoryFolder, RemoveInventoryFolder, FetchInventoryDescendents, 
//            InventoryDescendents, FetchInventory, FetchInventoryReply, BulkUpdateInventory, 
//            RequestInventoryAsset, InventoryAssetResponse, RemoveInventoryObjects, PurgeInventoryDescendents, 
//            UpdateTaskInventory, RemoveTaskInventory, MoveTaskInventory, RequestTaskInventory, 
//            ReplyTaskInventory, DeRezObject, DeRezAck, RezObject, 
//            RezObjectFromNotecard, TransferInventory, TransferInventoryAck, AcceptFriendship, 
//            DeclineFriendship, FormFriendship, TerminateFriendship, OfferCallingCard, 
//            AcceptCallingCard, DeclineCallingCard, RezScript, CreateInventoryItem, 
//            CreateLandmarkForEvent, EventLocationRequest, EventLocationReply, RegionHandleRequest, 
//            RegionIDAndHandleReply, MoneyTransferRequest, MoneyTransferBackend, MoneyBalanceRequest, 
//            MoneyBalanceReply, RoutedMoneyBalanceReply, ActivateGestures, DeactivateGestures, 
//            MuteListUpdate, UseCachedMuteList, GrantUserRights, ChangeUserRights, 
//            OnlineNotification, OfflineNotification, SetStartLocationRequest, SetStartLocation, 
//            NetTest, SetCPURatio, SimCrashed, NameValuePair, 
//            RemoveNameValuePair, UpdateAttachment, RemoveAttachment, SoundTrigger, 
//            AttachedSound, AttachedSoundGainChange, PreloadSound, AssetUploadRequest, 
//            AssetUploadComplete, EmailMessageRequest, EmailMessageReply, InternalScriptMail, 
//            ScriptDataRequest, ScriptDataReply, CreateGroupRequest, CreateGroupReply, 
//            UpdateGroupInfo, GroupRoleChanges, JoinGroupRequest, JoinGroupReply, 
//            EjectGroupMemberRequest, EjectGroupMemberReply, LeaveGroupRequest, LeaveGroupReply, 
//            InviteGroupRequest, InviteGroupResponse, GroupProfileRequest, GroupProfileReply, 
//            GroupAccountSummaryRequest, GroupAccountSummaryReply, GroupAccountDetailsRequest, GroupAccountDetailsReply, 
//            GroupAccountTransactionsRequest, GroupAccountTransactionsReply, GroupActiveProposalsRequest, GroupActiveProposalItemReply, 
//            GroupVoteHistoryRequest, GroupVoteHistoryItemReply, StartGroupProposal, GroupProposalBallot, 
//            TallyVotes, GroupMembersRequest, GroupMembersReply, ActivateGroup, 
//            SetGroupContribution, SetGroupAcceptNotices, GroupRoleDataRequest, GroupRoleDataReply, 
//            GroupRoleMembersRequest, GroupRoleMembersReply, GroupTitlesRequest, GroupTitlesReply, 
//            GroupTitleUpdate, GroupRoleUpdate, LiveHelpGroupRequest, LiveHelpGroupReply, 
//            AgentWearablesRequest, AgentWearablesUpdate, AgentIsNowWearing, AgentCachedTexture, 
//            AgentCachedTextureResponse, AgentDataUpdateRequest, AgentDataUpdate, GroupDataUpdate, 
//            AgentGroupDataUpdate, AgentDropGroup, LogTextMessage, ViewerEffect, 
//            CreateTrustedCircuit, DenyTrustedCircuit, RequestTrustedCircuit, RezSingleAttachmentFromInv, 
//            RezMultipleAttachmentsFromInv, DetachAttachmentIntoInv, CreateNewOutfitAttachments, UserInfoRequest, 
//            UserInfoReply, UpdateUserInfo, ParcelRename, InitiateDownload, 
//            SystemMessage, MapLayerRequest, MapLayerReply, MapBlockRequest, 
//            MapNameRequest, MapBlockReply, MapItemRequest, MapItemReply, 
//            SendPostcard, RpcChannelRequest, RpcChannelReply, RpcScriptRequestInbound, 
//            RpcScriptRequestInboundForward, RpcScriptReplyInbound, ScriptMailRegistration, ParcelMediaCommandMessage, 
//            ParcelMediaUpdate, LandStatRequest, LandStatReply, Error, 
//            ObjectIncludeInSearch, RezRestoreToWorld, LinkInventoryItem

public class SLMessageFactory
{

    public SLMessageFactory()
    {
    }
