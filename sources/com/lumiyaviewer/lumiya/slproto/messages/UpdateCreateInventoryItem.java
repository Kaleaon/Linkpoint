...
public class UpdateCreateInventoryItem extends SLMessage
{
    ...
    public int CalcPayloadSize()
    {
        ...
        int i;
        int j;
        for (i = 38; iterator.hasNext(); i = inventorydata.Description.length + (j + 133 + 1) + 4 + 4 + i)
        {
    ...
    public void PackPayload(ByteBuffer bytebuffer)
    {
        ...
        packBoolean(bytebuffer, AgentData_Field.SimApproved);
    ...
    public void UnpackPayload(ByteBuffer bytebuffer)
    {
        ...
        AgentData_Field.SimApproved = unpackBoolean(bytebuffer);
