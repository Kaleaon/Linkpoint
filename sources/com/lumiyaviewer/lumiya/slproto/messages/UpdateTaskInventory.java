...
public class UpdateTaskInventory extends SLMessage
{
    ...
    public UpdateTaskInventory()
    {
        ...
        UpdateData_Field = new UpdateData();
        InventoryData_Field = new InventoryData();
    }

    public int CalcPayloadSize()
    {
        return InventoryData_Field.Name.length + 129 + 1 + InventoryData_Field.Description.length + 4 + 4 + 41;
    }
    ...
    public void PackPayload(ByteBuffer bytebuffer)
    {
        ...
        packByte(bytebuffer, (byte)UpdateData_Field.Key);
    ...
    public void UnpackPayload(ByteBuffer bytebuffer)
    {
        ...
        UpdateData_Field.LocalID = unpackInt(bytebuffer);
        UpdateData_Field.Key = unpackByte(bytebuffer) & 0xff;
