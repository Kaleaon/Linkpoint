...
//            GroupManager, AutoValue_GroupManager_GroupMemberRolesQuery

public static abstract class olesQuery
{

    public static olesQuery create(UUID uuid, UUID uuid1, UUID uuid2)
    {
