...
class istener extends com.lumiyaviewer.lumiya.slproto.tener.SLMessageBaseEventListener
{
    ...
    public void onMessageAcknowledged(SLMessage slmessage)
    {
        ...
        {
            SLUserProfiles._2D_get0(SLUserProfiles.this).getAvatarPickInfos().requestUpdate(new AvatarPickKey(SLUserProfiles._2D_get0(SLUserProfiles.this).getUserID(), val$pickID));
    ...
    cher()
    {
        this$0 = final_sluserprofiles;
        val$pickID = UUID.this;
        super();
    }
}
