...
public final class Floats {
    ...
    private static class FloatArrayAsList extends AbstractList<Float> implements RandomAccess, Serializable {
        ...
        public List<Float> subList(int i, int i2) {
            ...
            return i != i2 ? new FloatArrayAsList(this.array, this.start + i, this.start + i2) : Collections.emptyList();
        }
    ...
    public static List<Float> asList(float... fArr) {
        return fArr.length != 0 ? new FloatArrayAsList(fArr) : Collections.emptyList();
    }
    ...
    public static float[] ensureCapacity(float[] fArr, int i, int i2) {
        ...
        return fArr.length >= i ? fArr : copyOf(fArr, i + i2);
    }
