...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public static <E> ImmutableSortedSet<E> copyOfSorted(SortedSet<E> sortedSet) {
        ...
        return !copyOf.isEmpty() ? new RegularImmutableSortedSet(copyOf, comparator2) : emptySet(comparator2);
    }

    static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator2) {
        return !NATURAL_ORDER.equals(comparator2) ? new RegularImmutableSortedSet<>(ImmutableList.of(), comparator2) : NATURAL_EMPTY_SET;
    }
