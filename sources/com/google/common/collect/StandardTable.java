...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public int size() {
                ...
                while (true) {
                    ...
                    i = !it.next().containsKey(Column.this.columnKey) ? i2 : i2 + 1;
                }
            }
        }
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public V put(C c, V v) {
            ...
            return (this.backingRowMap != null && !this.backingRowMap.isEmpty()) ? this.backingRowMap.put(c, v) : StandardTable.this.put(this.rowKey, c, v);
        }
