...
public class CycleDetectingLockFactory {
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e, boolean z) {
            return this.policy != Policies.DISABLED ? new CycleDetectingReentrantLock(this.lockGraphNodes.get(e), z) : new ReentrantLock(z);
        }
        ...
        public ReentrantReadWriteLock newReentrantReadWriteLock(E e, boolean z) {
            return this.policy != Policies.DISABLED ? new CycleDetectingReentrantReadWriteLock(this.lockGraphNodes.get(e), z) : new ReentrantReadWriteLock(z);
        }
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z) {
        return this.policy != Policies.DISABLED ? new CycleDetectingReentrantLock(new LockGraphNode(str), z) : new ReentrantLock(z);
    }
    ...
    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z) {
        return this.policy != Policies.DISABLED ? new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z) : new ReentrantReadWriteLock(z);
    }
}
