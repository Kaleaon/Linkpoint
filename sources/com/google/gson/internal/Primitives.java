...
public final class Primitives {
    ...
    public static <T> Class<T> unwrap(Class<T> cls) {
        Class<T> cls2 = WRAPPER_TO_PRIMITIVE_TYPE.get(C$Gson$Preconditions.checkNotNull(cls));
        return cls2 != null ? cls2 : cls;
    }

    public static <T> Class<T> wrap(Class<T> cls) {
        Class<T> cls2 = PRIMITIVE_TO_WRAPPER_TYPE.get(C$Gson$Preconditions.checkNotNull(cls));
        return cls2 != null ? cls2 : cls;
    }
}
