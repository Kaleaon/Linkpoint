...
public class AudioManagerWrapper implements InvocationHandler {
    ...
    public AudioManagerWrapper(Context context) {
        ...
        try {
            ...
            mRequestAudioFocus = AudioManager.class.getMethod("requestAudioFocus", new Class[]{cls2, Integer.TYPE, Integer.TYPE});
            mAbandonAudioFocus = AudioManager.class.getMethod("abandonAudioFocus", new Class[]{cls2});
            this.audioFocusHandler = Proxy.newProxyInstance(cls2.getClassLoader(), new Class[]{cls2}, this);
    ...
    public boolean requestAudioFocus() {
        ...
        try {
            return ((Integer) mRequestAudioFocus.invoke(this.audioManager, new Object[]{this.audioFocusHandler, Integer.valueOf(3), Integer.valueOf(1)})).intValue() == 1;
        } catch (Exception e) {
            return true;
        }
    }
