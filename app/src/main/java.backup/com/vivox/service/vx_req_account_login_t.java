...
public class vx_req_account_login_t {
    ...
    protected vx_req_account_login_t(long l, boolean bl) {
        this.swigCMemOwn = bl;
        this.swigCPtr = l;
    }
     ...
     */
    protected static long getCPtr(vx_req_account_login_t vx_req_account_login_t2) {
        if (vx_req_account_login_t2 != null) return vx_req_account_login_t2.swigCPtr;
        return 0L;
    }
    ...
    public vx_req_base_t getBase() {
        long l = VxClientProxyJNI.vx_req_account_login_t_base_get(this.swigCPtr, this);
    ...
    public void setAcct_mgmt_server(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_acct_mgmt_server_set(this.swigCPtr, this, string2);
    }

    public void setAcct_name(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_acct_name_set(this.swigCPtr, this, string2);
    }

    public void setAcct_password(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_acct_password_set(this.swigCPtr, this, string2);
    }

    public void setAnswer_mode(vx_session_answer_mode vx_session_answer_mode2) {
        VxClientProxyJNI.vx_req_account_login_t_answer_mode_set(this.swigCPtr, this, vx_session_answer_mode2.swigValue());
    }

    public void setApplication_override(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_application_override_set(this.swigCPtr, this, string2);
    }

    public void setApplication_token(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_application_token_set(this.swigCPtr, this, string2);
    }

    public void setAutopost_crash_dumps(int n) {
        VxClientProxyJNI.vx_req_account_login_t_autopost_crash_dumps_set(this.swigCPtr, this, n);
    }

    public void setBase(vx_req_base_t vx_req_base_t2) {
        VxClientProxyJNI.vx_req_account_login_t_base_set(this.swigCPtr, this, vx_req_base_t.getCPtr(vx_req_base_t2), vx_req_base_t2);
    }

    public void setBuddy_management_mode(vx_buddy_management_mode vx_buddy_management_mode2) {
        VxClientProxyJNI.vx_req_account_login_t_buddy_management_mode_set(this.swigCPtr, this, vx_buddy_management_mode2.swigValue());
    }

    public void setConnector_handle(String string2) {
        VxClientProxyJNI.vx_req_account_login_t_connector_handle_set(this.swigCPtr, this, string2);
    }

    public void setEnable_buddies_and_presence(int n) {
        VxClientProxyJNI.vx_req_account_login_t_enable_buddies_and_presence_set(this.swigCPtr, this, n);
    }

    public void setEnable_client_ringback(int n) {
        VxClientProxyJNI.vx_req_account_login_t_enable_client_ringback_set(this.swigCPtr, this, n);
    }

    public void setEnable_text(vx_text_mode vx_text_mode2) {
        VxClientProxyJNI.vx_req_account_login_t_enable_text_set(this.swigCPtr, this, vx_text_mode2.swigValue());
    }

    public void setParticipant_property_frequency(int n) {
        VxClientProxyJNI.vx_req_account_login_t_participant_property_frequency_set(this.swigCPtr, this, n);
    }
}
