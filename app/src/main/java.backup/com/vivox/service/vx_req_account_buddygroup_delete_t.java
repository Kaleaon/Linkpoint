...
public class vx_req_account_buddygroup_delete_t {
     ...
     */
    protected static long getCPtr(vx_req_account_buddygroup_delete_t vx_req_account_buddygroup_delete_t2) {
    ...
    public vx_req_base_t getBase() {
        long l = VxClientProxyJNI.vx_req_account_buddygroup_delete_t_base_get(this.swigCPtr, this);
