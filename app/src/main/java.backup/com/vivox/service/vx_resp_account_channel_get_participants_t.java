...
public class vx_resp_account_channel_get_participants_t {
     ...
     */
    protected static long getCPtr(vx_resp_account_channel_get_participants_t vx_resp_account_channel_get_participants_t2) {
    ...
    public vx_resp_base_t getBase() {
        long l = VxClientProxyJNI.vx_resp_account_channel_get_participants_t_base_get(this.swigCPtr, this);
    ...
    public SWIGTYPE_p_p_vx_participant getParticipants() {
        long l = VxClientProxyJNI.vx_resp_account_channel_get_participants_t_participants_get(this.swigCPtr, this);
    ...
    public void setParticipant_count(int n) {
