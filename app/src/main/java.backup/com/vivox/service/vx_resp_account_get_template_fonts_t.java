...
public class vx_resp_account_get_template_fonts_t {
     ...
     */
    protected static long getCPtr(vx_resp_account_get_template_fonts_t vx_resp_account_get_template_fonts_t2) {
    ...
    public vx_resp_base_t getBase() {
        long l = VxClientProxyJNI.vx_resp_account_get_template_fonts_t_base_get(this.swigCPtr, this);
        if (l != 0L) return new vx_resp_base_t(l, false);
        return null;
    }

    public int getTemplate_font_count() {
     ...
     * Lifted jumps to return sites
     */
    public SWIGTYPE_p_p_vx_voice_font getTemplate_fonts() {
        long l = VxClientProxyJNI.vx_resp_account_get_template_fonts_t_template_fonts_get(this.swigCPtr, this);
    ...
    public void setTemplate_font_count(int n) {
        VxClientProxyJNI.vx_resp_account_get_template_fonts_t_template_font_count_set(this.swigCPtr, this, n);
    }

    public void setTemplate_fonts(SWIGTYPE_p_p_vx_voice_font sWIGTYPE_p_p_vx_voice_font) {
