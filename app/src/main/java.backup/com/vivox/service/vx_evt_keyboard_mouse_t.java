...
public class vx_evt_keyboard_mouse_t {
     ...
     */
    protected static long getCPtr(vx_evt_keyboard_mouse_t vx_evt_keyboard_mouse_t2) {
    ...
    public vx_evt_base_t getBase() {
        long l = VxClientProxyJNI.vx_evt_keyboard_mouse_t_base_get(this.swigCPtr, this);
