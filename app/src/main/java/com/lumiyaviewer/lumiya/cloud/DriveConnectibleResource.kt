...
abstract class DriveConnectibleResource {
    ...
    private ResultCallback<? super DriveResource.MetadataResult> onFolderMetadata
    private OnResourceReadyListener onParentFolderReady
    private OnResourceReadyListener onParentFolderReadyForSearch
    private ResultCallback<? super DriveApi.MetadataBufferResult> onQueryResults
    private DriveSynchronizer.OnSyncCompletedListener onSyncCompleted
    @Nullable
    private DriveConnectibleResource parentFolder
    @Nullable
    ...
    /* synthetic */ boolean access$002(DriveConnectibleResource driveConnectibleResource, boolean bl) {
        driveConnectibleResource.needInvalidate = bl
        return bl
    }

    /* synthetic */ boolean access$102(DriveConnectibleResource driveConnectibleResource, boolean bl) {
    ...
    interface OnResourceReadyListener {
        fun onResourceReady(var1: DriveResource, var2: String): Unit
    }
