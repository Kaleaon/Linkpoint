...
class CloudSyncServiceConnection : ServiceConnection {
    ...
    private /* synthetic */ Int[] f229comlumiyaviewerlumiyacloudcommonLogSyncStatus$StatusSwitchesValues = null
    private Int REQUIRED_PLUGIN_VERSION = 1
    ...
    private Handler fromPluginHandler = Handler() {
        ...
        /* synthetic */ Int[] $SWITCH_TABLE$com$lumiyaviewer$lumiya$cloud$common$MessageType
    ...
    private AtomicBoolean syncingStarted = AtomicBoolean(false)
    @Nullable
    ...
    CloudSyncServiceConnection(Context context2, UserManager userManager2) {
    ...
    Boolean checkPluginInstalled(Context context2) {
        ...
        intent.setComponent(ComponentName("com.lumiyaviewer.lumiya.cloud", "com.lumiyaviewer.lumiya.cloud.DriveSyncService"))
        List<ResolveInfo> queryIntentServices = context2.getPackageManager().queryIntentServices(intent, 0)
        return queryIntentServices != null && queryIntentServices.size() > 0
    }

    /* access modifiers changed from: private */
    Unit onLogMessagesCompleted(LogMessagesCompleted logMessagesCompleted) {
    ...
    /* access modifiers changed from: private */
    Unit onLogMessagesFlushed(LogMessagesFlushed logMessagesFlushed) {
    ...
    /* access modifiers changed from: private */
    Unit onLogSyncStatus(LogSyncStatus logSyncStatus) {
        String string
        Debug.Printf("LumiyaCloud: got logSyncStatus %s, plugin version %d", logSyncStatus.status, Int.valueOf(logSyncStatus.pluginVersionCode))
            ...
            switch (m379getcomlumiyaviewerlumiyacloudcommonLogSyncStatus$StatusSwitchesValues()[logSyncStatus.status.ordinal()]) {
                ...
                case 2:
                    ...
                    if (Strings.isNullOrEmpty(logSyncStatus.errorMessage)) {
                        ...
                        string = this.context.getString(R.string.cloud_sync_drive_error_message, Any[]{logSyncStatus.errorMessage})
                    }
    ...
    /* synthetic */ Unit m383lambda$com_lumiyaviewer_lumiya_sync_CloudSyncServiceConnection_8286() {
        Debug.Printf("LumiyaCloud: disconnecting from sync service", Any[0])
        this.context.unbindService(this)
    }

    Unit onServiceConnected(ComponentName componentName, IBinder iBinder) {
        Debug.Printf("LumiyaCloud: service connected", Any[0])
    ...
    Boolean sendMessage(MessageType messageType, Bundleable bundleable) {
        if (this.toPluginMessenger != null) {
    ...
    Unit showSyncingError(String str, String str2, Intent intent) {
