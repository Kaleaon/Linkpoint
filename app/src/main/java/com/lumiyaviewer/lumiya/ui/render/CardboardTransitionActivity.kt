...
class CardboardTransitionActivity : AppCompatActivity {
    ...
    Unit m785com_lumiyaviewer_lumiya_ui_render_CardboardTransitionActivitymthref0() {
        ...
        Debug.Printf("Cardboard: EGL renderer still active.", Any[0])
        this.waitAttempts++
        this.handler.postDelayed(Runnable(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f512$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$4MERJxt3ZMMK7daj1OhYLtxY69Y.1.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$4MERJxt3ZMMK7daj1OhYLtxY69Y.1.$m$0():Unit, class status: UNLOADED
...
*/
    ...
    /* synthetic */ Unit m786lambda$com_lumiyaviewer_lumiya_ui_render_CardboardTransitionActivity_1411() {
