...
class WorldViewActivity : DetailsActivity : View.OnTouchListener, ThemeMapper, ScriptDialogHandler, UnreadNotificationManager.NotifyCapture {
    private Long BUTTONS_FADE_TIMEOUT_MILLIS = 7500
    private String FROM_NOTIFICATION_TAG = "fromNotification"
    private Long OBJECT_DESELECT_TIMEOUT_MILLIS = 6000
    private Int PERMISSION_AUDIO_REQUEST_CODE = 100
    private Float TURNING_SPEED = 50.0f
    ...
    SubscriptionData<UUID, SLAgentCircuit> agentCircuit = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f535$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.3.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.3.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
    ...
    /* access modifiers changed from: private */
    ValueAnimator buttonsFadeAnimator = null
    /* access modifiers changed from: private */
    Runnable buttonsFadeTask = Runnable() {
        Unit run() {
    ...
    /* access modifiers changed from: private */
    Boolean buttonsFadeTimerStarted = false
    ...
    private Any chatEventHandler = Any() {
        ...
        /* synthetic */ Unit m846lambda$com_lumiyaviewer_lumiya_ui_render_WorldViewActivity$1_50098(ActiveChattersManager.ChatMessageEvent chatMessageEvent) {
        ...
        Unit onChatMessage(ActiveChattersManager.ChatMessageEvent chatMessageEvent) {
            WorldViewActivity.this.mHandler.post(Runnable(this, chatMessageEvent) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f532$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f533$f1
...
*/
    ...
    private SubscriptionData<SubscriptionSingleKey, CurrentLocationInfo> currentLocationInfo = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f538$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.6.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.6.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    private GestureDetector.OnGestureListener gestureListener = GestureDetector.SimpleOnGestureListener() {
        ...
        Unit onLongPress(MotionEvent motionEvent) {
    ...
    /* access modifiers changed from: private */
    Float hudScaleFactor = 1.0f
    @BindView(2131755744)
    FrameLayout insetsBackground
    /* access modifiers changed from: private */
    Boolean isDragging = false
    /* access modifiers changed from: private */
    Boolean isInScaling = false
    /* access modifiers changed from: private */
    Boolean isInteracting = false
    private Boolean isSplitScreen
    /* access modifiers changed from: private */
    Long lastActivityTime = SystemClock.uptimeMillis()
    /* access modifiers changed from: private */
    Long lastObjectActivityTime = SystemClock.uptimeMillis()
    private UUID lastTouchUUID = null
    private Boolean localDrawingEnabled = false
    /* access modifiers changed from: private */
    WorldSurfaceView mGLView
    /* access modifiers changed from: private */
    ...
    private SubscriptionData<SubscriptionSingleKey, MyAvatarState> myAvatarState = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f536$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.4.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.4.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    /* access modifiers changed from: private */
    Boolean objectDeselectTimerStarted = false
    /* access modifiers changed from: private */
    Runnable objectDeselectTimerTask = Runnable() {
        Unit run() {
    ...
    /* access modifiers changed from: private */
    Float oldScaleFocusX = Float.NaN
    /* access modifiers changed from: private */
    Float oldScaleFocusY = Float.NaN
    ...
    private ScaleGestureDetector.OnScaleGestureListener scaleGestureListener = ScaleGestureDetector.SimpleOnScaleGestureListener() {
        ...
        Unit onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
    ...
    private SubscriptionData<Int, SLObjectProfileData> selectedObjectProfile = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f537$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.5.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.5.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    private SubscriptionData<SubscriptionSingleKey, ChatterID> voiceActiveChatter = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f539$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.7.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.7.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    /* access modifiers changed from: private */
    SubscriptionData<ChatterID, VoiceChatInfo> voiceChatInfo = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {

        /* renamed from: -$f0 */
        private /* synthetic */ Any f540$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.8.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.render.-$Lambda$YnTWxJEMPymM_sHfAdAKQ7gcDf8.8.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    private class SelectableAttachment {
        ...
        SelectableAttachment(Int i, String str) {
            this.localID = i
    ...
    private Unit displayHUD(Int i) {
        Debug.Printf("Displaying HUD with ID %d", Int.valueOf(i))
    ...
    /* access modifiers changed from: private */
    Unit dragSelectorSetRawPosition(Int i, Int i2) {
        Int[] iArr = Int[2]
    ...
    private Unit enterCardboardView() {
        if (ContextCompat.checkSelfPermission(this, "android.permission.RECORD_AUDIO") != 0) {
            Debug.Printf("Cardboard: audio permission not yet granted", Any[0])
            ActivityCompat.requestPermissions(this, String[]{"android.permission.RECORD_AUDIO"}, 100)
            return
        }
        Debug.Printf("Cardboard: audio permission already granted", Any[0])
    ...
    Unit m836com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref0(SLAgentCircuit sLAgentCircuit) {
    ...
    Unit m839com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref3(CurrentLocationInfo currentLocationInfo2) {
    ...
    Unit m837com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref1(MyAvatarState myAvatarState2) {
        updateObjectPanel()
    }

    /* access modifiers changed from: private */
    /* renamed from: onPickedAvatarNameUpdated */
    Unit m842com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref6(ChatterNameRetriever chatterNameRetriever) {
    ...
    Unit m838com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref2(SLObjectProfileData sLObjectProfileData) {
    ...
    Unit m840com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref4(ChatterID chatterID) {
    ...
    Unit m841com_lumiyaviewer_lumiya_ui_render_WorldViewActivitymthref5(VoiceChatInfo voiceChatInfo2) {
    }

    /* access modifiers changed from: private */
    Unit selectByDragPointer(Int i, Int i2) {
        Int[] iArr = Int[2]
        this.dragPointerLayout.getLocationOnScreen(iArr)
        Int[] iArr2 = Int[2]
    ...
    private Unit selectHUDtoDisplay() {
        ...
        if (data != null) {
            ...
            builder.setAdapter(arrayAdapter, DialogInterface.OnClickListener(this, arrayList) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f530$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f531$f1
...
*/
    ...
    private Unit startFadingButtonsTimer() {
        if (!this.buttonsFadeTimerStarted) {
            Debug.Printf("ButtonsFade: starting timer", Any[0])
    ...
    private Unit updateObjectPanel() {
        ...
        L_0x0047:
            ...
            r9 = 4
            java.lang.Any[] r9 = java.lang.Any[r9]
        ...
        L_0x0234:
            ...
            goto L_0x01f9
        L_0x0237:
            com.lumiyaviewer.lumiya.react.SubscriptionData<java.lang.Int, com.lumiyaviewer.lumiya.slproto.objects.SLObjectProfileData> r0 = r12.selectedObjectProfile
            java.lang.Any r0 = r0.getData()
    ...
    @EventHandler
    Unit handleBakingProgressEvent(SLBakingProgressEvent sLBakingProgressEvent) {
...
*/
                ...
                Debug.Printf("ObjectPick: picked object %d", Int.valueOf(this.pickedObject.localID))
                this.selectedObjectProfile.subscribe(this.userManager.getObjectsManager().getObjectProfile(), Int.valueOf(this.pickedObject.localID))
            }
            updateObjectPanel()
            beginCountingObjectDeselect()
        } else {
    ...
    /* synthetic */ Unit m843lambda$com_lumiyaviewer_lumiya_ui_render_WorldViewActivity_10269(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ Unit m844lambda$com_lumiyaviewer_lumiya_ui_render_WorldViewActivity_43183(DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m845lambda$com_lumiyaviewer_lumiya_ui_render_WorldViewActivity_48476(List list, DialogInterface dialogInterface, Int i) {
        if (i >= 0 && i < list.size()) {
    ...
    Unit moveTouchEvent(Int i, MotionEvent motionEvent) {
        Float f = 1.0f
        Float f2 = -1.0f
        if (this.avatarControl == null) {
            return
...
*/
    ...
    Intent onGetNotifyCaptureIntent(@Nonnull UnreadNotificationInfo unreadNotificationInfo, Intent intent) {
        Debug.Printf("NotifyCapture: returning intent", Any[0])
    ...
    Unit onObjectPayButton() {
        ...
        if (this.pickedObject != null) {
            ...
            if (this.pickedObject.saleType != 0) {
                AlertDialog.Builder builder = AlertDialog.Builder(this)
                builder.setMessage((CharSequence) String.format(getString(R.string.object_buy_confirm), Any[]{name, Int.valueOf(this.pickedObject.salePrice)})).setCancelable(false).setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this) {

                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f534$f0
...
*/
    ...
    Unit onPause() {
        Debug.Printf("WorldViewActivity: onPause", Any[0])
        if (this.userManager != null) {
    ...
    Unit onRequestPermissionsResult(Int i, @Nonnull String[] strArr, @Nonnull Int[] iArr) {
        Debug.Printf("Cardboard: onRequestPermissionResult, code %d", Int.valueOf(i))
        if (i == 100) {
            startCardboardActivity()
        }
    }
    ...
    Unit onResume() {
        super.onResume()
        Debug.Printf("WorldViewActivity: onResume", Any[0])
    ...
    Unit onUserInteraction() {
        ...
        Debug.Printf("ButtonsFade: some user interaction", Any[0])
        this.mHandler.post(this.buttonsRestoreTask)
        beginCountingButtonsFade()
        beginCountingObjectDeselect()
    }

    Unit processScreenshot(Bitmap bitmap) {
        try {
            File file = File(getCacheDir(), "screenshots")
            file.mkdirs()
            File file2 = File(file, "Lumiya-" + SimpleDateFormat("yyyy-MM-dd-HHmmss", Locale.US).format(Date()) + ".jpg")
            ...
            String string = agentSLURL != null ? getString(R.string.screenshot_taken_slurl, Any[]{agentSLURL}) : getString(R.string.screenshot_taken_lumiya)
    ...
    Unit rendererAdvancedRenderingChanged() {
    ...
    Unit rendererShaderCompileError() {
    ...
    Unit setTouchedObject(SLObjectInfo sLObjectInfo) {
