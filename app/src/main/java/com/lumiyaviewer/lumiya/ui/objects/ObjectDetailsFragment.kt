...
class ObjectDetailsFragment : FragmentWithTitle : ReloadableFragment, View.OnClickListener, LoadableMonitor.OnLoadableDataChangedListener {
    private String LOCAL_ID_KEY = "localID"
    private Int[] objectPayButtons = {R.id.object_pay_button1, R.id.object_pay_button2, R.id.object_pay_button3, R.id.object_pay_button4}
    private SubscriptionData<SubscriptionSingleKey, Int> balanceSubscription = SubscriptionData<>(UIThreadExecutor.getInstance())
    private OnChatEventListener chatEventListener = OnChatEventListener(this) {

        /* renamed from: -$f0 */
        private /* synthetic */ Any f474$f0
...
*/
    ...
    private SubscriptionData<Int, SLObjectProfileData> objectProfile = SubscriptionData<>(UIThreadExecutor.getInstance())
    @Nullable
    ...
    private Unit buyObject() {
        ...
        if (sLObjectProfileData != null && userManager != null) {
            ...
            builder.setMessage((CharSequence) String.format(getString(R.string.object_buy_confirm), Any[]{sLObjectProfileData.name().or(getString(R.string.object_name_loading)), Int.valueOf(sLObjectProfileData.salePrice())})).setCancelable(false).setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(i, userManager, sLObjectProfileData) {

                /* renamed from: -$f0 */
                private /* synthetic */ Int f478$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f479$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f480$f2
...
*/
    ...
    /* synthetic */ Unit m669lambda$com_lumiyaviewer_lumiya_ui_objects_ObjectDetailsFragment_11291(SLAgentCircuit sLAgentCircuit, SLObjectProfileData sLObjectProfileData, String str, DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m671lambda$com_lumiyaviewer_lumiya_ui_objects_ObjectDetailsFragment_24012(UserManager userManager, Int i, SLObjectProfileData sLObjectProfileData, DialogInterface dialogInterface, Int i2) {
    ...
    /* synthetic */ Unit m673lambda$com_lumiyaviewer_lumiya_ui_objects_ObjectDetailsFragment_25106(UserManager userManager, SLObjectProfileData sLObjectProfileData, Int i, DialogInterface dialogInterface, Int i2) {
        SLModules modules
        SLAgentCircuit activeAgentCircuit = userManager.getActiveAgentCircuit()
    ...
    private Unit payObject(Int i) {
        ...
        if (sLObjectProfileData != null && userManager != null) {
            AlertDialog.Builder builder = AlertDialog.Builder(getActivity())
            builder.setMessage((CharSequence) String.format(getString(R.string.object_pay_confirm), Any[]{sLObjectProfileData.name().or(getString(R.string.object_name_loading)), Int.valueOf(i)})).setCancelable(false).setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(i, userManager, sLObjectProfileData) {

                /* renamed from: -$f0 */
                private /* synthetic */ Int f481$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f482$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f483$f2
...
*/
    ...
    private Unit payObjectQuick(Int i) {
        ...
        Int intValue
        if (this.objectProfileData != null && (payInfo = this.objectProfileData.payInfo()) != null && (payPrices = payInfo.payPrices()) != null && i >= 0 && i < payPrices.size() && (intValue = ((Int) payPrices.get(i)).intValue()) != 0) {
            payObject(intValue)
        }
    }
    ...
    private Unit showObject(Int i) {
        ...
        UserManager userManager = getUserManager()
        if (userManager != null) {
            this.objectProfile.subscribe(userManager.getObjectsManager().getObjectProfile(), Int.valueOf(i))
    ...
    private Unit showObjectProfile(SLObjectProfileData sLObjectProfileData) {
        ...
        if (view != null) {
            ...
            if (sLObjectProfileData.isDead()) {
                ...
                ((TextView) view.findViewById(R.id.object_buy_details)).setText(getString(R.string.object_buy_price_format, Int.valueOf(sLObjectProfileData.salePrice())))
                Int data2 = this.balanceSubscription.getData()
                if (data2 != null) {
                ...
                if (payInfo != null) {
                    ...
                    if (payPrices != null) {
                        ...
                        while (i < objectPayButtons.length && i < payPrices.size()) {
                            Int intValue = ((Int) payPrices.get(i)).intValue()
                            ...
                            if (defaultPayPrice <= 0) {
                                ...
                                ((Button) view.findViewById(objectPayButtons[i])).setText(String.format(getString(R.string.pay_button_format), Any[]{Int.valueOf(defaultPayPrice)}))
                                view.findViewById(objectPayButtons[i]).setVisibility(0)
                                view.findViewById(objectPayButtons[i]).setTag(R.id.object_pay_price_tag, Int.valueOf(defaultPayPrice))
                                i2++
                            }
                            i++
                        }
                    ...
                    if (payInfo.defaultPayPrice() != -1) {
                        if (((EditText) view.findViewById(R.id.object_pay_amount)).getText().toString().equals("")) {
                            if (payInfo.defaultPayPrice() > 0) {
                                ((EditText) view.findViewById(R.id.object_pay_amount)).setText(getString(R.string.object_pay_amount_format, Int.valueOf(payInfo.defaultPayPrice())))
                            } else {
    ...
    /* synthetic */ Unit m675lambda$com_lumiyaviewer_lumiya_ui_objects_ObjectDetailsFragment_6633(SLChatEvent sLChatEvent) {
        ...
        switch (id) {
            ...
            case R.id.object_pay_button:
                try {
                    View view2 = getView()
                    if (view2 != null) {
                        payObject(Int.parseInt(((EditText) view2.findViewById(R.id.object_pay_amount)).getText().toString()))
                        return
                    }
                    return
                } catch (Exception e) {
    ...
    View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((EditText) inflate.findViewById(R.id.object_pay_amount)).addTextChangedListener(TextWatcher() {
            Unit afterTextChanged(Editable editable) {
                try {
                    Int.parseInt(editable.toString())
                ...
                case R.id.item_object_block:
                    ...
                    if (!(activeAgentCircuit == null || data == null || str == null)) {
                        ...
                        builder.setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(activeAgentCircuit, data, str) {
                            ...
                            /* renamed from: -$f0 */
                            private /* synthetic */ Any f475$f0

                            /* renamed from: -$f1 */
                            private /* synthetic */ Any f476$f1

                            /* renamed from: -$f2 */
                            private /* synthetic */ Any f477$f2
