...
class GroupMainProfileTab : ChatterReloadableFragment : LoadableMonitor.OnLoadableDataChangedListener {
    private SubscriptionData<UUID, SLAgentCircuit> agentCircuit = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f315$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.12.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.12.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
    ...
    private LoadableMonitor loadableMonitor = LoadableMonitor(this.groupProfile, this.myGroupList, this.agentDataUpdate, this.groupRoles).withDataChangedListener(this).withOptionalLoadables(this.groupTitles)
    private SubscriptionData<UUID, AvatarGroupList> myGroupList = SubscriptionData<>(UIThreadExecutor.getInstance())
    private ChatterNameRetriever.OnChatterNameUpdated onFounderNameReady = ChatterNameRetriever.OnChatterNameUpdated(this) {

        /* renamed from: -$f0 */
        private /* synthetic */ Any f316$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.13.$m$0(com.lumiyaviewer.lumiya.slproto.users.ChatterNameRetriever):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.13.$m$0(com.lumiyaviewer.lumiya.slproto.users.ChatterNameRetriever):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m440com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref3(View view) {
        try {
    ...
    Unit m437com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref0(SLAgentCircuit sLAgentCircuit) {
        View view = getView()
        if (view != null) {
    ...
    Unit m442com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref5(View view) {
        Int i = 0
        try {
            ...
            builder.setTitle((Int) R.string.select_group_role_title).setSingleChoiceItems(charSequenceArr, i2, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(atomicInteger) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f326$f0

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.2.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.2.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f323$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f324$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f325$f2

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.17.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.17.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m443com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref6(View view) {
        try {
            this.agentCircuit.assertHasData()
            ...
            if (avatarGroupEntry != null) {
                ...
                ((EditText) inflate.findViewById(R.id.land_contribution_value)).setText(getString(R.string.generic_int_format, Int.valueOf(avatarGroupEntry.Contribution)))
                builder.setPositiveButton((Int) R.string.set_land_contribution_ok_button, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, inflate) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f317$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Any f318$f1

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.14.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.14.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m439com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref2(View view) {
    ...
    Unit m446com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref9(android.view.View r9) {
        /*
            r8 = this
            ...
            java.lang.Any r0 = r0.get()     // Catch:{ DataNotReadyException -> 0x0067 }
            ...
            java.lang.Any r0 = r0.get(r1)     // Catch:{ DataNotReadyException -> 0x0067 }
            ...
            java.lang.Any r2 = r2.get()     // Catch:{ DataNotReadyException -> 0x0067 }
            ...
            java.lang.Any r3 = r3.get()     // Catch:{ DataNotReadyException -> 0x0067 }
            ...
            java.lang.Any r4 = r4.get()     // Catch:{ DataNotReadyException -> 0x0067 }
            ...
            java.lang.Any r5 = r5.get()     // Catch:{ DataNotReadyException -> 0x0067 }
        ...
        L_0x0067:
            ...
            goto L_0x0066
        */
        throw UnsupportedOperationException("Method not decompiled: com.lumiyaviewer.lumiya.ui.chat.profiles.GroupMainProfileTab.m446com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref9(android.view.View):Unit")
    }

    /* access modifiers changed from: private */
    /* renamed from: onJoinClicked */
    Unit m444com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref7(View view) {
        try {
            this.agentCircuit.assertHasData()
            UUID uuid = this.groupProfile.get().GroupData_Field.GroupID
            if (this.myGroupList.get().Groups.get(uuid) == null) {
                ...
                if (this.groupProfile.get().GroupData_Field.MembershipFee == 0) {
                    ...
                    builder.setMessage((CharSequence) getString(R.string.join_group_question_message_not_free, Int.valueOf(this.groupProfile.get().GroupData_Field.MembershipFee)))
                }
                builder.setPositiveButton((Int) R.string.yes_join_button, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, uuid) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f319$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Any f320$f1

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.15.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.15.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m445com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref8(View view) {
        try {
            this.agentCircuit.assertHasData()
            UUID uuid = this.groupProfile.get().GroupData_Field.GroupID
            if (this.myGroupList.get().Groups.get(uuid) != null) {
                ...
                builder.setPositiveButton((Int) R.string.yes_leave_button, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, uuid) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f321$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Any f322$f1

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.16.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.16.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m441com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref4(View view) {
        try {
            AvatarGroupList.AvatarGroupEntry avatarGroupEntry = this.myGroupList.get().Groups.get(this.groupProfile.get().GroupData_Field.GroupID)
            if (avatarGroupEntry != null) {
    ...
    Unit m438com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTabmthref1(View view) {
        UUID uuid
    ...
    /* synthetic */ Unit m447lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTab_11438(AtomicInteger atomicInteger, UUID uuid, DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m448lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTab_21725(ChatterNameRetriever chatterNameRetriever) {
        View view = getView()
        if (view != null) {
    ...
    /* synthetic */ Unit m449lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTab_6577(UUID uuid, DialogInterface dialogInterface, Int i) {
        try {
    ...
    /* synthetic */ Unit m450lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTab_8098(UUID uuid, DialogInterface dialogInterface, Int i) {
        try {
    ...
    /* synthetic */ Unit m451lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMainProfileTab_9645(View view, DialogInterface dialogInterface, Int i) {
        try {
            this.agentCircuit.get().getModules().groupManager.SetGroupContribution(this.groupProfile.get().GroupData_Field.GroupID, Int.parseInt(((EditText) view.findViewById(R.id.land_contribution_value)).getText().toString()))
        } catch (Exception e) {
            Debug.Warning(e)
        }
    }
    ...
    View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        inflate.findViewById(R.id.group_profile_view_founder_button).setOnClickListener(View.OnClickListener(this) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f327$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.3.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.3.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.button_copy_group_key).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f328$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.4.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.4.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.active_group_checkbox).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f329$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.5.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.5.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.show_in_profile_checkbox).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f330$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.6.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.6.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.group_change_role_button).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f331$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.7.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.7.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.group_profile_contribution_button).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f332$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.8.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.8.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.group_join_button).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f333$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.9.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.9.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.group_leave_button).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f313$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.10.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.10.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
        ...
        inflate.findViewById(R.id.group_invite_button).setOnClickListener(View.OnClickListener(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f314$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.11.$m$0(android.view.View):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$qgA5NpRVpRFsQYZFFPT9VQYjWms.11.$m$0(android.view.View):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
    ...
    Unit onLoadableDataChanged() {
        ...
        try {
            ...
            if (view != null) {
                ...
                ((TextView) view.findViewById(R.id.text_profile_member_count)).setText(getString(R.string.group_member_count_format, Int.valueOf(this.groupProfile.get().GroupData_Field.GroupMembershipCount)))
                ((TextView) view.findViewById(R.id.text_profile_join_fee)).setText(this.groupProfile.get().GroupData_Field.MembershipFee == 0 ? getString(R.string.group_free_to_join) : getString(R.string.group_join_fee_format, Int.valueOf(this.groupProfile.get().GroupData_Field.MembershipFee)))
                ...
                if (uuid == null || !(!uuid.equals(UUIDPool.ZeroUUID)) || this.chatterID == null) {
                    ...
                    ((ChatterPicView) view.findViewById(R.id.group_founder_pic)).setChatterID((ChatterID) null, (String) null)
                } else {
                    ...
                    this.founderNameRetriever = ChatterNameRetriever(userChatterID, this.onFounderNameReady, UIThreadExecutor.getInstance())
                }
                if (avatarGroupEntry != null) {
                    ...
                    ((TextView) view.findViewById(R.id.land_contribution_text)).setText(avatarGroupEntry.Contribution != 0 ? getString(R.string.format_land_contribution, Int.valueOf(avatarGroupEntry.Contribution)) : getString(R.string.no_land_contributed))
