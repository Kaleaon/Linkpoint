...
abstract class TextFieldEditFragment : ChatterFragment : BackButtonHandler {
    ...
    abstract String getFieldHint(Context context)
    ...
    /* synthetic */ Unit m557lambda$com_lumiyaviewer_lumiya_ui_common_TextFieldEditFragment_4960(String str, DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m558lambda$com_lumiyaviewer_lumiya_ui_common_TextFieldEditFragment_5518(DialogInterface dialogInterface, Int i) {
    ...
    Boolean onBackButtonPressed() {
        ...
        builder.setMessage(getString(R.string.save_changes_question)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(this, charSequence) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f344$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f345$f1
            ...
            case R.id.item_undo:
                ...
                if (view != null && !Objects.equal(((TextView) view.findViewById(R.id.field_edit_text)).getText().toString(), this.originalText)) {
                    ...
                    builder.setMessage(getString(R.string.discard_changes_question)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(this, view) {
                        ...
                        /* renamed from: -$f0 */
                        private /* synthetic */ Any f346$f0

                        /* renamed from: -$f1 */
                        private /* synthetic */ Any f347$f1
