...
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.2.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.2.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
    ...
    private class GroupMemberListRecyclerAdapter : RecyclerView.Adapter<GroupMemberViewHolder> {
        ...
        Unit onBindViewHolder(GroupMemberViewHolder groupMemberViewHolder, Int i) {
            Boolean z = false
        ...
        GroupMemberViewHolder onCreateViewHolder(ViewGroup viewGroup, Int i) {
        ...
        Unit onViewRecycled(GroupMemberViewHolder groupMemberViewHolder) {
            groupMemberViewHolder.recycle()
        }

        Unit setData(LazyList<GroupMember> lazyList) {
            this.data = lazyList
            this.selectedPosition = -1
            notifyDataSetChanged()
        }

        Unit setSelectedPosition(Int i) {
            if (i != this.selectedPosition) {
    ...
    private class GroupMemberViewHolder : RecyclerView.ViewHolder : ChatterNameRetriever.OnChatterNameUpdated, View.OnClickListener {
        ...
        Unit bindToData(GroupMember groupMember, Boolean z) {
            Int i = 0
            String str = null
        ...
        Unit onChatterNameUpdated(ChatterNameRetriever chatterNameRetriever2) {
...
*/
    ...
    Unit m473com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMembersProfileTabmthref0(UUID uuid) {
