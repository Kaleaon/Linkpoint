    ...
    private Subscription.OnError onObjectListError = Subscription.OnError(this) {
...

        {
            /*
                ...
                return
            */
            throw UnsupportedOperationException("Method not decompiled: com.lumiyaviewer.lumiya.ui.objects.$Lambda$rXtKRyOts6GGB3GxWNYA5oEvU2Y.AnonymousClass1.<init>(java.lang.Any):Unit")
        }
