...
class ImageAssetView : View {
    ...
    private Rect bitmapDestRect = Rect()
    ...
    private class LoadAssetImageTask : AsyncTask<UUID, Void, Bitmap> : ResourceConsumer {
        ...
        private Any textureReady

        private LoadAssetImageTask() {
            this.textureReady = Any()
        }
    ...
    ImageAssetView(Context context) {
        super(context)
    }

    ImageAssetView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet)
    }

    ImageAssetView(Context context, AttributeSet attributeSet, Int i) {
    ...
    Unit onMeasure(Int i, Int i2) {
        ...
        if (this.verticalFit && this.imageBitmap != null && size != Int.MAX_VALUE && size > 0) {
