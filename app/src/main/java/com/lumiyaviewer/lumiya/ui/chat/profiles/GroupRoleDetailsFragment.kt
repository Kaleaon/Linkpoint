...
class GroupRoleDetailsFragment : ChatterFragment : LoadableMonitor.OnLoadableDataChangedListener, BackButtonHandler {
    ...
    private View.OnClickListener permCheckboxClickListener = View.OnClickListener(this) {

        /* renamed from: -$f0 */
        private /* synthetic */ Any f290$f0
    ...
    private Unit askForSavingChanges(Runnable runnable) {
        ...
        if (view != null) {
            ...
            builder.setMessage(getString(R.string.save_changes_question)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(selectedPowers, this, charSequence, charSequence2, charSequence3, runnable) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Long f293$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f294$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f295$f2

                /* renamed from: -$f3 */
                private /* synthetic */ Any f296$f3

                /* renamed from: -$f4 */
                private /* synthetic */ Any f297$f4

                /* renamed from: -$f5 */
                private /* synthetic */ Any f298$f5
...
*/
    ...
    /* synthetic */ Unit m485lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupRoleDetailsFragment_26404(Runnable runnable, DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m490lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupRoleDetailsFragment_9928(View view) {
        if (this.RoleID == null) {
            return
        }
