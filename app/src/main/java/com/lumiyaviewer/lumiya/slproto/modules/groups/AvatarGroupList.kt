...
class AvatarGroupList : Serializable {
    ...
    class AvatarGroupEntry : Serializable {
        ...
        AvatarGroupEntry(AgentGroupDataUpdate.GroupData groupData) {
        ...
        AvatarGroupEntry(AvatarGroupsReply.GroupData groupData, @Nullable AvatarGroupsReply.NewGroupData newGroupData) {
            this.GroupName = SLMessage.stringFromVariableOEM(groupData.GroupName)
        ...
        AvatarGroupEntry(AgentGroupDataInfo.GroupDataEntry groupDataEntry, AgentGroupDataInfo.NewGroupDataEntry newGroupDataEntry) {
    ...
    AvatarGroupList(AgentGroupDataUpdate agentGroupDataUpdate) {
    ...
    AvatarGroupList(AvatarGroupsReply avatarGroupsReply) {
