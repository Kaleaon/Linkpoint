...
class SLInventory : SLModule {
    ...
    String fetchCap
    /* access modifiers changed from: private */
    AtomicBoolean fetchEntireInventoryRequested = AtomicBoolean(false)
    /* access modifiers changed from: private */
    Map<UUID, SLInventoryFetchRequest> fetchRequests = ConcurrentHashMap()
    private ResultHandler<UUID, SLInventoryEntry> folderEntryResultHandler
    private RequestHandler<UUID> folderLoadingRequestHandler = SimpleRequestHandler<UUID>() {
        Unit onRequest(@Nonnull UUID uuid) {
            SLInventory.this.updateFolderLoadingStatus(uuid)
        }
    }
    private ResultHandler<UUID, Boolean> folderLoadingResultHandler
    private RequestHandler<UUID> folderRequestHandler = RequestHandler<UUID>() {
        Unit onRequest(@Nonnull UUID uuid) {
            try {
        ...
        Unit onRequestCancelled(@Nonnull UUID uuid) {
    ...
    private SubscriptionData<UUID, SLInventoryEntry> nextFolderSubscription
    ...
    SLInventoryEntry rootFolder = null
    private Boolean rootFolderFetchNeeded = false
    private SubscriptionData<UUID, SLInventoryEntry> rootFolderSubscription
    private ResultHandler<SubscriptionSingleKey, Boolean> seachRunningResultHandler
    private ResultHandler<SubscriptionSingleKey, Boolean> searchProcessResultHandler
    private RequestHandler<SubscriptionSingleKey> searchRequestHandler = RequestHandler<SubscriptionSingleKey>() {
    ...
    private RequestHandler<SubscriptionSingleKey> searchRunningRequestHandler = SimpleRequestHandler<SubscriptionSingleKey>() {
        Unit onRequest(@Nonnull SubscriptionSingleKey subscriptionSingleKey) {
            SLInventory.this.updateSearchRunningStatus()
        }
    }
    ...
    class InventoryFetchException : IOException {
        InventoryFetchException(String str) {
            super(str)
        }
    }
    ...
    class NoInventoryItemException : Exception {
        ...
        NoInventoryItemException(Long j) {
            super("Inventory item " + j + " not found")
        }

        NoInventoryItemException(UUID uuid) {
    ...
    interface OnNotecardUpdatedListener {
        Unit onNotecardUpdated(SLInventoryEntry sLInventoryEntry, @Nullable String str)
    }

    SLInventory(SLAgentCircuit sLAgentCircuit, SLCaps sLCaps) {
        ...
        if (this.userManager != null) {
            ...
            this.nextFolderSubscription = SubscriptionData<>(this.dbExecutor, $Lambda$eCHTl_kh2tUCaOJO9NRHJvhjs(this), Subscription.OnError(this) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Object f82$f0
...
*/
            ...
            if (this.rootFolderFetchNeeded) {
                this.rootFolderSubscription = SubscriptionData<>(this.dbExecutor, Subscription.OnData(this) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Object f76$f0
...
*/
    ...
    private Unit DoUpdateInventoryItem(SLInventoryEntry sLInventoryEntry, OnInventoryCallbackListener onInventoryCallbackListener) {
    ...
    /* access modifiers changed from: private */
    Unit MoveTaskInventory(UUID uuid, Int i, UUID uuid2) {
    ...
    /* access modifiers changed from: private */
    Unit StartUploadingNotecardContents(SLInventoryEntry sLInventoryEntry, @Nullable UUID uuid, Boolean z, byte[] bArr, OnNotecardUpdatedListener onNotecardUpdatedListener) {
        GenericHTTPExecutor.getInstance().execute(Runnable(z, this, sLInventoryEntry, bArr, uuid, onNotecardUpdatedListener) {

            /* renamed from: -$f0 */
            private /* synthetic */ Boolean f105$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Object f106$f1

            /* renamed from: -$f2 */
            private /* synthetic */ Object f107$f2

            /* renamed from: -$f3 */
            private /* synthetic */ Object f108$f3

            /* renamed from: -$f4 */
            private /* synthetic */ Object f109$f4

            /* renamed from: -$f5 */
            private /* synthetic */ Object f110$f5
...
*/
    ...
    Unit m175com_lumiyaviewer_lumiya_slproto_inventory_SLInventorymthref1(Throwable th) {
        fetchNextFolder()
    }

    /* access modifiers changed from: private */
    /* renamed from: onNextFolderFetched */
    Unit m174com_lumiyaviewer_lumiya_slproto_inventory_SLInventorymthref0(SLInventoryEntry sLInventoryEntry) {
    ...
    Unit m176com_lumiyaviewer_lumiya_slproto_inventory_SLInventorymthref2(SLInventoryEntry sLInventoryEntry) {
    ...
    /* access modifiers changed from: private */
    Unit updateFolderLoadingStatus(@Nonnull UUID uuid) {
    ...
    /* access modifiers changed from: private */
    Unit updateSearchRunningStatus() {
    ...
    Collection<SLInventoryEntry> CollectGiveableItems(SLInventoryEntry sLInventoryEntry) {
    ...
    Unit CopyInventoryFromNotecard(UUID uuid, UUID uuid2, UUID uuid3, @Nullable Runnable runnable) {
        GenericHTTPExecutor.getInstance().execute(Runnable(this, uuid, uuid2, uuid3, runnable) {

            /* renamed from: -$f0 */
            private /* synthetic */ Object f87$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Object f88$f1

            /* renamed from: -$f2 */
            private /* synthetic */ Object f89$f2

            /* renamed from: -$f3 */
            private /* synthetic */ Object f90$f3

            /* renamed from: -$f4 */
            private /* synthetic */ Object f91$f4
...
*/
    ...
    Unit CopyInventoryItem(SLInventoryEntry sLInventoryEntry, SLInventoryEntry sLInventoryEntry2) {
    ...
    Unit CopyObjectContents(String str, Int i, Set<UUID> set, Function<UUID, Void> function) {
        if (this.rootFolder != null) {
            this.dbExecutor.execute(Runnable(i, this, str, ImmutableSet.copyOf(set), function) {

                /* renamed from: -$f0 */
                private /* synthetic */ Int f92$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Object f93$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Object f94$f2

                /* renamed from: -$f3 */
                private /* synthetic */ Object f95$f3

                /* renamed from: -$f4 */
                private /* synthetic */ Object f96$f4
...
*/
    ...
    Unit DeleteInventoryItem(SLInventoryEntry sLInventoryEntry) {
    ...
    Unit DeleteInventoryItemRaw(UUID uuid) {
        RemoveInventoryItem removeInventoryItem = RemoveInventoryItem()
        removeInventoryItem.AgentData_Field.AgentID = this.circuitInfo.agentID
        removeInventoryItem.AgentData_Field.SessionID = this.circuitInfo.sessionID
        RemoveInventoryItem.InventoryData inventoryData = RemoveInventoryItem.InventoryData()
    ...
    Unit DeleteMultiInventoryItemRaw(SLInventoryEntry sLInventoryEntry, List<UUID> list) {
    ...
    UUID DoCreateNewFolder(SLInventoryEntry sLInventoryEntry, String str, Boolean z, @Nullable Function<UUID, Void> function) {
    ...
    Unit DoCreateNewLandmark(SLInventoryEntry sLInventoryEntry, String str, String str2) {
        CreateInventoryItem createInventoryItem = CreateInventoryItem()
        createInventoryItem.AgentData_Field.AgentID = this.circuitInfo.agentID
        createInventoryItem.AgentData_Field.SessionID = this.circuitInfo.sessionID
        createInventoryItem.InventoryBlock_Field.CallbackID = getNextCallbackID()
    ...
    Unit HandleBulkUpdateInventory(LLSDNode lLSDNode) {
    ...
    @SLMessageHandler
    synchronized Unit HandleInventoryDescendents(InventoryDescendents inventoryDescendents) {
    ...
    Unit LinkInventoryItem(SLInventoryEntry sLInventoryEntry, UUID uuid, Int i, Int i2, String str, String str2) {
    ...
    Unit MoveInventoryItem(SLInventoryEntry sLInventoryEntry, SLInventoryEntry sLInventoryEntry2) {
    ...
    Unit MoveInventoryItemRaw(UUID uuid, String str, UUID uuid2) {
        MoveInventoryItem moveInventoryItem = MoveInventoryItem()
        moveInventoryItem.AgentData_Field.AgentID = this.circuitInfo.agentID
        moveInventoryItem.AgentData_Field.SessionID = this.circuitInfo.sessionID
        moveInventoryItem.AgentData_Field.Stamp = false
    ...
    Unit RenameInventoryItem(SLInventoryEntry sLInventoryEntry, String str) {
        ...
        DoUpdateInventoryItem(sLInventoryEntry, OnInventoryCallbackListener(this, sLInventoryEntry) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Object f83$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Object f84$f1
...
*/
    ...
    Unit TrashInventoryItem(SLInventoryEntry sLInventoryEntry) {
    ...
    Unit UpdateNotecard(@Nullable SLInventoryEntry sLInventoryEntry, UUID uuid, Boolean z, String str, String str2, @Nullable byte[] bArr, @Nullable UUID uuid2, Int i, @Nullable OnNotecardUpdatedListener onNotecardUpdatedListener) {
        ...
        if (uuid2 == null) {
            if (sLInventoryEntry == null) {
                ...
                DoCreateInventoryItem(uuid, z ? SLAssetType.AT_LSL_TEXT.getTypeCode() : SLAssetType.AT_NOTECARD.getTypeCode(), z ? SLInventoryType.IT_LSL.getTypeCode() : SLInventoryType.IT_NOTECARD.getTypeCode(), str, str2, OnInventoryCallbackListener(z, this, bArr, onNotecardUpdatedListener) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Boolean f97$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Object f98$f1

                    /* renamed from: -$f2 */
                    private /* synthetic */ Object f99$f2

                    /* renamed from: -$f3 */
                    private /* synthetic */ Object f100$f3
...
*/
                ...
                DoUpdateInventoryItem(sLInventoryEntry, OnInventoryCallbackListener(z, this, bArr, onNotecardUpdatedListener) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Boolean f101$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Object f102$f1

                    /* renamed from: -$f2 */
                    private /* synthetic */ Object f103$f2

                    /* renamed from: -$f3 */
                    private /* synthetic */ Object f104$f3
...
*/
            ...
            Boolean z3 = z
            byte[] bArr2 = bArr
            OnNotecardUpdatedListener onNotecardUpdatedListener2 = onNotecardUpdatedListener
    ...
    Unit UpdateStoreInventoryItem(SLInventoryEntry sLInventoryEntry) {
        try {
            this.db.saveEntry(sLInventoryEntry)
            DoUpdateInventoryItem(sLInventoryEntry, OnInventoryCallbackListener(this, sLInventoryEntry) {

                /* renamed from: -$f0 */
                private /* synthetic */ Object f85$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Object f86$f1
...
*/
    ...
    UUID getCallingCardsFolderUUID() {
    ...
    /* synthetic */ Unit m177lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_10310(Long j, UUID uuid, Boolean z, Boolean z2) {
    ...
    /* synthetic */ Unit m178lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_27010(SLInventoryEntry sLInventoryEntry, SLInventoryEntry sLInventoryEntry2) {
    ...
    /* synthetic */ Unit m179lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_42520(SLInventoryEntry sLInventoryEntry, SLInventoryEntry sLInventoryEntry2) {
        this.userManager.getInventoryManager().requestFolderUpdate(sLInventoryEntry.parentUUID)
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$-com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_48053  reason: not valid java name */
    /* synthetic */ Unit m180lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_48053(SLInventoryEntry sLInventoryEntry, byte[] bArr, UUID uuid, Boolean z, OnNotecardUpdatedListener onNotecardUpdatedListener) {
        UUID uuid2 = null
    ...
    /* synthetic */ Unit m181lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_49599(Boolean z, byte[] bArr, OnNotecardUpdatedListener onNotecardUpdatedListener, SLInventoryEntry sLInventoryEntry) {
        StartUploadingNotecardContents(sLInventoryEntry, (UUID) null, z, bArr, onNotecardUpdatedListener)
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$-com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_50229  reason: not valid java name */
    /* synthetic */ Unit m182lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_50229(Boolean z, byte[] bArr, OnNotecardUpdatedListener onNotecardUpdatedListener, SLInventoryEntry sLInventoryEntry) {
        StartUploadingNotecardContents(sLInventoryEntry, (UUID) null, z, bArr, onNotecardUpdatedListener)
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$-com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_51539  reason: not valid java name */
    /* synthetic */ Unit m183lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_51539(UUID uuid, UUID uuid2, UUID uuid3, Runnable runnable) {
        try {
    ...
    /* synthetic */ Unit m184lambda$com_lumiyaviewer_lumiya_slproto_inventory_SLInventory_53068(String str, ImmutableSet immutableSet, Int i, Function function) {
    ...
    /* access modifiers changed from: package-private */
    Unit onFetchComplete(SLInventoryFetchRequest sLInventoryFetchRequest, UUID uuid, Long j, Boolean z, Boolean z2) {
        if (this.dbExecutor != null) {
            this.dbExecutor.execute(Runnable(z, z2, j, this, uuid) {

                /* renamed from: -$f0 */
                private /* synthetic */ Boolean f77$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Boolean f78$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Long f79$f2

                /* renamed from: -$f3 */
                private /* synthetic */ Object f80$f3

                /* renamed from: -$f4 */
                private /* synthetic */ Object f81$f4
