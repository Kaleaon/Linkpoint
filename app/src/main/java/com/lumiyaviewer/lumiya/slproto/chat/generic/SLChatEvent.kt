...
abstract class SLChatEvent : View.OnLongClickListener {
    ...
    private /* synthetic */ Int[] f72comlumiyaviewerlumiyaslprotochatgenericSLChatEvent$ChatMessageTypeSwitchesValues = null
    ...
    private /* synthetic */ Int[] f73comlumiyaviewerlumiyaslprotouserschatsrcChatMessageSource$ChatMessageSourceTypeSwitchesValues = null
    Int CHAT_AUDIBLE_BARELY = 0
    Int CHAT_AUDIBLE_FULLY = 1
    Int CHAT_AUDIBLE_NOT = -1
    Int CHAT_SOURCE_AGENT = 1
    Int CHAT_SOURCE_OBJECT = 2
    Int CHAT_SOURCE_SYSTEM = 0
    Int CHAT_SOURCE_UNKNOWN = 3
    Int CHAT_TYPE_DEBUG_MSG = 6
    Int CHAT_TYPE_NORMAL = 1
    Int CHAT_TYPE_OWNER = 8
    Int CHAT_TYPE_REGION = 7
    Int CHAT_TYPE_SHOUT = 2
    Int CHAT_TYPE_START = 4
    Int CHAT_TYPE_STOP = 5
    Int CHAT_TYPE_WHISPER = 0
    Int IM_BUSY_AUTO_RESPONSE = 20
    Int IM_CONSOLE_AND_CHAT_HISTORY = 21
    Int IM_FRIENDSHIP_ACCEPTED = 39
    Int IM_FRIENDSHIP_DECLINED = 40
    Int IM_FRIENDSHIP_OFFERED = 38
    Int IM_FROM_TASK = 19
    Int IM_FROM_TASK_AS_ALERT = 31
    Int IM_GODLIKE_LURE_USER = 25
    Int IM_GOTO_URL = 28
    Int IM_GROUP_ELECTION_DEPRECATED = 27
    Int IM_GROUP_INVITATION = 3
    Int IM_GROUP_INVITATION_ACCEPT = 35
    Int IM_GROUP_INVITATION_DECLINE = 36
    Int IM_GROUP_MESSAGE_DEPRECATED = 8
    Int IM_GROUP_NOTICE = 32
    Int IM_GROUP_NOTICE_INVENTORY_ACCEPTED = 33
    Int IM_GROUP_NOTICE_INVENTORY_DECLINED = 34
    Int IM_GROUP_NOTICE_REQUESTED = 37
    Int IM_GROUP_VOTE = 7
    Int IM_INVENTORY_ACCEPTED = 5
    Int IM_INVENTORY_DECLINED = 6
    Int IM_INVENTORY_OFFERED = 4
    Int IM_LURE_ACCEPTED = 23
    Int IM_LURE_DECLINED = 24
    Int IM_LURE_USER = 22
    Int IM_MESSAGEBOX = 1
    Int IM_MESSAGEBOX_COUNTDOWN = 2
    Int IM_NEW_USER_DEFAULT = 12
    Int IM_NOTHING_SPECIAL = 0
    Int IM_SESSION_CONFERENCE_START = 16
    Int IM_SESSION_GROUP_START = 15
    Int IM_SESSION_INVITE = 13
    Int IM_SESSION_LEAVE = 18
    Int IM_SESSION_P2P_INVITE = 14
    Int IM_SESSION_SEND = 17
    Int IM_TASK_INVENTORY_ACCEPTED = 10
    Int IM_TASK_INVENTORY_DECLINED = 11
    Int IM_TASK_INVENTORY_OFFERED = 9
    Int IM_TELEPORT_REQUEST = 26
    Int IM_TYPING_START = 41
    Int IM_TYPING_STOP = 42
    @Nonnull
    protected UUID agentUUID
    @Nullable
    protected ChatMessage dbMessage
    private Boolean isOffline
    private Date originalTimestamp
    @Nonnull
    protected ChatMessageSource source
    ...
    enum ChatMessageViewType : ChatEventViewHolder.Factory {
        ...
        VIEW_TYPE_YESNO(R.layout.chat_message_yesno, false, ChatEventViewHolder.Factory() {
            private /* synthetic */ com.lumiyaviewer.lumiya.slproto.chat.generic.ChatEventViewHolder $m$0(
/*
...
*/
            ...
            com.lumiyaviewer.lumiya.slproto.chat.generic.ChatEventViewHolder createViewHolder(
/*
...
*/
        ...
        ChatMessageViewType[] VALUES = null
    ...
    SLChatEvent(@Nonnull ChatMessage chatMessage, @Nonnull UUID uuid) {
    ...
    SLChatEvent(@Nullable ImprovedInstantMessage improvedInstantMessage, @Nonnull UUID uuid, @Nonnull ChatMessageSource chatMessageSource) {
        this.timestamp = Date()
    ...
    SLChatEvent(@Nonnull ChatMessageSource chatMessageSource, @Nonnull UUID uuid) {
        this.timestamp = Date()
        this.originalTimestamp = this.timestamp
        this.isOffline = false
        this.source = chatMessageSource
    ...
    @Nullable
    SLChatEvent loadFromDatabaseObject(@Nullable ChatMessage chatMessage, @Nonnull UUID uuid) {
        if (chatMessage == null) {
            return null
        }
    ...
    @Nonnull
    abstract ChatMessageType getMessageType()

    CharSequence getPlainTextMessage(Context context, UserManager userManager, Boolean z) {
        return getPlainTextMessage(context, userManager, z, ": ", " ")
    }

    CharSequence getPlainTextMessage(Context context, UserManager userManager, Boolean z, String str, String str2) {
    ...
    @Nonnull
    ChatMessageSource getSource() {
        return this.source
    }

    /* access modifiers changed from: protected */
    abstract String getText(Context context, @Nonnull UserManager userManager)

    Date getTimestamp() {
        return this.timestamp
    }

    abstract ChatMessageViewType getViewType()

    /* access modifiers changed from: protected */
    abstract Boolean isActionMessage(@Nonnull UserManager userManager)
    ...
    /* synthetic */ Boolean m150lambda$com_lumiyaviewer_lumiya_slproto_chat_generic_SLChatEvent_21084(Context context, MenuItem menuItem) {
    ...
    /* access modifiers changed from: protected */
    Unit notifyEventUpdated(UserManager userManager) {
    ...
    Boolean onLongClick(View view) {
        ...
        popupMenu.setOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener(this, context) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Object f70$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Object f71$f1
