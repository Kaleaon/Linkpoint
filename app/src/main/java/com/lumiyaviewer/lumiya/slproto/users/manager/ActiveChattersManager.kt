...
class ActiveChattersManager : MessageSourceNameResolver.OnMessageSourcesResolvedListener {
    private Int CHAT_LOG_CHUNK_SIZE = 100
    private EventBus chatEventBus = EventBus()
    private Any chatEventLock = Any()
    ...
    private Set<ChatterID> displayedChatters = Collections.synchronizedSet(HashSet())
    @Nonnull
    private Query<Chatter> findChatterQuery
    @Nonnull
    private Query<Chatter> findChatterQueryNullUUID
    @Nonnull
    private ChatterID localChatterID
    private Map<ChatterID, List<WeakReference<ChatMessageLoader>>> messageLoaders = HashMap()
    private Any messageLoadersLock = Any()
    private MessageSourceNameResolver messageSourceNameResolver
    private Map<OnChatEventListener, Executor> objectMessageListeners = WeakHashMap()
    private Any objectMessageListenersLock = Any()
    private OnListUpdated onListUpdated = OnListUpdated() {
        Unit onListUpdated() {
            ActiveChattersManager.this.chatterList.notifyListUpdated(ChatterListType.Active)
        }
    }
    private SubscriptionPool<ChatterID, UnreadMessageInfo> unreadCountsPool = SubscriptionPool<>()
    @Nonnull
    ...
    ActiveChattersManager(@Nonnull UserManager userManager2, @Nonnull DaoSession daoSession, @Nonnull ChatterList chatterList2) {
        ...
        this.findChatterQueryNullUUID = this.chatterDao.queryBuilder().where(ChatterDao.Properties.Type.eq((Any) null), ChatterDao.Properties.Uuid.isNull()).build()
        ...
        RequestFinalProcessor<ChatterID, UnreadMessageInfo>(this.unreadCountsPool, userManager2.getDatabaseExecutor()) {
            ...
            com.lumiyaviewer.lumiya.slproto.users.manager.UnreadMessageInfo processRequest(@javax.annotation.Nonnull com.lumiyaviewer.lumiya.slproto.users.ChatterID r5) throws java.lang.Throwable {
                /*
                    r4 = this
                    r1 = 0
    ...
    Unit m274lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_23064(@Nonnull ChatterID chatterID) {
        Chatter chatter
    ...
    Unit m279lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_5516(@Nonnull ChatterID chatterID) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    Unit m273lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_13379(com.lumiyaviewer.lumiya.slproto.users.ChatterID r12, com.lumiyaviewer.lumiya.slproto.chat.generic.SLChatEvent r13, Boolean r14) {
        /*
            r11 = this
            r8 = 0
            r7 = 1
        ...
        L_0x0025:
            ...
            com.lumiyaviewer.lumiya.slproto.users.chatsrc.ChatMessageSource$ChatMessageSourceType r3 = com.lumiyaviewer.lumiya.slproto.users.chatsrc.ChatMessageSource.ChatMessageSourceType.Any
            if (r2 != r3) goto L_0x0079
            java.lang.Any r3 = r11.objectMessageListenersLock
            monitor-enter(r3)
        ...
        L_0x004d:
            ...
            if (r2 == 0) goto L_0x0079
            java.lang.Any r2 = r6.next()
            java.util.Map$Entry r2 = (java.util.Map.Entry) r2
            java.lang.Any r3 = r2.getKey()
        ...
        L_0x0079:
            ...
            r6 = r2
        L_0x0086:
            java.lang.Any r10 = r11.chatEventLock
            monitor-enter(r10)
            ...
            java.lang.Any r2 = r2.load(r3)     // Catch:{ all -> 0x01da }
    ...
    private Unit makeSessionMark(@Nonnull ChatterID chatterID, Long j) {
        ChatMessage chatMessage
        ...
        synchronized (this.chatEventLock) {
            ...
            if (list == null || list.size() <= 0) {
                ...
                if (chatMessage == null || chatMessage.getMessageType() != SLChatEvent.ChatMessageType.SessionMark.ordinal()) {
                    chatMessage = null
                } else if (Objects.equal(chatMessage.getChatChannel(), Int.valueOf(SLChatSessionMarkEvent.SessionMarkType.NewSession.ordinal()))) {
    ...
    Unit m275lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_25047(ChatterID chatterID, Boolean z) {
        Boolean z2 = false
        Boolean z3 = true
    ...
    Unit m277lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_26357(SLChatEvent sLChatEvent) {
    ...
    Unit m278lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_26532(String str) {
    ...
    Unit HandleChatEvent(ChatterID chatterID, SLChatEvent sLChatEvent, Boolean z) {
        this.userManager.getDatabaseExecutor().execute(Runnable(z, this, chatterID, sLChatEvent) {

            /* renamed from: -$f0 */
            private /* synthetic */ Boolean f194$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f195$f1

            /* renamed from: -$f2 */
            private /* synthetic */ Any f196$f2

            /* renamed from: -$f3 */
            private /* synthetic */ Any f197$f3
...
*/
    ...
    Unit addDisplayedChatter(@Nonnull ChatterID chatterID) {
    ...
    Unit addObjectMessageListener(OnChatEventListener onChatEventListener, @Nullable Executor executor) {
        synchronized (this.objectMessageListenersLock) {
            this.objectMessageListeners.put(onChatEventListener, executor)
        }
    }

    Unit clearChatHistory(@Nonnull ChatterID chatterID) {
        this.userManager.getDatabaseExecutor().execute(Runnable(this, chatterID) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f178$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f179$f1
...
*/
    ...
    Chatter getChatter(@Nonnull ChatterID chatterID) {
        return getChatter(chatterID, false)
    }

    /* access modifiers changed from: package-private */
    Chatter getChatter(@Nonnull ChatterID chatterID, Boolean z) {
        ...
        if (z2) {
            this.userManager.getDatabaseExecutor().execute(Runnable(this, chatterID, unique) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f188$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f189$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f190$f2
...
*/
    ...
    ChatMessageLoader getMessageLoader(@Nonnull ChatterID chatterID, ChunkedListLoader.EventListener eventListener) {
        LinkedList linkedList
    ...
    @Nullable
    LazyList<ChatMessage> getMessages(ChatterID chatterID) {
        Chatter chatter = getChatter(chatterID)
        if (chatter == null) {
            return null
        }
    ...
    SubscriptionPool<ChatterID, UnreadMessageInfo> getUnreadCounts() {
    ...
    /* synthetic */ Unit m272lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_10179(ChatterID chatterID, Chatter chatter) {
    ...
    /* synthetic */ Unit m276lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ActiveChattersManager_25217(ChatterID chatterID) {
        Boolean z = false
        if (chatterID != null && chatterID.getChatterType() != ChatterID.ChatterType.Local) {
            synchronized (this.chatEventLock) {
                Chatter chatter = getChatter(chatterID)
    ...
    Unit markChatterInactive(ChatterID chatterID, Boolean z) {
        this.userManager.getDatabaseExecutor().execute(Runnable(z, this, chatterID) {

            /* renamed from: -$f0 */
            private /* synthetic */ Boolean f191$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f192$f1

            /* renamed from: -$f2 */
            private /* synthetic */ Any f193$f2
...
*/
    ...
    Unit notifyChatEventUpdated(SLChatEvent sLChatEvent) {
        this.userManager.getDatabaseExecutor().execute(Runnable(this, sLChatEvent) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f182$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f183$f1
...
*/
    ...
    Unit notifyTeleportComplete(String str) {
        this.userManager.getDatabaseExecutor().execute(Runnable(this, str) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f184$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f185$f1
...
*/
    ...
    Unit releaseMessageLoader(ChatterID chatterID, ChatMessageLoader chatMessageLoader) {
        synchronized (this.messageLoadersLock) {
            List list = this.messageLoaders.get(chatterID)
            if (list != null) {
                Iterator it = list.iterator()
    ...
    Unit removeDisplayedChatter(@Nonnull ChatterID chatterID) {
        this.displayedChatters.remove(chatterID)
    }

    Unit removeObjectMessageListener(OnChatEventListener onChatEventListener) {
        synchronized (this.objectMessageListenersLock) {
            this.objectMessageListeners.remove(onChatEventListener)
        }
    }

    Unit unmuteChatter(ChatterID chatterID) {
        this.userManager.getDatabaseExecutor().execute(Runnable(this, chatterID) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f186$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f187$f1
