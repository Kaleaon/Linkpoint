...
class TerrainTextures {
    ...
    private Float[] terrainHeightRange
    private Float[] terrainStartHeight
    private UUID[] textureIDs
    ...
    TerrainTextures(RegionHandshake.RegionInfo regionInfo) {
        this.terrainStartHeight = Float[4]
        this.terrainHeightRange = Float[4]
    ...
    private Float bilinearCorners(Float[] fArr, Float f, Float f2) {
    ...
    Int getNeededLayerMask(Float[] fArr) {
        Int i = 0
        for (Float f : fArr) {
    ...
    Float[] getTextureHeightMap(Float[] fArr, Int i, Int i2, Float f, Float f2, Float f3, Float f4) {
        Float[] fArr2 = Float[(i * i2)]
