...
class KotlinLLSDIntegrationTest {
    ...
    companion object {
        ...
        private fun testNestedStructures() {
            ...
            val complexData = kotlinLlsdMap {
                "user_profile" to kotlinLlsdMap {
                    ...
                    "inventory_folders" to kotlinLlsdArray {
                        // Multiple folders
                        repeat(5) { index ->
                            add(kotlinLlsdMap {
        ...
        private fun testPerformance() {
            ...
            val largeInventory = kotlinLlsdMap {
                "inventory_skeleton" to kotlinLlsdArray {
        ...
        private fun testSecondLifeProtocol() {
            ...
            val agentMovementMessage = kotlinLlsdMap {
                "message" to "AgentMovementComplete"
                "agent_data" to kotlinLlsdMap {
                    "agent_id" to UUID.randomUUID()
                    "session_id" to UUID.randomUUID()
                    "position" to kotlinLlsdArray {
                        add(128.0); add(128.0); add(23.0)
                    }
                    "look_at" to kotlinLlsdArray {
                        add(1.0); add(0.0); add(0.0)
                    }
                }
                "region_data" to kotlinLlsdMap {
            ...
            val chatMessage = kotlinLlsdMap {
                "message_type" to "ChatFromSimulator"
                "body" to kotlinLlsdMap {
