...
class ChatterUserSubscription : ChatterSubscription {
    ...
    ChatterUserSubscription(@NonNull SortedChatterList sortedChatterList, @NonNull ChatterID.ChatterIDUser chatterIDUser, @NonNull UserManager userManager) {
        ...
        this.onlineStatusSubscription = userManager.getChatterList().getFriendManager().getOnlineStatus().subscribe(chatterIDUser.getChatterUUID(), Subscription.OnData(this) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f216$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$o86h7H3WuAxnvPtFprunJr0Jq8o.1.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$o86h7H3WuAxnvPtFprunJr0Jq8o.1.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
        ...
        this.distanceSubscription = userManager.getChatterList().getDistanceToUser().subscribe(chatterIDUser.getChatterUUID(), Subscription.OnData(this) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f217$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$o86h7H3WuAxnvPtFprunJr0Jq8o.2.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$o86h7H3WuAxnvPtFprunJr0Jq8o.2.$m$0(java.lang.Any):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit m301com_lumiyaviewer_lumiya_slproto_users_manager_ChatterUserSubscriptionmthref2(Float f) {
        if (f != null) {
    ...
    Unit m300com_lumiyaviewer_lumiya_slproto_users_manager_ChatterUserSubscriptionmthref1(Boolean bool) {
    ...
    Unit m299com_lumiyaviewer_lumiya_slproto_users_manager_ChatterUserSubscriptionmthref0(UserName userName) {
