...
class SLMuteList : SLModule : SLXfer.SLXferCompletionListener {
    ...
    ResultHandler<SubscriptionSingleKey, ImmutableList<MuteListEntry>> muteListResultHandler
    private UserManager userManager

    SLMuteList(SLAgentCircuit sLAgentCircuit) {
    ...
    Unit HandleMuteListUpdate(MuteListUpdate muteListUpdate) {
        ...
        if (!stringFromVariableOEM.equals("")) {
            this.agentCircuit.getModules().xferManager.RequestXfer(stringFromVariableOEM, ELLPath.LL_PATH_CACHE, true, this, (Any) null)
        }
    }
