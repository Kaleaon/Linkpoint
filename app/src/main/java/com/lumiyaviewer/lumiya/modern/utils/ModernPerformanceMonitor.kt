...
class ModernPerformanceMonitor {
    ...
    private Map<String, Long> operationStartTimes = new ConcurrentHashMap<>()
    private Map<String, List<Long>> operationDurations = new ConcurrentHashMap<>()
    ...
    class PerformanceMetrics {
        ...
        PerformanceMetrics(String operationName, long totalOperations, 
    ...
    class BenchmarkResult {
        ...
        BenchmarkResult(BenchmarkCategory category, List<PerformanceMetrics> metrics, 
