...
class ModernLinkpointDemo {
    ...
    private ModernTextureManager textureManager
    private ModernRenderPipeline renderPipeline
    private OAuth2AuthManager authManager
    private ModernAssetManager assetManager
    private ProtocolCompatibilityDemo protocolDemo
     ...
     */
    fun getAuthManager(): OAuth2AuthManager {
        return authManager
    }
     ...
     * Get asset manager  
     */
    fun getAssetManager(): ModernAssetManager {
        return assetManager
    }
