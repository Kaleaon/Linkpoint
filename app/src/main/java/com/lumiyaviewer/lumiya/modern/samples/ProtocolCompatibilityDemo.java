...
import com.lumiyaviewer.lumiya.slproto.types.*;
 ...
 */
public class ProtocolCompatibilityDemo {
    private static final String TAG = "ProtocolCompatibility";
     ...
     */
    public void demonstrateLLSDPrimitives() {
        Log.i(TAG, "=== LLSD Primitives Compatibility Demo ===");
        
        // Vector3 compatibility 
        LLVector3 position = new LLVector3(128.0f, 128.0f, 25.0f);
        ...
        LLQuaternion rotation = new LLQuaternion();
        ...
        // Date compatibility
        LLSDDate dateLLSD = ModernLLSDCodec.Primitives.createDate(new Date());
     ...
     */
    public void demonstrateProtocolTransports() {
     ...
     */
    public void demonstrateAuthCompatibility() {
