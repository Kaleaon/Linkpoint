 ...
 */
public class HybridProtocolManager {
    private static final String TAG = "HybridProtocol";
    ...
    private final LegacyUDPManager udpManager;
     ...
     */
    private static class LegacyUDPManager {
     ...
     * Protocol router to determine optimal transport
     */
    private static class ProtocolRouter {
