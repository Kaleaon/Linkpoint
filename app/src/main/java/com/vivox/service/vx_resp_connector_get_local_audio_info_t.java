...
public class vx_resp_connector_get_local_audio_info_t {
     ...
     */
    protected static long getCPtr(vx_resp_connector_get_local_audio_info_t vx_resp_connector_get_local_audio_info_t2) {
    ...
    public vx_resp_base_t getBase() {
        long l = VxClientProxyJNI.vx_resp_connector_get_local_audio_info_t_base_get(this.swigCPtr, this);
        if (l != 0L) return new vx_resp_base_t(l, false);
        return null;
    }

    public int getIs_mic_muted() {
        return VxClientProxyJNI.vx_resp_connector_get_local_audio_info_t_is_mic_muted_get(this.swigCPtr, this);
    }

    public int getIs_speaker_muted() {
