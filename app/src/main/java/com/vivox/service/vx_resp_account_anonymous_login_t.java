...
public class vx_resp_account_anonymous_login_t {
     ...
     */
    protected static long getCPtr(vx_resp_account_anonymous_login_t vx_resp_account_anonymous_login_t2) {
    ...
    public vx_resp_base_t getBase() {
        long l = VxClientProxyJNI.vx_resp_account_anonymous_login_t_base_get(this.swigCPtr, this);
