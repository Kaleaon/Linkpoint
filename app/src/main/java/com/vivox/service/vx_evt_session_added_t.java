...
public class vx_evt_session_added_t {
     ...
     */
    protected static long getCPtr(vx_evt_session_added_t vx_evt_session_added_t2) {
    ...
    public vx_evt_base_t getBase() {
        long l = VxClientProxyJNI.vx_evt_session_added_t_base_get(this.swigCPtr, this);
    ...
    public void setIs_channel(int n) {
