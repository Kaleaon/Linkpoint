...
public class vx_resp_connector_set_local_mic_volume_t {
     ...
     */
    protected static long getCPtr(vx_resp_connector_set_local_mic_volume_t vx_resp_connector_set_local_mic_volume_t2) {
    ...
    public vx_resp_base_t getBase() {
        long l = VxClientProxyJNI.vx_resp_connector_set_local_mic_volume_t_base_get(this.swigCPtr, this);
