...
/**
 * Linkpoint Material Design 3 typography
 * 
 * Defines text styles for Jetpack Compose following Material Design 3 guidelines
 */
val LinkpointTypography = Typography(
    ...
    // Label styles - Smaller text for labels and captions
