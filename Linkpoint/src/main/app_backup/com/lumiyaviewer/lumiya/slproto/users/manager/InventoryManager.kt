...
class InventoryManager {
    ...
    AtomicReference<UUID> currentSessionID = AtomicReference<>((Any) null)
    /* access modifiers changed from: private */
    SubscriptionPool<InventoryQuery, InventoryEntryList> entryListPool = SubscriptionPool<>()
    /* access modifiers changed from: private */
    SubscriptionPool<UUID, SLInventoryEntry> folderEntryPool = SubscriptionPool<>()
    ...
    /* access modifiers changed from: private */
    AtomicReference<UUID> rootFolderID = AtomicReference<>((Any) null)
    private SubscriptionPool<SubscriptionSingleKey, Boolean> searchProcessPool = SubscriptionPool<>()
    private SubscriptionPool<SubscriptionSingleKey, Boolean> searchRunningPool = SubscriptionPool<>()
    ...
    InventoryManager(@NonNull UUID uuid) {
        ...
        this.folderEntryPool.setCacheInvalidateHandler(Refreshable(userInventoryDB) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f175$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$JIBenvPHaOomPgMJhTFPuiVXBzY.2.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$JIBenvPHaOomPgMJhTFPuiVXBzY.2.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
        ...
        this.entryListPool.setDisposeHandler(DisposeHandler() {
            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$JIBenvPHaOomPgMJhTFPuiVXBzY.1.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$JIBenvPHaOomPgMJhTFPuiVXBzY.1.$m$0(java.lang.Any):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    /* synthetic */ Unit m324lambda$com_lumiyaviewer_lumiya_slproto_users_manager_InventoryManager_3450(InventoryDB inventoryDB2, UUID uuid) {
    ...
    /* synthetic */ Boolean m325lambda$com_lumiyaviewer_lumiya_slproto_users_manager_InventoryManager_6838(InventoryQuery inventoryQuery) {
