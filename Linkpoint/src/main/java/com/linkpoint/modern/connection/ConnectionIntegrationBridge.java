 ...
 */
public class ConnectionIntegrationBridge {
    private static final String TAG = "ConnectionBridge";
    
    private final Context context;
    private final ModernConnectionManager modernManager;
    private final EventBus eventBus;
    
    public ConnectionIntegrationBridge(Context context) {
        this.context = context.getApplicationContext();
        this.modernManager = new ModernConnectionManager(context);
    ...
    public CompletableFuture<Boolean> connectWithModernReliability(SLAuthParams authParams) {
        ...
        eventBus.publish(new SLConnectionStateChangedEvent(
        ...
        return modernManager.connectAsync(authParams)
            .thenApply(authReply -> {
                if (authReply != null && authReply.success) {
                    ...
                    eventBus.publish(new SLLoginResultEvent(
                        true, 
            ...
            .exceptionally(throwable -> {
                ...
                eventBus.publish(new SLDisconnectEvent(
                    false, 
