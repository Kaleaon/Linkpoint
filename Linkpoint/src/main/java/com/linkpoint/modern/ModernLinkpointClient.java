 ...
 */
public class ModernLinkpointClient {
    private static final String TAG = "ModernLinkpoint";
    
    private final Context context;
    
    // Core systems
    private final ModernConnectionManager connectionManager;
    private final ConnectionDiagnostics diagnostics;
    private final ConnectionIntegrationBridge connectionBridge;
    private final ModernAuthManager authManager;
    private final HybridProtocolManager protocolManager;
    private final ModernSecondLifeFeatures featuresManager;
