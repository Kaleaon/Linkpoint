                ...
                public void onLLSDXMLResult(LLSDNode lLSDNode) {
                    ...
                    if (lLSDNode == null) {
                        try {
                            ...
                            SLVoice.this.agentCircuit.HandleChatEvent(groupChatterID, new SLChatSystemMessageEvent(ChatMessageSourceUnknown.getInstance(), SLVoice.this.userManager.getUserID(), LinkpointApp.getContext().getString(R.string.failed_to_connect_group_voice)), false);
                            Debug.Warning(e);
                        }
                    } else {
