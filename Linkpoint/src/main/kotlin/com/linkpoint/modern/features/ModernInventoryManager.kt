...
class ModernInventoryManager {
    ...
    private val Map<UUID, InventoryFolder> folderCache = ConcurrentHashMap<>()
    ...
    class InventoryItem {
        ...
        val InventoryType type
        val UUID assetId
        val Long creationDate
    ...
    class InventoryFolder {
        val UUID folderId
        val String name
        val UUID parentFolderId
        val List<UUID> childFolders = ArrayList<>()
