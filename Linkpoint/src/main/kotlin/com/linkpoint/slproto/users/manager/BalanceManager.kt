...
class BalanceManager {
    ...
    /* access modifiers changed from: private */
    val AtomicReference<SLFinancialInfo> financialInfo = AtomicReference<>((Object) null)
    /* access modifiers changed from: private */
    ...
    public Unit clearMoneyTransactions() {
        this.userManager.getDatabaseExecutor().execute(Runnable(this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f224$f0

            private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$xo_DO1h0hLJizWUYkWN5MuOY-xk.1.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$xo_DO1h0hLJizWUYkWN5MuOY-xk.1.$m$0():Unit, class status: UNLOADED
...
*/
    ...
    public /* synthetic */ Unit m287lambda$com_lumiyaviewer_lumiya_slproto_users_manager_BalanceManager_4293() {
