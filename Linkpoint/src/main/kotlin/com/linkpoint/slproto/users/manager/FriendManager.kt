...
class FriendManager {
    ...
    public Unit addFriend(UUID uuid) {
    ...
    public Unit setUsersOnline(List<UUID> list, Boolean z) {
        for (UUID uuid : list) {
    ...
    public Unit updateFriendList(ImmutableList<SLAuthReply.Friend> immutableList) {
