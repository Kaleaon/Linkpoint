...
class ChatterNameRetriever {
    ...
    public ChatterNameRetriever(ChatterID chatterID2, OnChatterNameUpdated onChatterNameUpdated, Executor executor2, Boolean z) {
        this.chatterID = chatterID2
        this.listener = WeakReference<>(onChatterNameUpdated)
        this.executor = executor2
        if (z) {
    ...
    public Unit subscribe() {
        ...
        if (userManager == null) {
            ...
            this.subscription = userManager.getUserNames().subscribe(((ChatterID.ChatterIDUser) this.chatterID).getChatterUUID(), this.executor, Subscription.OnData(this) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f148$f0

                private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.-$Lambda$Tr7QBnh_GnHDqFtHSpMdsLw3Yfs.1.$m$0(java.lang.Object):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.-$Lambda$Tr7QBnh_GnHDqFtHSpMdsLw3Yfs.1.$m$0(java.lang.Object):Unit, class status: UNLOADED
...
*/
            ...
            this.subscription = userManager.getCachedGroupProfiles().getPool().subscribe(((ChatterID.ChatterIDGroup) this.chatterID).getChatterUUID(), this.executor, Subscription.OnData(this) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f149$f0

                private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.-$Lambda$Tr7QBnh_GnHDqFtHSpMdsLw3Yfs.2.$m$0(java.lang.Object):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.-$Lambda$Tr7QBnh_GnHDqFtHSpMdsLw3Yfs.2.$m$0(java.lang.Object):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
