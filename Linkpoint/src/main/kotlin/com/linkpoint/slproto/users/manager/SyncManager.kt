...
class SyncManager {
    ...
    private val Set<String> flushChatterNames = Collections.newSetFromMap(ConcurrentHashMap())
    private val Map<ChatterID, ChatterNameRetriever> flushChatters = ConcurrentHashMap()
    private Long lastConfirmedMessageID = 0
    private val String localChatName
    private val Query<ChatMessage> messagesQuery
    private ChatterNameRetriever myNameRetriever = null
    private val AtomicBoolean needsStopSyncing = AtomicBoolean(false)
    private val AtomicBoolean syncMessageSent = AtomicBoolean(false)
    private val AtomicReference<CloudSyncServiceConnection> syncServiceConnection = AtomicReference<>()
    private val AtomicBoolean syncingEnabled = AtomicBoolean(false)
...
private /* synthetic */ Int[] m355getcomlumiyaviewerlumiyaslprotousersChatterID$ChatterTypeSwitchesValues() {
    ...
    public Unit m361com_lumiyaviewer_lumiya_slproto_users_manager_SyncManagermthref5(ChatterNameRetriever chatterNameRetriever2) {
        this.dbExecutor.execute(Runnable(this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f157$f0
...
*/
    ...
    public Unit m357com_lumiyaviewer_lumiya_slproto_users_manager_SyncManagermthref1(ChatterNameRetriever chatterNameRetriever2) {
        this.dbExecutor.execute(Runnable(this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f158$f0
    ...
    private String resolveChatterName(Chatter chatter) {
        ...
        if (this.chatterNameRetriever == null || (!this.chatterNameRetriever.chatterID.equals(fromDatabaseObject))) {
            ...
            this.chatterNameRetriever = ChatterNameRetriever(fromDatabaseObject, ChatterNameRetriever.OnChatterNameUpdated(this) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f153$f0
    ...
    public Unit flushChatter(ChatterID chatterID) {
        if (this.syncingEnabled.get()) {
            this.dbExecutor.execute(Runnable(this, chatterID) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f162$f0

                /* renamed from: -$f1 */
                private val /* synthetic */ Object f163$f1
...
*/
    ...
    public /* synthetic */ Unit m363lambda$com_lumiyaviewer_lumiya_slproto_users_manager_SyncManager_10038() {
    ...
    public /* synthetic */ Unit m364lambda$com_lumiyaviewer_lumiya_slproto_users_manager_SyncManager_10254(ChatterID chatterID) {
    ...
    public /* synthetic */ Unit m365lambda$com_lumiyaviewer_lumiya_slproto_users_manager_SyncManager_9602(Long j) {
    ...
    public Unit onMessagesFlushed(ImmutableList<Long> immutableList) {
        this.dbExecutor.execute(Runnable(this, immutableList) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f164$f0

            /* renamed from: -$f1 */
            private val /* synthetic */ Object f165$f1
...
*/
    ...
    public Unit onMessagesWritten(Long j) {
        this.dbExecutor.execute(Runnable(j, this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Long f154$f0

            /* renamed from: -$f1 */
            private val /* synthetic */ Object f155$f1
...
*/
    ...
    public Unit startSyncing(CloudSyncServiceConnection cloudSyncServiceConnection) {
        ...
        this.dbExecutor.execute(Runnable(this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f159$f0
...
*/
    ...
    public Unit stopSyncing() {
        ...
        this.dbExecutor.execute(Runnable(this) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f160$f0
    ...
    public Unit syncNewMessages() {
        if (this.syncingEnabled.get()) {
            this.dbExecutor.execute(Runnable(this) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f161$f0
