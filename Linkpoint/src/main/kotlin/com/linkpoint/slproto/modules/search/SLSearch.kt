...
class SLSearch : SLModule() {
    private const val Int DFQ_ADULT_SIMS_ONLY = 134217728
    private const val Int DFQ_AGENT_OWNED = 64
    private const val Int DFQ_AREA_SORT = 262144
    private const val Int DFQ_AUCTION = 512
    private const val Int DFQ_DATE_EVENTS = 32
    private const val Int DFQ_DWELL_SORT = 1024
    private const val Int DFQ_EVENTS = 8
    private const val Int DFQ_FILTER_MATURE = 4194304
    private const val Int DFQ_FOR_SALE = 128
    private const val Int DFQ_GROUPS = 16
    private const val Int DFQ_GROUP_OWNED = 256
    private const val Int DFQ_INC_ADULT = 67108864
    private const val Int DFQ_INC_MATURE = 33554432
    private const val Int DFQ_INC_NEW_VIEWER = 117440512
    private const val Int DFQ_INC_PG = 16777216
    private const val Int DFQ_LIMIT_BY_AREA = 2097152
    private const val Int DFQ_LIMIT_BY_PRICE = 1048576
    private const val Int DFQ_MATURE_SIMS_ONLY = 16384
    private const val Int DFQ_NAME_SORT = 524288
    private const val Int DFQ_ONLINE = 2
    private const val Int DFQ_PEOPLE = 1
    private const val Int DFQ_PER_METER_SORT = 131072
    private const val Int DFQ_PG_EVENTS_ONLY = 8192
    private const val Int DFQ_PG_PARCELS_ONLY = 8388608
    private const val Int DFQ_PG_SIMS_ONLY = 2048
    private const val Int DFQ_PICTURES_ONLY = 4096
    private const val Int DFQ_PLACES = 4
    private const val Int DFQ_PRICE_SORT = 65536
    private const val Int DFQ_SORT_ASC = 32768
