...
class ChatTextBoxViewHolder : ChatEventViewHolder() : View.OnClickListener, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    private val EditText textBox
    private SLChatTextBoxDialog textBoxEvent = null
    private val Button textBoxSend
    ...
    public Unit onFocusChange(View view, Boolean z) {
    ...
    public Unit setTextBoxEvent(SLChatTextBoxDialog sLChatTextBoxDialog) {
