...
final /* synthetic */ class $Lambda$paN_qX4OegT79dFg6kmGbliJfA0 : ThreadFactory {

    /* renamed from: -$f0  reason: not valid java name */
    private val /* synthetic */ Object f50$f0

    private val /* synthetic */ Thread $m$0(Runnable runnable) {
    ...
    val Thread newThread(Runnable runnable) {
        return $m$0(runnable)
    }
}
