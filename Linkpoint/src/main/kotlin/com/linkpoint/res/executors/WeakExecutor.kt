...
class WeakExecutor : ThreadPoolExecutor() {
    private val Boolean usePriorities = false
...
private class WeakCallable<T> : Callable<T> {
            private val WeakReference<Callable<T>> callableRef
...
private class WeakRunnable : Runnable {
            private val WeakReference<Runnable> runnableRef
    ...
    public WeakExecutor(String str, Int i, BlockingQueue<Runnable> blockingQueue) {
        super(i, i, 60, TimeUnit.SECONDS, blockingQueue, ThreadFactory(str) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f51$f0

            private val /* synthetic */ java.lang.Thread $m$0(
/*
...
*/
            ...
            val java.lang.Thread newThread(
/*
