...
val class DrawableGeometry : GLCleanable {
    ...
    private val GLLoadableBuffer TexCoordsBuffer
    private val GLLoadableBuffer VertexBuffer
    private val Int VertexCount
    private val Int VertexSizeBytes
    private val Boolean facesCombined
    ...
    /* access modifiers changed from: package-private */
    val GLLoadableBuffer GLBindBuffers20(RenderContext renderContext) {
    ...
    /* access modifiers changed from: package-private */
    val Unit GLBindBuffersRigged30(RenderContext renderContext) {
        if (this.isRiggedMesh && this.meshData != null) {
    ...
    /* access modifiers changed from: package-private */
    val Unit GLDrawAll10(RenderContext renderContext) {
        this.IndexBuffer.DrawElements(renderContext, 4, this.IndexCount, 5123, 0)
    }

    /* access modifiers changed from: package-private */
    val Unit GLDrawAll20(RenderContext renderContext) {
        if (!renderContext.hasGL30) {
