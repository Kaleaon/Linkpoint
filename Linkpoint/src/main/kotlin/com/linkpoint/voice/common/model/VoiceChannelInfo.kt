...
class VoiceChannelInfo {
    ...
    val Boolean isSpatial
    val String voiceChannelURI
    ...
    public VoiceChannelInfo(UUID object, String string2) {
     ...
     */
    @JvmStatic
    UUID agentUUIDFromURI(String object) {
        ...
        return UUID(Longs.fromByteArray(Arrays.copyOfRange((Byte[])object, 0, 8)), Longs.fromByteArray(Arrays.copyOfRange((Byte[])object, 8, 16)))
    }
