    ...
    Unit TeleportToLandmark(Context context, UserManager userManager2, UUID uuid, Boolean z) {
        ...
        if (userManager2 != null && (activeAgentCircuit = userManager2.getActiveAgentCircuit()) != null && activeAgentCircuit.getModules().rlvController.canTeleportToLandmark()) {
            $Lambda$8gWLFwrhoxKapEC8iWggaUhFR1c.AnonymousClass2 r1 = Runnable(activeAgentCircuit, uuid, context, userManager2) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f339$f0

                /* renamed from: -$f1 */
                private val /* synthetic */ Object f340$f1

                /* renamed from: -$f2 */
                private val /* synthetic */ Object f341$f2

                /* renamed from: -$f3 */
                private val /* synthetic */ Object f342$f3
...
*/
            ...
            if (z) {
                ...
                builder.setMessage(context.getString(R.string.teleport_confirm_title)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(r1) {
                    ...
                    /* renamed from: -$f0 */
                    private val /* synthetic */ Object f338$f0
