...
abstract class MasterDetailsActivity : DetailsActivity() {
    ...
    /* access modifiers changed from: protected */
     ...
     public fun isSplitScreen(): Boolean {
    ...
    fun onCreate(@android.support.annotation.Nullable android.os.Bundle r15) {
        /*
            ...
            r2 = 1
            super.onCreate(r15)
            val r1: Boolean = com.lumiyaviewer.lumiya.LinkpointApp.isSplitScreenNeeded(r14)
            r14.isSplitScreen = r1
            val r1: Boolean = r14.isSplitScreen
        ...
        L_0x0059:
            ...
            val r7: Boolean = r1.getBoolean(r7, r3)
            java.lang.Boolean r7 = java.lang.Boolean.valueOf(r7)
            r5[r3] = r7
            com.lumiyaviewer.lumiya.Debug.Printf(r4, r5)
            java.lang.String r4 = "MasterDetailsActivityIsImplicitDetails"
            val r1: Boolean = r1.getBoolean(r4, r3)
            if (r1 != 0) goto L_0x0236
            r1 = r2
        L_0x00b0:
        ...
        L_0x00d0:
            ...
            val r4: Boolean = r14.isSplitScreen
            ...
            r4 = r2
        L_0x00e7:
            val r5: Boolean = r14.isSplitScreen
        ...
        L_0x00fb:
            ...
            java.lang.Array<Any> r12 = java.lang.Object[r2]
            val r5: Boolean = r9.isVisible()
            if (r5 == 0) goto L_0x01c8
            java.lang.String r5 = "visible"
        L_0x0110:
            r12[r3] = r5
            com.lumiyaviewer.lumiya.Debug.Printf(r11, r12)
            val r5: Boolean = r9.isDetached()
        ...
        L_0x0151:
            ...
            val r2: Boolean = r1 instanceof com.lumiyaviewer.lumiya.ui.common.ReloadableFragment     // Catch:{ Exception -> 0x01fd }
        ...
        L_0x0202:
            ...
            val r5: Boolean = r10.isDetached()
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r5)
            r4[r3] = r5
            r4[r2] = r10
            com.lumiyaviewer.lumiya.Debug.Printf(r1, r4)
            val r1: Boolean = r10.isDetached()
        ...
        L_0x0236:
            ...
            goto L_0x00b0
        */
        throw UnsupportedOperationException("Method not decompiled: com.lumiyaviewer.lumiya.ui.common.MasterDetailsActivity.onCreate(android.os.Bundle):Unit")
    }

    /* access modifiers changed from: protected */
    public abstract Fragment onCreateMasterFragment(Intent intent, Bundle bundle)
    ...
    /* access modifiers changed from: protected */
     public fun onDetailsStackEmpty(): Boolean {
        ...
        val beginTransaction: FragmentTransaction = (supportFragmentManager = getSupportFragmentManager()).beginTransaction()
        beginTransaction.setCustomAnimations(17432576, R.anim.slide_to_right, 0, 17432577)
        beginTransaction.remove(findFragmentById)
        val findFragmentById2: Fragment = supportFragmentManager.findFragmentById(R.id.selector)
    ...
    fun onNewIntent(intent: Intent) {
        ...
        val bundleExtra: Bundle = intent.hasExtra(INTENT_SELECTION_KEY) ? intent.getBundleExtra(INTENT_SELECTION_KEY) : null
    ...
    fun replaceDetailsFragment(fragmentManager: FragmentManager, fragment: Fragment) {
     ...
     public fun showDetailsFragment(cls: Class<? : Fragment>, intent: Intent, bundle: Bundle): Fragment {
        Bundle arguments
        val showDetailsFragment: Fragment = super.showDetailsFragment(cls, intent, bundle)
    ...
    fun updateTitleNoDetails() {
        ...
        if (findFragmentById == null || !(findFragmentById instanceof FragmentHasTitle) || !findFragmentById.isAdded()) {
            ...
            if (!findFragmentById.isDetached()) {
                val title: String = ((FragmentHasTitle) findFragmentById).getTitle()
                val subTitle: String = ((FragmentHasTitle) findFragmentById).getSubTitle()
                if (title != null) {
                    z = true
