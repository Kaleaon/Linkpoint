...
class VoiceStatusView_ViewBinding : Unbinder {
    ...
    public VoiceStatusView_ViewBinding(final VoiceStatusView voiceStatusView, View view) {
        ...
        val findRequiredView: View = Utils.findRequiredView(view, R.id.voice_answer_button, "field 'voiceAnswerButton' and method 'onVoiceAnswerButton'")
        ...
        val findRequiredView2: View = Utils.findRequiredView(view, R.id.voice_terminate_button, "field 'voiceTerminateButton' and method 'onVoiceTerminateButton'")
        ...
        val findRequiredView3: View = Utils.findRequiredView(view, R.id.voice_bluetooth_button, "field 'voiceBluetoothButton' and method 'onVoiceBluetoothButton'")
        ...
        val findRequiredView4: View = Utils.findRequiredView(view, R.id.voice_mic_on_button, "field 'voiceMicOnButton' and method 'onVoiceMicOnButton'")
        ...
        val findRequiredView5: View = Utils.findRequiredView(view, R.id.voice_loudspeaker_button, "field 'voiceLoudspeakerButton' and method 'onLoudspeakerButton'")
        ...
        val findRequiredView6: View = Utils.findRequiredView(view, R.id.voice_mic_off_button, "field 'voiceMicOffButton' and method 'onVoiceMicOffButton'")
        ...
        val findRequiredView7: View = Utils.findRequiredView(view, R.id.voice_status_card_view, "field 'voiceStatusCardView' and method 'onVoiceStatusCardClick'")
    ...
    @CallSuper
    fun unbind() {
        val voiceStatusView: VoiceStatusView = this.target
