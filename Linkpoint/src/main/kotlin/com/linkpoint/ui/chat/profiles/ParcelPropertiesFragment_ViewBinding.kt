...
class ParcelPropertiesFragment_ViewBinding : Unbinder {
    ...
    public ParcelPropertiesFragment_ViewBinding(final ParcelPropertiesFragment parcelPropertiesFragment, View view) {
        ...
        val findRequiredView: View = Utils.findRequiredView(view, R.id.parcel_media_stop_button, "field 'mediaStopButton' and method 'onParcelMediaStop'")
        ...
        val findRequiredView2: View = Utils.findRequiredView(view, R.id.parcel_media_play_button, "field 'mediaPlayButton' and method 'onParcelMediaPlay'")
        ...
        val findRequiredView3: View = Utils.findRequiredView(view, R.id.parcel_owner_profile_button, "method 'onOwnerProfileButton'")
        ...
        val findRequiredView4: View = Utils.findRequiredView(view, R.id.sim_restart_button, "method 'onSimRestartButton'")
        ...
        val findRequiredView5: View = Utils.findRequiredView(view, R.id.parcel_set_home_button, "method 'onSetHomeButton'")
    ...
    @CallSuper
    fun unbind() {
        val parcelPropertiesFragment: ParcelPropertiesFragment = this.target
