...
class UserMainProfileTab : ChatterReloadableFragment(), LoadableMonitor.OnLoadableDataChangedListener {
    ...
    private val LoadableMonitor loadableMonitor = LoadableMonitor(this.avatarProperties, this.avatarNotes, this.onlineStatus).withDataChangedListener(this)
    @BindView(2131755197)
    LoadingLayout loadingLayout
    private val ChatterNameRetriever.OnChatterNameUpdated onPartnerNameReady = $Lambda$wqoLfTfjESd1OUBLJEQMKRim4S0(this)
    private val SubscriptionData<UUID, Boolean> onlineStatus = SubscriptionData<>(UIThreadExecutor.getInstance())
    ...
    public /* synthetic */ Unit m509lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_UserMainProfileTab_9585(ChatterNameRetriever chatterNameRetriever) {
        if (getView() != null) {
