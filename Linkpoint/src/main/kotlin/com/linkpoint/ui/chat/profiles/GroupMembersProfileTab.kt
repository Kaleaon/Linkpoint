...
class GroupMembersProfileTab : ChatterReloadableFragment(), LoadableMonitor.OnLoadableDataChangedListener {
    ...
    /* access modifiers changed from: private */
    val SubscriptionData<UUID, SLAgentCircuit> agentCircuit = SubscriptionData<>(UIThreadExecutor.getInstance())
    private val SubscriptionData<UUID, UUID> groupMemberList = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {

        /* renamed from: -$f0 */
        private val /* synthetic */ Object f271$f0

        private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.2.$m$0(java.lang.Object):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.2.$m$0(java.lang.Object):Unit, class status: UNLOADED
...
*/
    ...
    private val SubscriptionData<GroupManager.GroupMembersQuery, LazyList<GroupMember>> groupMembers = SubscriptionData<>(UIThreadExecutor.getInstance())
    private val SubscriptionData<UUID, GroupProfileReply> groupProfile = SubscriptionData<>(UIThreadExecutor.getInstance())
    private val LoadableMonitor loadableMonitor = LoadableMonitor(this.groupMemberList, this.myGroupList, this.groupProfile, this.groupMembers).withOptionalLoadables(this.agentCircuit).withDataChangedListener(this)
    ...
    private class GroupMemberListRecyclerAdapter : RecyclerView().Adapter<GroupMemberViewHolder> {
        private val Int cardSelectedColor
    ...
    private class GroupMemberViewHolder : RecyclerView().ViewHolder : ChatterNameRetriever.OnChatterNameUpdated, View.OnClickListener {
        ...
        private val Button groupMemberChatButton
        private val Button groupMemberEjectButton
        private val Button groupMemberProfileButton
        private val Button groupMemberRolesButton
        private val View selectedLayout
        private val TextView userNameTextView
        private val TextView userOnlineStatusText
        private val ChatterPicView userPicView
        private val TextView userTitleText
    ...
    fun addGroupRoleMember(ChatterID.ChatterIDUser chatterIDUser) {
        ...
        if (uuid != null) {
            AlertDialog.Builder(getContext()).setTitle((Int) R.string.add_role_member_confirm).setPositiveButton((Int) R.string.yes_add_button, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, uuid, chatterIDUser) {
                ...
                /* renamed from: -$f0 */
                private val /* synthetic */ Object f274$f0

                /* renamed from: -$f1 */
                private val /* synthetic */ Object f275$f1

                /* renamed from: -$f2 */
                private val /* synthetic */ Object f276$f2

                private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.4.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.4.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    fun ejectGroupMember(ChatterID.ChatterIDUser chatterIDUser) {
        AlertDialog.Builder(getContext()).setTitle((Int) R.string.eject_member_confirm).setPositiveButton((Int) R.string.yes_eject_button, (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, chatterIDUser) {
            ...
            /* renamed from: -$f0 */
            private val /* synthetic */ Object f272$f0

            /* renamed from: -$f1 */
            private val /* synthetic */ Object f273$f1

            private val /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.3.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.3.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
Method generation error in method: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.ui.chat.profiles.-$Lambda$MA84Fd9rUtD4VNMgzavMq_NILXY.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    public /* synthetic */ Unit m474lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMembersProfileTab_13581(UUID uuid, ChatterID.ChatterIDUser chatterIDUser, DialogInterface dialogInterface, Int i) {
        try {
    ...
    public /* synthetic */ Unit m475lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_GroupMembersProfileTab_14656(ChatterID.ChatterIDUser chatterIDUser, DialogInterface dialogInterface, Int i) {
        try {
