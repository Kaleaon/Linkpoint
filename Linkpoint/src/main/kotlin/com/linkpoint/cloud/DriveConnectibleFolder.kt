...
internal class DriveConnectibleFolder(
    ...
    resourceName: String
) : DriveConnectibleResource(context, driveSynchronizer, preferencesKey, driveConnectibleResource, googleApiClient, resourceName) {
    ...
    override fun getMimeType(): String = "application/vnd.google-apps.folder"

    override fun isMetadataOk(metadata: Metadata): Boolean {
        return !metadata.isTrashed && !metadata.isExplicitlyTrashed && metadata.isFolder
    }
}