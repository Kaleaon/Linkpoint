package com.linkpoint.repository

import com.linkpoint.database.dao.ChatMessageDao
import com.linkpoint.database.dao.ChatterDao
import com.linkpoint.database.entities.ChatMessageEntity
import com.linkpoint.database.entities.ChatterEntity
...
class ChatRepository @Inject constructor(
     ...
     */
    fun getMessagesForChatter(chatterId: Long): Flow<List<ChatMessageEntity>> {
     ...
     */
    suspend fun getRecentMessages(chatterId: Long, limit: Int = 50): List<ChatMessageEntity> {
     ...
     */
    fun getActiveChatters(): Flow<List<ChatterEntity>> {
     ...
     */
    fun getChattersWithUnread(): Flow<List<ChatterEntity>> {
    ...
    suspend fun getOrCreateChatter(
        uuid: UUID,
        type: ChatterEntity.ChatterType
    ): ChatterEntity {
