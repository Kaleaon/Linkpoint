...
class ModernRenderContext {
    ...
    private var hasTessellation: Boolean = false    // ES 3.2+  
    private var hasGeometryShaders: Boolean = false // ES 3.2+
     ...
     */
    fun hasComputeShaders(): Boolean { return hasComputeShaders; }
