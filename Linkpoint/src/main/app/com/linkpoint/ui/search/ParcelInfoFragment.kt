...
class ParcelInfoFragment : FragmentWithTitle : ReloadableFragment, LoadableMonitor.OnLoadableDataChangedListener, ChatterNameRetriever.OnChatterNameUpdated {
    ...
    /* synthetic */ Unit m848lambda$com_lumiyaviewer_lumiya_ui_search_ParcelInfoFragment_9137(UserManager userManager, LLVector3 lLVector3, DialogInterface dialogInterface, Int i) {
    ...
    @OnClick({2131755608})
    Unit onParcelOwnerProfileClick() {
        UUID activeAgentID = ActivityUtils.getActiveAgentID(getArguments())
        ParcelInfoReply data = this.parcelInfoReply.getData()
    ...
    Unit onParcelTeleportButton() {
        ...
        if (data != null && userManager != null) {
            ...
            builder.setMessage(getActivity().getString(R.string.teleport_parcel_confirm_title)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(this, userManager, lLVector3) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f581$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f582$f1

                /* renamed from: -$f2 */
                private /* synthetic */ Any f583$f2

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.search.-$Lambda$5Jqy4HmgAu6T9fnroWh-Zqm3eJE.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.search.-$Lambda$5Jqy4HmgAu6T9fnroWh-Zqm3eJE.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
