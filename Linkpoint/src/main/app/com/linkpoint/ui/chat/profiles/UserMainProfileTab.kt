...
class UserMainProfileTab : ChatterReloadableFragment : LoadableMonitor.OnLoadableDataChangedListener {
    ...
    private ChatterNameRetriever.OnChatterNameUpdated onPartnerNameReady = $Lambda$wqoLfTfjESd1OUBLJEQMKRim4S0(this)
    ...
    /* synthetic */ Unit m509lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_UserMainProfileTab_9585(ChatterNameRetriever chatterNameRetriever) {
        if (getView() != null) {
