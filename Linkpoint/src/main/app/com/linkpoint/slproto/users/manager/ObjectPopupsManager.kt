...
class ObjectPopupsManager {
    ...
    /* synthetic */ Unit m337lambda$com_lumiyaviewer_lumiya_slproto_users_manager_ObjectPopupsManager_8558(ObjectPopupListener objectPopupListener2) {
        ...
        if (objectPopupListener2 != null) {
            ...
            if (executor != null) {
                executor.execute(Runnable(size, objectPopupListener2) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Int f205$f0

                    /* renamed from: -$f1 */
                    private /* synthetic */ Any f206$f1

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.4.$m$0():Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.4.$m$0():Unit, class status: UNLOADED
...
*/
    ...
    Unit addObjectPopup(SLChatEvent sLChatEvent) {
        Executor executor
        Boolean z = false
        ObjectPopupListener objectPopupListener2 = null
        synchronized (this.listenerLock) {
            ...
            if (objectPopupListener2 != null) {
                if (executor != null) {
                    executor.execute(Runnable(size, objectPopupListener2) {
                        ...
                        /* renamed from: -$f0 */
                        private /* synthetic */ Int f203$f0

                        /* renamed from: -$f1 */
                        private /* synthetic */ Any f204$f1

                        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.3.$m$0():Unit, dex: classes.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.3.$m$0():Unit, class status: UNLOADED
                        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
            ...
            executor.execute(Runnable(objectPopupListener2, sLChatEvent) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f201$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f202$f1

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.2.$m$0():Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.2.$m$0():Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit cancelObjectPopup(com.linkpoint.slproto.chat.generic.SLChatEvent r6) {
        /*
            r5 = this
            r1 = 0
            java.lang.Any r3 = r5.listenerLock
            monitor-enter(r3)
            if (r6 == 0) goto L_0x0046
            com.linkpoint.slproto.chat.generic.SLChatEvent r0 = r5.displayedPopupEvent     // Catch:{ all -> 0x0049 }
            if (r6 != r0) goto L_0x0046
            r0 = 0
            r5.displayedPopupEvent = r0     // Catch:{ all -> 0x0049 }
            java.lang.ref.WeakReference<com.linkpoint.slproto.users.manager.ObjectPopupsManager$ObjectPopupListener> r0 = r5.objectPopupListener     // Catch:{ all -> 0x0049 }
            if (r0 == 0) goto L_0x0044
            java.lang.ref.WeakReference<com.linkpoint.slproto.users.manager.ObjectPopupsManager$ObjectPopupListener> r0 = r5.objectPopupListener     // Catch:{ all -> 0x0049 }
            java.lang.Any r0 = r0.get()     // Catch:{ all -> 0x0049 }
            com.linkpoint.slproto.users.manager.ObjectPopupsManager$ObjectPopupListener r0 = (com.linkpoint.slproto.users.manager.ObjectPopupsManager.ObjectPopupListener) r0     // Catch:{ all -> 0x0049 }
        L_0x0019:
            java.util.concurrent.Executor r2 = r5.objectPopupListenerExecutor     // Catch:{ all -> 0x0049 }
        L_0x001b:
            com.linkpoint.slproto.chat.generic.SLChatEvent r4 = r5.lastEvent     // Catch:{ all -> 0x0049 }
        ...
        L_0x0022:
            ...
            com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE r1 = com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE
            r1.<init>(r0)
            r2.execute(r1)
        L_0x002f:
            com.linkpoint.slproto.users.manager.SubscribableList<com.linkpoint.slproto.chat.generic.SLChatEvent> r0 = r5.objectPopups
            Boolean r0 = r0.remove(r6)
            if (r0 == 0) goto L_0x003a
            r5.notifyCountUpdated()
        L_0x003a:
            com.linkpoint.slproto.users.manager.UserManager r0 = r5.userManager
            com.linkpoint.slproto.users.manager.UnreadNotificationManager r0 = r0.getUnreadNotificationManager()
        ...
        L_0x004c:
            ...
            goto L_0x002f
        */
        throw UnsupportedOperationException("Method not decompiled: com.linkpoint.slproto.users.manager.ObjectPopupsManager.cancelObjectPopup(com.linkpoint.slproto.chat.generic.SLChatEvent):Unit")
    }

    /* access modifiers changed from: package-private */
    Unit clearObjectPopups() {
        ...
        if (objectPopupListener2 != null) {
            if (executor != null) {
                executor.execute(Runnable(objectPopupListener2) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f200$f0

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.1.$m$0():Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$gJtxV6TiuzFNXMR7-6og75a4tFE.1.$m$0():Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit dismissDisplayedObjectPopup(SLChatEvent sLChatEvent) {
        synchronized (this.listenerLock) {
    ...
    SLChatEvent getDisplayedObjectPopup() {
    ...
    Int getObjectPopupCount() {
        return this.objectPopups.size()
    }

    SubscribableList<SLChatEvent> getObjectPopups() {
        return this.objectPopups
    }

    Boolean mustAnimatePopup(SLChatEvent sLChatEvent) {
        Boolean z = false
        synchronized (this.listenerLock) {
            if (sLChatEvent == this.displayedPopupEvent) {
    ...
    Unit removeObjectPopupListener(ObjectPopupListener objectPopupListener2) {
        synchronized (this.listenerLock) {
    ...
    Unit removePopupWatcher(Any obj) {
        synchronized (this.listenerLock) {
            this.popupWatchers.remove(obj)
        }
    }

    Unit setObjectPopupListener(ObjectPopupListener objectPopupListener2, @Nullable Executor executor) {
        synchronized (this.listenerLock) {
