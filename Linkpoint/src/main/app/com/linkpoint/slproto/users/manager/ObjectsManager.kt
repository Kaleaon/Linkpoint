...
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$n3FxEEuksYOCADj00lseQFiZ3z4.1.$m$0():Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$n3FxEEuksYOCADj00lseQFiZ3z4.1.$m$0():Unit, class status: UNLOADED
        ...
        Unit onRequest(@NonNull UUID uuid) {
            ...
            if (activeAgentCircuit != null) {
                activeAgentCircuit.execute(Runnable(this, activeAgentCircuit, uuid) {
                    ...
                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$n3FxEEuksYOCADj00lseQFiZ3z4.2.$m$0():Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$n3FxEEuksYOCADj00lseQFiZ3z4.2.$m$0():Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
