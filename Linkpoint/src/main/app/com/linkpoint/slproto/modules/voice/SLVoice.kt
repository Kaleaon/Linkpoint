...
class SLVoice : SLModule {
    ...
    private String parcelVoiceCapURL
    private Any parcelVoiceChannelLock = Any()
    private Set<UUID> requestedGroupChats = Collections.synchronizedSet(HashSet())
    private Int requestedParcelID = -1
    private volatile Boolean shutdown = false
    /* access modifiers changed from: private */
    UserManager userManager = UserManager.getUserManager(this.agentCircuit.getAgentUUID())
    private Boolean voiceCredentialsRequested = false
    /* access modifiers changed from: private */
    volatile Boolean voiceEnabled = false
    /* access modifiers changed from: private */
    volatile Boolean voiceLoggedIn = false
    private SubscriptionData<SubscriptionSingleKey, Boolean> voiceLoggedInSubscription = SubscriptionData<>(UIThreadExecutor.getInstance(), $Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY(this))
    @Nullable
    private volatile VoiceLoginInfo voiceLoginInfo = null
    /* access modifiers changed from: private */
    @Nullable
    volatile VoicePluginServiceConnection voicePluginServiceConnection = null

    SLVoice(SLAgentCircuit sLAgentCircuit, SLCaps sLCaps) {
        ...
        if (this.capURL != null) {
            ...
            Debug.Printf("Voice cap not supported", Any[0])
        }
    ...
    Unit m253com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoicemthref3(LLSDNode lLSDNode) {
        if (lLSDNode != null) {
            try {
    ...
    Unit m252com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoicemthref2(LLSDNode lLSDNode) {
        if (lLSDNode != null) {
            try {
            ...
            Debug.Printf("SLVoice: null result", Any[0])
            if (this.shutdown || this.loginAttempts >= 3 || !this.voiceEnabled) {
                Debug.Printf("SLVoice: giving up", Any[0])
                return
            }
            this.loginAttempts++
            try {
                ...
                if (!this.shutdown && this.voiceEnabled) {
                    LLSDXMLAsyncRequest(this.capURL, LLSDUndefined(), LLSDXMLAsyncRequest.LLSDXMLResultListener(this) {
                        ...
                        /* renamed from: -$f0 */
                        private /* synthetic */ Any f133$f0

                        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.2.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, dex: classes.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.2.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, class status: UNLOADED
...
*/
    ...
    Unit m250com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoicemthref0(Boolean bool) {
    ...
    VoiceChannelInfo getCurrentParcelVoiceChannel() {
    ...
    Boolean groupVoiceChatRequest(UUID uuid) {
    ...
    /* synthetic */ Unit m254lambda$com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoice_12525(Int i, LLSDNode lLSDNode) {
        VoiceChannelInfo voiceChannelInfo
        ...
        if (lLSDNode != null) {
            synchronized (this.parcelVoiceChannelLock) {
                try {
                    ...
                    Debug.Printf("Voice: error retrieving parcel voice info for %d (%s)", Int.valueOf(i), e.getMessage())
            ...
            Debug.Printf("Voice: error retrieving parcel voice info for %d", Int.valueOf(i))
            z = false
        }
        if (z) {
    ...
    /* synthetic */ Unit m255lambda$com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoice_14030(VoiceLoginStatus voiceLoginStatus, VoicePluginServiceConnection voicePluginServiceConnection2) {
    ...
    /* synthetic */ Unit m256lambda$com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoice_14408(VoiceChannelStatus voiceChannelStatus) {
    ...
    /* synthetic */ Unit m257lambda$com_lumiyaviewer_lumiya_slproto_modules_voice_SLVoice_4388() {
        ...
        if (!this.voiceEnabled) {
            ...
            if (this.capURL != null) {
                LLSDXMLAsyncRequest(this.capURL, LLSDUndefined(), LLSDXMLAsyncRequest.LLSDXMLResultListener(this) {
                    ...
                    /* renamed from: -$f0 */
                    private /* synthetic */ Any f132$f0

                    private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.1.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, dex: classes.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.1.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit nearbyVoiceChatRequest(VoiceChannelInfo voiceChannelInfo) {
    ...
    Unit onGroupSessionReady(UUID uuid) {
    ...
    Unit onVoiceChannelStatus(VoiceChannelStatus voiceChannelStatus) {
        this.agentCircuit.execute(Runnable(this, voiceChannelStatus) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f136$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f137$f1

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.5.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.5.$m$0():Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit onVoiceLoginStatus(VoicePluginServiceConnection voicePluginServiceConnection2, VoiceLoginStatus voiceLoginStatus) {
        this.agentCircuit.execute(Runnable(this, voiceLoginStatus, voicePluginServiceConnection2) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f138$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f139$f1

            /* renamed from: -$f2 */
            private /* synthetic */ Any f140$f2

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.6.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.6.$m$0():Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Boolean requestParcelVoiceInfo() {
        ...
        LLSDXMLAsyncRequest(this.parcelVoiceCapURL, LLSDUndefined(), LLSDXMLAsyncRequest.LLSDXMLResultListener(this) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f134$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.3.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.3.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
    ...
    Unit setCurrentParcel(Int i) {
        ...
        if (z) {
            LLSDXMLAsyncRequest(this.parcelVoiceCapURL, LLSDUndefined(), LLSDXMLAsyncRequest.LLSDXMLResultListener(i, this) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Int f141$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f142$f1

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.7.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.7.$m$0(com.linkpoint.slproto.llsd.LLSDNode):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Unit updateSpatialVoicePosition() {
        VoicePluginServiceConnection voicePluginServiceConnection2 = this.voicePluginServiceConnection
    ...
    Unit updateVoiceEnabledStatus() {
        UIThreadExecutor.getInstance().execute(Runnable(this) {

            /* renamed from: -$f0 */
            private /* synthetic */ Any f135$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.4.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.modules.voice.-$Lambda$RETWaU3Ta92aG3GeBeXvI3Y9viY.4.$m$0():Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Boolean userVoiceChatRequest(UUID uuid) {
        VoicePluginServiceConnection voicePluginServiceConnection2 = this.voicePluginServiceConnection
