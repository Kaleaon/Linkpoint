...
import com.linkpoint.openjpeg.OpenJPEG.ImageFormat
...
object OpenJPEGIntegrationTest {
    ...
    private void testFormatDetection() {
    ...
    private void testKTX2Initialization() {
    ...
    fun testTextureLoadingPipeline(): Unit {
        ...
        try {
            ...
            // For now, just verify that the enhanced OpenJPEG object maintains compatibility
