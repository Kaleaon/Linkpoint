...
object GlobalOptions : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    @Volatile private var themeResId: Int = R.style.Theme_LinkpointCompat_Light
    ...
    fun initialize(context: Context? = null) {
        ...
        val targetContext = context ?: runCatching { LinkpointApp.getContext() }
            .getOrElse { error ->
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        val context = runCatching { LinkpointApp.getContext() }.getOrElse { error ->
    ...
    fun getCacheDir(child: String): File {
        val base = cacheBaseDirRef.get() ?: runCatching { LinkpointApp.getContext().cacheDir }
            .getOrElse { error ->
    ...
    private fun updateState(context: Context, prefs: SharedPreferences) {
        ...
        themeResId = when (prefs.getString("theme", "light")) {
            "dark" -> R.style.Theme_LinkpointCompat
            "pink" -> R.style.Theme_LinkpointCompat_Pink
            else -> R.style.Theme_LinkpointCompat_Light
        }
