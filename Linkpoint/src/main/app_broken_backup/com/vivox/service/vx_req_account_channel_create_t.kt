...
class vx_req_account_channel_create_t {
     ...
     */
    protected Long getCPtr(vx_req_account_channel_create_t vx_req_account_channel_create_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_account_channel_create_t_base_get(this.swigCPtr, this)
    ...
    vx_channel_type getChannel_type() {
    ...
    Unit setChannel_type(vx_channel_type vx_channel_type2) {
