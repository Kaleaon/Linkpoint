...
class vx_resp_account_authtoken_login_t {
     ...
     */
    protected Long getCPtr(vx_resp_account_authtoken_login_t vx_resp_account_authtoken_login_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_account_authtoken_login_t_base_get(this.swigCPtr, this)
