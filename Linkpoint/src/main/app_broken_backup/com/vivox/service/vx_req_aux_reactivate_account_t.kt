...
class vx_req_aux_reactivate_account_t {
     ...
     */
    protected Long getCPtr(vx_req_aux_reactivate_account_t vx_req_aux_reactivate_account_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_aux_reactivate_account_t_base_get(this.swigCPtr, this)
    ...
    vx_generic_credentials getCredentials() {
        var l: Long = VxClientProxyJNI.vx_req_aux_reactivate_account_t_credentials_get(this.swigCPtr, this)
