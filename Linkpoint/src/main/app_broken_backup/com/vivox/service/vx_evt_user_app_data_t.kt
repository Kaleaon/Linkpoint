...
class vx_evt_user_app_data_t {
     ...
     */
    protected Long getCPtr(vx_evt_user_app_data_t vx_evt_user_app_data_t2) {
    ...
    vx_evt_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_evt_user_app_data_t_base_get(this.swigCPtr, this)
    ...
    Unit setFrom_uri(String string2) {
