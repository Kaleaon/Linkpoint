...
class vx_req_account_login_t {
     ...
     */
    protected Long getCPtr(vx_req_account_login_t vx_req_account_login_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_account_login_t_base_get(this.swigCPtr, this)
    ...
    Unit setEnable_client_ringback(Int n) {
