...
class vx_resp_aux_get_vad_properties_t {
     ...
     */
    protected Long getCPtr(vx_resp_aux_get_vad_properties_t vx_resp_aux_get_vad_properties_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_aux_get_vad_properties_t_base_get(this.swigCPtr, this)
