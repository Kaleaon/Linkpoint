...
class vx_evt_media_stream_updated_t {
     ...
     */
    protected Long getCPtr(vx_evt_media_stream_updated_t vx_evt_media_stream_updated_t2) {
    ...
    vx_evt_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_evt_media_stream_updated_t_base_get(this.swigCPtr, this)
    ...
    vx_session_media_state getState() {
    ...
    Unit setState(vx_session_media_state vx_session_media_state2) {
