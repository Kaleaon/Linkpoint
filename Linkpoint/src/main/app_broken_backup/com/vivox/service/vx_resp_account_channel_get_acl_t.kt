...
class vx_resp_account_channel_get_acl_t {
     ...
     */
    protected Long getCPtr(vx_resp_account_channel_get_acl_t vx_resp_account_channel_get_acl_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_account_channel_get_acl_t_base_get(this.swigCPtr, this)
    ...
    SWIGTYPE_p_p_vx_participant getParticipants() {
        var l: Long = VxClientProxyJNI.vx_resp_account_channel_get_acl_t_participants_get(this.swigCPtr, this)
