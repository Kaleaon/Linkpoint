...
class vx_req_aux_render_audio_modify_t {
     ...
     */
    protected Long getCPtr(vx_req_aux_render_audio_modify_t vx_req_aux_render_audio_modify_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_aux_render_audio_modify_t_base_get(this.swigCPtr, this)
    ...
    Unit setFont_str(String string2) {
