...
class vx_resp_aux_connectivity_info_t {
     ...
     */
    protected Long getCPtr(vx_resp_aux_connectivity_info_t vx_resp_aux_connectivity_info_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_aux_connectivity_info_t_base_get(this.swigCPtr, this)
     ...
     * Lifted jumps to return sites
     */
    SWIGTYPE_p_p_vx_connectivity_test_result getTest_results() {
        var l: Long = VxClientProxyJNI.vx_resp_aux_connectivity_info_t_test_results_get(this.swigCPtr, this)
        if (l != 0L) return SWIGTYPE_p_p_vx_connectivity_test_result(l, false)
        return null
    }
    ...
    Unit setTest_results(SWIGTYPE_p_p_vx_connectivity_test_result sWIGTYPE_p_p_vx_connectivity_test_result) {
