...
class vx_resp_aux_render_audio_start_t {
     ...
     */
    protected Long getCPtr(vx_resp_aux_render_audio_start_t vx_resp_aux_render_audio_start_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_aux_render_audio_start_t_base_get(this.swigCPtr, this)
