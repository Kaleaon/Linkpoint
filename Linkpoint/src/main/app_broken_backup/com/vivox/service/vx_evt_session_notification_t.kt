...
class vx_evt_session_notification_t {
     ...
     */
    protected Long getCPtr(vx_evt_session_notification_t vx_evt_session_notification_t2) {
    ...
    vx_evt_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_evt_session_notification_t_base_get(this.swigCPtr, this)
    ...
    vx_session_notification_state getState() {
    ...
    Unit setState(vx_session_notification_state vx_session_notification_state2) {
