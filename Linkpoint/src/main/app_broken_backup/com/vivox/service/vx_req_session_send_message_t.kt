...
class vx_req_session_send_message_t {
     ...
     */
    protected Long getCPtr(vx_req_session_send_message_t vx_req_session_send_message_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_session_send_message_t_base_get(this.swigCPtr, this)
