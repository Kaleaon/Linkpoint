...
class vx_resp_account_buddy_search_t {
     ...
     */
    protected Long getCPtr(vx_resp_account_buddy_search_t vx_resp_account_buddy_search_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_account_buddy_search_t_base_get(this.swigCPtr, this)
    ...
    SWIGTYPE_p_p_vx_buddy getBuddies() {
        var l: Long = VxClientProxyJNI.vx_resp_account_buddy_search_t_buddies_get(this.swigCPtr, this)
