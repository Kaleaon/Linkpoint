...
class vx_evt_participant_added_t {
     ...
     */
    protected Long getCPtr(vx_evt_participant_added_t vx_evt_participant_added_t2) {
    ...
    vx_evt_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_evt_participant_added_t_base_get(this.swigCPtr, this)
    ...
    Unit setParticipant_type(Int n) {
