...
class vx_resp_account_get_session_fonts_t {
     ...
     */
    protected Long getCPtr(vx_resp_account_get_session_fonts_t vx_resp_account_get_session_fonts_t2) {
    ...
    vx_resp_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_resp_account_get_session_fonts_t_base_get(this.swigCPtr, this)
        if (l != 0L) return vx_resp_base_t(l, false)
        return null
    }

    Int getSession_font_count() {
     ...
     * Lifted jumps to return sites
     */
    SWIGTYPE_p_p_vx_voice_font getSession_fonts() {
        var l: Long = VxClientProxyJNI.vx_resp_account_get_session_fonts_t_session_fonts_get(this.swigCPtr, this)
    ...
    Unit setSession_font_count(Int n) {
        VxClientProxyJNI.vx_resp_account_get_session_fonts_t_session_font_count_set(this.swigCPtr, this, n)
    }

    Unit setSession_fonts(SWIGTYPE_p_p_vx_voice_font sWIGTYPE_p_p_vx_voice_font) {
