...
class vx_req_aux_set_idle_timeout_t {
     ...
     */
    protected Long getCPtr(vx_req_aux_set_idle_timeout_t vx_req_aux_set_idle_timeout_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_aux_set_idle_timeout_t_base_get(this.swigCPtr, this)
