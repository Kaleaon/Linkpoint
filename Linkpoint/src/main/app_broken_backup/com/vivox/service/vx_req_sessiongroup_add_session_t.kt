...
class vx_req_sessiongroup_add_session_t {
     ...
     */
    protected Long getCPtr(vx_req_sessiongroup_add_session_t vx_req_sessiongroup_add_session_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_sessiongroup_add_session_t_base_get(this.swigCPtr, this)
