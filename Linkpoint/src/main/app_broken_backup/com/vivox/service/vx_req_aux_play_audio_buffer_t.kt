...
class vx_req_aux_play_audio_buffer_t {
     ...
     */
    protected Long getCPtr(vx_req_aux_play_audio_buffer_t vx_req_aux_play_audio_buffer_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_aux_play_audio_buffer_t_base_get(this.swigCPtr, this)
    ...
    Unit setTemplate_font_id(Int n) {
