...
class vx_req_channel_mute_user_t {
     ...
     */
    protected Long getCPtr(vx_req_channel_mute_user_t vx_req_channel_mute_user_t2) {
    ...
    vx_req_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_req_channel_mute_user_t_base_get(this.swigCPtr, this)
