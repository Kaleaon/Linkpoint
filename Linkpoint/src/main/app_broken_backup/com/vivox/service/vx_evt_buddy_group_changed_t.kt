...
class vx_evt_buddy_group_changed_t {
     ...
     */
    protected Long getCPtr(vx_evt_buddy_group_changed_t vx_evt_buddy_group_changed_t2) {
    ...
    vx_evt_base_t getBase() {
        var l: Long = VxClientProxyJNI.vx_evt_buddy_group_changed_t_base_get(this.swigCPtr, this)
