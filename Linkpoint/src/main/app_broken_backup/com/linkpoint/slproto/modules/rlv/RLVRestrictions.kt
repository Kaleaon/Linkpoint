...
class RLVRestrictions {
    private Map<RLVRestrictionType, RLVRestrictionList> restrictions = EnumMap(RLVRestrictionType.class)
    ...
    private class RLVRestrictionList {
        ...
        private /* synthetic */ IntArray f127comlumiyaviewerlumiyaslprotomodulesrlvRLVRestrictionType$RLVRuleMatchTypeSwitchesValues = null
        ...
        fun isAllowed(com.linkpoint.slproto.modules.rlv.RLVRestrictionType.RLVRuleMatchType r6, java.lang.String r7, java.util.UUID r8, java.util.UUID r9): Boolean {
            /*
                ...
                r4 = 1
                r3 = 0
                com.linkpoint.slproto.modules.rlv.RLVRestrictionType$RLVRuleMatchType r0 = com.linkpoint.slproto.modules.rlv.RLVRestrictionType.RLVRuleMatchType.TargetSpecifiesAllowance
    ...
    synchronized Unit addRestriction(RLVRestrictionType rLVRestrictionType, UUID uuid, String str) {
        if (str == null) {
            str = ""
        }
    ...
    synchronized List<RLVRestrictionType> getRestrictionsByObject(UUID uuid) {
    ...
    synchronized Set<String> getTargetsForRestriction(RLVRestrictionType rLVRestrictionType) {
        RLVRestrictionList rLVRestrictionList = this.restrictions.get(rLVRestrictionType)
        if (rLVRestrictionList == null) {
            return null
        }
    ...
    synchronized Boolean isAllowed(RLVRestrictionType rLVRestrictionType, String str, UUID uuid) {
        return isAllowed(rLVRestrictionType, str, uuid, (UUID) null)
    }

    synchronized Boolean isAllowed(RLVRestrictionType rLVRestrictionType, String str, UUID uuid, UUID uuid2) {
        if (str == null) {
            str = ""
        }
        RLVRestrictionList rLVRestrictionList = this.restrictions.get(rLVRestrictionType)
    ...
    synchronized Unit removeRestriction(RLVRestrictionType rLVRestrictionType, UUID uuid, String str) {
        if (str == null) {
            str = ""
        }
    ...
    synchronized Unit removeRestrictions(UUID uuid, Set<RLVRestrictionType> set) {
        Debug.Printf("RLV: removing %d restrictions for object %s", Int.valueOf(set.size()), uuid)
