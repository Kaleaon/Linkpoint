...
class GroupManager {
    ...
    private RateLimitRequestHandler<UUID, UUID> groupMemberDataSetHandler
    private SubscriptionPool<UUID, UUID> groupMemberDataSetPool = SubscriptionPool<>()
    /* access modifiers changed from: private */
    GroupMemberListDao groupMemberListDao
    /* access modifiers changed from: private */
    SubscriptionPool<GroupMemberRolesQuery, Set<UUID>> groupMemberRolesSubscriptionPool = SubscriptionPool<>()
    /* access modifiers changed from: private */
    SubscriptionPool<GroupMembersQuery, LazyList<GroupMember>> groupMembersSubscriptionPool = SubscriptionPool<>()
    /* access modifiers changed from: private */
    GroupRoleMemberDao groupRoleMemberDao
    private RateLimitRequestHandler<UUID, UUID> groupRoleMemberDataSetHandler
    private SubscriptionPool<UUID, UUID> groupRoleMemberDataSetPool = SubscriptionPool<>()
    /* access modifiers changed from: private */
    GroupRoleMemberListDao groupRoleMemberListDao
    /* access modifiers changed from: private */
    ...
    abstract class GroupMemberRolesQuery {
        ...
        abstract UUID groupID()

        abstract UUID memberID()

        abstract UUID requestID()
    }
    ...
    GroupManager(@NonNull UserManager userManager2, @NonNull DaoSession daoSession, @NonNull ChatterList chatterList2) {
        ...
        this.subscription = userManager2.getAvatarGroupLists().getPool().subscribe(userManager2.getUserID(), Subscription.OnData(this) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f218$f0

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.2.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.2.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
        ...
        this.groupMembersSubscriptionPool.setDisposeHandler(DisposeHandler() {
            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.1.$m$0(java.lang.Any):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.1.$m$0(java.lang.Any):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    Subscribable<GroupMemberRolesQuery, Set<UUID>> getGroupMemberRoleList() {
    ...
    Subscribable<GroupMembersQuery, LazyList<GroupMember>> getGroupMembersList() {
    ...
    Subscribable<GroupRoleMembersQuery, LazyList<GroupRoleMember>> getGroupRoleMemberList() {
    ...
    fun requestGroupRoleMembersRefresh(UUID uuid)  {
        this.userManager.getDatabaseExecutor().execute(Runnable(this, uuid) {
            ...
            /* renamed from: -$f0 */
            private /* synthetic */ Any f219$f0

            /* renamed from: -$f1 */
            private /* synthetic */ Any f220$f1

            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.3.$m$0():Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.slproto.users.manager.-$Lambda$u_XXTkSOKCgaVXhhU-plrxzPP28.3.$m$0():Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
