...
import com.linkpoint.slproto.chat.generic.ChatScriptDialogViewHolder
...
class SLChatScriptDialog : SLChatDialogEvent {
    ...
    class ScriptDialogDialog : Dialog : View.OnClickListener, DialogInterface.OnCancelListener {
        ...
        ScriptDialogDialog(Context context, UserManager userManager2, String str, String str2) {
            super(context)
