...
class UploadImageAsyncTask : AsyncTask<UploadImageParams, Void, UploadImageResult> {
    private MediaType MEDIA_TYPE_JP2 = MediaType.parse("image/jp2")
    ...
    UploadImageAsyncTask(Context context2, UUID uuid) {
    ...
    fun onPostExecute(com.linkpoint.ui.inventory.UploadImageAsyncTask.UploadImageResult r4)  {
        ...
        L_0x0014:
            ...
            com.linkpoint.slproto.users.manager.UserManager r1 = com.linkpoint.slproto.users.manager.UserManager.getUserManager(r1)
            if (r1 == 0) goto L_0x0022
            com.linkpoint.slproto.SLAgentCircuit r0 = r1.getActiveAgentCircuit()
        L_0x0022:
            if (r0 == 0) goto L_0x0037
            com.linkpoint.slproto.modules.SLModules r0 = r0.getModules()
            com.linkpoint.slproto.inventory.SLInventory r0 = r0.inventory
            java.util.UUID r0 = r0.findSpecialFolder(r2)
            if (r0 == 0) goto L_0x0037
            com.linkpoint.slproto.users.manager.InventoryManager r1 = r1.getInventoryManager()
        ...
        L_0x0047:
            ...
            com.linkpoint.ui.inventory.-$Lambda$zdXuDSYysFkzF70MB3S4I5y4LlM r2 = com.linkpoint.ui.inventory.-$Lambda$zdXuDSYysFkzF70MB3S4I5y4LlM
            r2.<init>()
        ...
        L_0x0064:
            ...
            goto L_0x0047
        */
        throw UnsupportedOperationException("Method not decompiled: com.linkpoint.ui.inventory.UploadImageAsyncTask.onPostExecute(com.linkpoint.ui.inventory.UploadImageAsyncTask$UploadImageResult):Unit")
    }
