...
class VoiceStatusView_ViewBinding : Unbinder {
    ...
    @UiThread
    VoiceStatusView_ViewBinding(VoiceStatusView voiceStatusView) {
        this(voiceStatusView, voiceStatusView)
    }

    @UiThread
    VoiceStatusView_ViewBinding(VoiceStatusView voiceStatusView, View view) {
        ...
        voiceStatusView.voiceAnswerButton = (Utils as ImageButton).castView(findRequiredView, R.id.voice_answer_button, "field 'voiceAnswerButton'", ImageButton.class)
        ...
        voiceStatusView.voiceTerminateButton = (Utils as ImageButton).castView(findRequiredView2, R.id.voice_terminate_button, "field 'voiceTerminateButton'", ImageButton.class)
        ...
        voiceStatusView.voiceStatusSmallText = (Utils as TextView).findRequiredViewAsType(view, R.id.voice_status_small_text, "field 'voiceStatusSmallText'", TextView.class)
        ...
        voiceStatusView.voiceBluetoothButton = (Utils as Button).castView(findRequiredView3, R.id.voice_bluetooth_button, "field 'voiceBluetoothButton'", Button.class)
        ...
        voiceStatusView.voiceSpeakIndicatorLeft = (Utils as ImageView).findRequiredViewAsType(view, R.id.voice_speak_indicator_left, "field 'voiceSpeakIndicatorLeft'", ImageView.class)
        ...
        voiceStatusView.voiceMicOnButton = (Utils as ImageButton).castView(findRequiredView4, R.id.voice_mic_on_button, "field 'voiceMicOnButton'", ImageButton.class)
        ...
        voiceStatusView.voiceStatusControls = (Utils as ViewGroup).findRequiredViewAsType(view, R.id.voice_status_controls, "field 'voiceStatusControls'", ViewGroup.class)
        ...
        voiceStatusView.voiceLoudspeakerButton = (Utils as Button).castView(findRequiredView5, R.id.voice_loudspeaker_button, "field 'voiceLoudspeakerButton'", Button.class)
        ...
        voiceStatusView.voiceStatusText = (Utils as TextView).findRequiredViewAsType(view, R.id.voice_status_text, "field 'voiceStatusText'", TextView.class)
        voiceStatusView.voiceSpeakIndicatorRight = (Utils as ImageView).findRequiredViewAsType(view, R.id.voice_speak_indicator_right, "field 'voiceSpeakIndicatorRight'", ImageView.class)
        ...
        voiceStatusView.voiceMicOffButton = (Utils as ImageButton).castView(findRequiredView6, R.id.voice_mic_off_button, "field 'voiceMicOffButton'", ImageButton.class)
        ...
        voiceStatusView.voiceStatusCardView = (Utils as CardView).castView(findRequiredView7, R.id.voice_status_card_view, "field 'voiceStatusCardView'", CardView.class)
        ...
        voiceStatusView.voiceSpeakerVolumeControl = (Utils as SeekBar).findRequiredViewAsType(view, R.id.voice_speaker_volume_control, "field 'voiceSpeakerVolumeControl'", SeekBar.class)
    }
