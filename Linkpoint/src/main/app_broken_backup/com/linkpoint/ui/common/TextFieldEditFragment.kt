...
/*
Method generation error in method: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.2.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.2.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
...
*/
            ...
            private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
            	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
            	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
            	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
            ...
            case R.id.item_undo:
                ...
                if (view != null && !Objects.equal(((view as TextView).findViewById(R.id.field_edit_text)).getText().toString(), this.originalText)) {
                    ...
                    builder.setMessage(getString(R.string.discard_changes_question)).setCancelable(true).setPositiveButton("Yes", DialogInterface.OnClickListener(this, view) {
                        ...
                        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.3.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.common.-$Lambda$DtZUcoBgRyVu-s24uOe08hwsuHo.3.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
