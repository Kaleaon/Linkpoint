package com.linkpoint.ui.opengl

import android.content.Context
import android.opengl.GLSurfaceView
import android.view.MotionEvent
import com.linkpoint.graphics.opengl.OpenGLWorldRenderer
...
class OpenGLWorldView(context: Context) : GLSurfaceView(context) {
    ...
    fun connectToWorldData(
        objectsManager: com.linkpoint.slproto.users.manager.ObjectsManager? = null,
        userManager: com.linkpoint.slproto.users.manager.UserManager? = null,
        terrainData: com.linkpoint.slproto.terrain.TerrainData? = null
    ) {
