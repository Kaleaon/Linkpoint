...
class SearchGridFragment_ViewBinding : Unbinder {
    ...
    SearchGridFragment_ViewBinding(SearchGridFragment searchGridFragment, View view) {
        ...
        searchGridFragment.searchString = (Utils as EditText).castView(findRequiredView, R.id.search_string, "field 'searchString'", EditText.class)
        this.view2131755639 = findRequiredView
        ((TextView) findRequiredView).setOnEditorActionListener(TextView.OnEditorActionListener() {
            fun onEditorAction(TextView textView, Int i, KeyEvent keyEvent): Boolean {
                return searchGridFragment.onSearchTextAction(i, keyEvent)
            }
        searchGridFragment.searchResultsList = (Utils as RecyclerView).findRequiredViewAsType(view, R.id.search_results_list, "field 'searchResultsList'", RecyclerView.class)
        searchGridFragment.radioGroupSearchType = (Utils as RadioGroup).findRequiredViewAsType(view, R.id.radiogroup_search_type, "field 'radioGroupSearchType'", RadioGroup.class)
    ...
    fun unbind(): Unit {
        ...
        ((this as TextView).view2131755639).setOnEditorActionListener((TextView.OnEditorActionListener) null)
