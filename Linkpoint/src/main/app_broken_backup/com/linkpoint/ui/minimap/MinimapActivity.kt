...
class MinimapActivity : ConnectedActivity {
    ...
    fun m639com_lumiyaviewer_lumiya_ui_minimap_MinimapActivitymthref0(CurrentLocationInfo currentLocationInfo2): Unit {
        String str = null
        if (currentLocationInfo2 != null) {
            ...
            setActivityTitle(str, getString(R.string.nearby_users_format, Any[]{Int.valueOf(currentLocationInfo2.nearbyUsers())}))
        }
    }

    private Unit setActivityTitle(@Nullable String str, @Nullable String str2) {
