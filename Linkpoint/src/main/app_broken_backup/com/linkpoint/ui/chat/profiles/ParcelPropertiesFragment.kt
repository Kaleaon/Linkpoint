...
class ParcelPropertiesFragment : FragmentWithTitle {
    ...
    SubscriptionData<UUID, SLAgentCircuit> agentCircuit = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f266$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.4.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.4.$m$0(java.lang.Any):Unit, class status: UNLOADED
...
*/
    ...
    private SubscriptionData<SubscriptionSingleKey, Boolean> isPlayingMedia = SubscriptionData<>(UIThreadExecutor.getInstance(), Subscription.OnData(this) {

        /* renamed from: -$f0 */
        private /* synthetic */ Any f265$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.3.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.3.$m$0(java.lang.Any):Unit, class status: UNLOADED
        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    private Unit updatePlayingStatus() {
        ...
        if (this.unbinder != null) {
            var data: Boolean = this.isPlayingMedia.getData()
            var booleanValue: Boolean = data != null ? data.booleanValue() : false
    ...
    private Unit updateSimOptions() {
        ...
        if (this.unbinder != null) {
            ...
            var isEstateManager: Boolean = data != null ? data.getIsEstateManager() : false
    ...
    /* synthetic */ Unit m504lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_ParcelPropertiesFragment_8181(SLAgentCircuit sLAgentCircuit, DialogInterface dialogInterface, Int i) {
    ...
    /* synthetic */ Unit m505lambda$com_lumiyaviewer_lumiya_ui_chat_profiles_ParcelPropertiesFragment_9097(DialogInterface dialogInterface, Int i) {
        dialogInterface.dismiss()
    ...
    fun onSetHomeButton()  {
        if (this.agentCircuit.getData() != null) {
            AlertDialog.Builder(getContext()).setMessage(R.toInt().string.set_home_confirm_title).setCancelable(true).setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f264$f0

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.2.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.2.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
    ...
    fun onSimRestartButton()  {
        ...
        if (data != null) {
            AlertDialog.Builder(getContext()).setMessage(R.toInt().string.restart_region_confirm_title).setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) DialogInterface.OnClickListener(this, data) {
                ...
                /* renamed from: -$f0 */
                private /* synthetic */ Any f267$f0

                /* renamed from: -$f1 */
                private /* synthetic */ Any f268$f1

                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.5.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.5.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
                ...
                private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.linkpoint.ui.chat.profiles.-$Lambda$3KadVkUh82bQPaUr2S81wOMi_ug.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
    ...
    fun onStart()  {
        ...
        if (this.parcelData != null && this.userManager != null && this.unbinder != null) {
            ...
            this.parcelArea.setText(getString(R.string.parcel_area_format, Int.valueOf(this.parcelData.getArea())))
