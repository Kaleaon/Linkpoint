...
public class IntKeyframeSet extends KeyframeSet {
    ...
    /* renamed from: clone */
    public IntKeyframeSet mo920clone() {
        ArrayList<Keyframe> arrayList = this.mKeyframes;
        int size = this.mKeyframes.size();
        Keyframe.IntKeyframe[] intKeyframeArr = new Keyframe.IntKeyframe[size];
        for (int i = 0; i < size; i++) {
            intKeyframeArr[i] = (Keyframe.IntKeyframe) arrayList.get(i).mo921clone();
        }
    ...
    public int getIntValue(float f) {
        ...
        if (this.mNumKeyframes == 2) {
            ...
            return this.mEvaluator != null ? ((Number) this.mEvaluator.evaluate(f, Integer.valueOf(this.firstValue), Integer.valueOf(this.lastValue))).intValue() : this.firstValue + ((int) (this.deltaValue * f));
        } else if (f <= 0.0f) {
            ...
            return this.mEvaluator != null ? ((Number) this.mEvaluator.evaluate(f2, Integer.valueOf(intValue), Integer.valueOf(intValue2))).intValue() : ((int) (f2 * (intValue2 - intValue))) + intValue;
        } else if (f >= 1.0f) {
            ...
            return this.mEvaluator != null ? ((Number) this.mEvaluator.evaluate(f3, Integer.valueOf(intValue3), Integer.valueOf(intValue4))).intValue() : ((int) (f3 * (intValue4 - intValue3))) + intValue3;
        } else {
            ...
            while (true) {
                ...
                if (f < intKeyframe5.getFraction()) {
                    ...
                    return this.mEvaluator != null ? ((Number) this.mEvaluator.evaluate(fraction5, Integer.valueOf(intValue5), Integer.valueOf(intValue6))).intValue() : ((int) ((intValue6 - intValue5) * fraction5)) + intValue5;
                }
                i++;
            }
        }
