...
public final class AnimatorSet extends Animator {
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m919clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo918clone();
                return node;
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo918clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo918clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m919clone = next.m919clone();
            hashMap.put(next, m919clone);
            animatorSet.mNodes.add(m919clone);
            animatorSet.mNodeMap.put(m919clone.animation, m919clone);
            m919clone.dependencies = null;
            m919clone.tmpDependencies = null;
            m919clone.nodeDependents = null;
            m919clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m919clone.animation.getListeners();
            if (listeners != null) {
            ...
            this.mDelayAnim.addListener(new AnimatorListenerAdapter() { // from class: com.nineoldandroids.animation.AnimatorSet.1
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    for (int i4 = 0; i4 < size3; i4++) {
                        ...
                        AnimatorSet.this.mPlayingSet.add(node3.animation);
                    }
                }
            });
