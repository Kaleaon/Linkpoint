...
public final class Preconditions {
    ...
    private static String badPositionIndexes(int i, int i2, int i3) {
        return (i >= 0 && i <= i3) ? (i2 >= 0 && i2 <= i3) ? format("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i)) : badPositionIndex(i2, i3, "end index") : badPositionIndex(i, i3, "start index");
    }
