    ...
    static class ConstructorInvokable<T> extends Invokable<T, T> {
        ...
        private boolean mayNeedHiddenThis() {
            ...
            if (declaringClass.getEnclosingConstructor() == null) {
                ...
                return enclosingMethod == null ? (declaringClass.getEnclosingClass() == null || Modifier.isStatic(declaringClass.getModifiers())) ? false : true : !Modifier.isStatic(enclosingMethod.getModifiers());
            }
            return true;
        }
