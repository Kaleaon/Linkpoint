...
public final class InetAddresses {
    ...
    public static Inet4Address getCoercedIPv4Address(InetAddress inetAddress) {
        ...
        int asInt = Hashing.murmur3_32().hashLong(!hasEmbeddedIPv4ClientAddress(inet6Address) ? ByteBuffer.wrap(inet6Address.getAddress(), 0, 8).getLong() : getEmbeddedIPv4ClientAddress(inet6Address).hashCode()).asInt() | (-536870912);
        if (asInt == -1) {
            asInt = -2;
        }
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address inet6Address) {
        ...
        int readShort2 = (ByteStreams.newDataInput(address, 10).readShort() ^ (-1)) & SupportMenu.USER_MASK;
