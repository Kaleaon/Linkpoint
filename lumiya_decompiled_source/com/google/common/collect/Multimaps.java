...
public final class Multimaps {
    ...
    public static <K, V> Multimap<K, V> filterEntries(Multimap<K, V> multimap, Predicate<? super Map.Entry<K, V>> predicate) {
        ...
        return !(multimap instanceof SetMultimap) ? !(multimap instanceof FilteredMultimap) ? new FilteredEntryMultimap((Multimap) Preconditions.checkNotNull(multimap), predicate) : filterFiltered((FilteredMultimap) multimap, predicate) : filterEntries((SetMultimap) multimap, (Predicate) predicate);
    }

    @CheckReturnValue
    public static <K, V> SetMultimap<K, V> filterEntries(SetMultimap<K, V> setMultimap, Predicate<? super Map.Entry<K, V>> predicate) {
        Preconditions.checkNotNull(predicate);
        return !(setMultimap instanceof FilteredSetMultimap) ? new FilteredEntrySetMultimap((SetMultimap) Preconditions.checkNotNull(setMultimap), predicate) : filterFiltered((FilteredSetMultimap) setMultimap, (Predicate) predicate);
    }
