...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public class WrappedCollection extends AbstractCollection<V> {
        ...
        WrappedCollection(K k, @Nullable Collection<V> collection, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
            ...
            this.ancestorDelegate = wrappedCollection != null ? wrappedCollection.getDelegate() : null;
        }
    ...
    public class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r5v1, types: [com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection] */
    ...
    Collection<V> wrapCollection(@Nullable K k, Collection<V> collection) {
        return !(collection instanceof SortedSet) ? !(collection instanceof Set) ? !(collection instanceof List) ? new WrappedCollection(k, collection, null) : wrapList(k, (List) collection, null) : new WrappedSet(k, (Set) collection) : new WrappedSortedSet(k, (SortedSet) collection, null);
    }
}
