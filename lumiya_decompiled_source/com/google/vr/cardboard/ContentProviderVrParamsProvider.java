    ...
    */
    private <T extends com.google.protobuf.nano.MessageNano> T readParams(T r8, android.net.Uri r9, java.lang.String r10) {
        /*
            r7 = this;
            r6 = 0
            android.content.ContentProviderClient r0 = r7.client     // Catch: java.lang.Throwable -> L5b java.lang.Throwable -> L6c
            r2 = 0
            r4 = 0
            r5 = 0
            r1 = r9
            r3 = r10
            android.database.Cursor r1 = r0.query(r1, r2, r3, r4, r5)     // Catch: java.lang.Throwable -> L5b java.lang.Throwable -> L6c
            if (r1 != 0) goto L38
        Le:
            java.lang.String r0 = com.google.vr.cardboard.ContentProviderVrParamsProvider.TAG     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            java.lang.String r2 = java.lang.String.valueOf(r9)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            java.lang.String r3 = java.lang.String.valueOf(r2)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            int r3 = r3.length()     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            int r3 = r3 + 50
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            r4.<init>(r3)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            java.lang.String r3 = "Invalid params result from ContentProvider query: "
            java.lang.StringBuilder r3 = r4.append(r3)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            java.lang.StringBuilder r2 = r3.append(r2)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            java.lang.String r2 = r2.toString()     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            android.util.Log.e(r0, r2)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            if (r1 != 0) goto L57
        L37:
            return r6
        L38:
            boolean r0 = r1.moveToFirst()     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            if (r0 == 0) goto Le
            r0 = 0
            byte[] r0 = r1.getBlob(r0)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            if (r0 == 0) goto L4c
            com.google.protobuf.nano.MessageNano r0 = com.google.protobuf.nano.MessageNano.mergeFrom(r8, r0)     // Catch: java.lang.Throwable -> L75 java.lang.Throwable -> L77
            if (r1 != 0) goto L53
        L4b:
            return r0
        L4c:
        ...
        L5b:
            ...
            r1 = r6
        L5d:
            java.lang.String r2 = com.google.vr.cardboard.ContentProviderVrParamsProvider.TAG     // Catch: java.lang.Throwable -> L75
