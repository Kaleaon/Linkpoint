...
public final class C$Gson$Types {
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public Type[] getLowerBounds() {
            return this.lowerBound == null ? C$Gson$Types.EMPTY_TYPE_ARRAY : new Type[]{this.lowerBound};
        }
    ...
    public static Type[] getMapKeyAndValueTypes(Type type, Class<?> cls) {
        if (type != Properties.class) {
            ...
            return !(supertype instanceof ParameterizedType) ? new Type[]{Object.class, Object.class} : ((ParameterizedType) supertype).getActualTypeArguments();
        }
        ...
        while (true) {
            ...
            if (!(type3 instanceof TypeVariable)) {
                if ((type3 instanceof Class) && ((Class) type3).isArray()) {
                    ...
                    return !z2 ? parameterizedType : newParameterizedTypeWithOwner(resolve5, parameterizedType.getRawType(), typeArr);
                }
            }
