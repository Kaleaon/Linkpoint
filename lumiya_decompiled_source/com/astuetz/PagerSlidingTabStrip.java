...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public Pair<Float, Float> getIndicatorCoordinates() {
        ...
        if (this.mCurrentPositionOffset > 0.0f && this.mCurrentPosition < this.mTabCount - 1) {
            ...
            left = (left * (1.0f - this.mCurrentPositionOffset)) + (childAt2.getLeft() * this.mCurrentPositionOffset);
            right = (right * (1.0f - this.mCurrentPositionOffset)) + (childAt2.getRight() * this.mCurrentPositionOffset);
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i++) {
            addTab(i, this.mPager.getAdapter().getPageTitle(i), !this.isCustomTabs ? LayoutInflater.from(getContext()).inflate(R.layout.psts_tab, (ViewGroup) this, false) : ((CustomTabProvider) this.mPager.getAdapter()).getCustomTabView(this, i));
        }
        updateTabStyles();
    }
