...
public abstract class RequestOperator<K, T> implements RequestHandler<K> {
    ...
    public /* synthetic */ void m42lambda$com_lumiyaviewer_lumiya_react_RequestOperator_1579(Object obj) {
    ...
    public /* synthetic */ void m43lambda$com_lumiyaviewer_lumiya_react_RequestOperator_996(Object obj) {
        ...
        if (this.executor != null) {
            this.executor.execute(new Runnable() { // from class: com.lumiyaviewer.lumiya.react.-$Lambda$3htMVvcf7XlS6QCgMv3cESjj4go
                private final /* synthetic */ void $m$0() {
                    ((RequestOperator) this).m43lambda$com_lumiyaviewer_lumiya_react_RequestOperator_996(k);
                }
    ...
    public void onRequestCancelled(@Nonnull final K k) {
        if (this.executor != null) {
            this.executor.execute(new Runnable() { // from class: com.lumiyaviewer.lumiya.react.-$Lambda$3htMVvcf7XlS6QCgMv3cESjj4go.1
                private final /* synthetic */ void $m$0() {
                    ((RequestOperator) this).m42lambda$com_lumiyaviewer_lumiya_react_RequestOperator_1579(k);
                }
