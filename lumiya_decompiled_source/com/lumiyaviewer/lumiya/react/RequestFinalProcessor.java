...
public abstract class RequestFinalProcessor<K, T> implements RequestHandler<K> {
    ...
    public void m34lambda$com_lumiyaviewer_lumiya_react_RequestFinalProcessor_1437(@Nonnull K k) {
    }
    ...
    public /* synthetic */ void m35lambda$com_lumiyaviewer_lumiya_react_RequestFinalProcessor_673(Object obj) {
        try {
        ...
        if (this.executor != null) {
            this.executor.execute(new Runnable() { // from class: com.lumiyaviewer.lumiya.react.-$Lambda$psFcS6-5kKyuCZBH4SbOZwtpXG8
                private final /* synthetic */ void $m$0() {
                    ((RequestFinalProcessor) this).m35lambda$com_lumiyaviewer_lumiya_react_RequestFinalProcessor_673(k);
                }
    ...
    public void onRequestCancelled(@Nonnull final K k) {
        if (this.executor != null) {
            this.executor.execute(new Runnable() { // from class: com.lumiyaviewer.lumiya.react.-$Lambda$psFcS6-5kKyuCZBH4SbOZwtpXG8.1
                private final /* synthetic */ void $m$0() {
                    ((RequestFinalProcessor) this).m34lambda$com_lumiyaviewer_lumiya_react_RequestFinalProcessor_1437(k);
                }
            ...
            m34lambda$com_lumiyaviewer_lumiya_react_RequestFinalProcessor_1437(k);
        }
    }
