...
public class GridConnectionService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final SubscriptionData<SubscriptionSingleKey, CurrentLocationInfo> currentLocationInfo = new SubscriptionData<>(UIThreadExecutor.getInstance(), new Subscription.OnData() { // from class: com.lumiyaviewer.lumiya.-$Lambda$3DowF6pLKgVjVrTY9aZKQ2J3cf0
        private final /* synthetic */ void $m$0(Object obj) {
            ((GridConnectionService) this).m18com_lumiyaviewer_lumiya_GridConnectionServicemthref0((CurrentLocationInfo) obj);
        }
    ...
    private final ChatterNameRetriever.OnChatterNameUpdated onActiveAgentNameUpdated = new ChatterNameRetriever.OnChatterNameUpdated() { // from class: com.lumiyaviewer.lumiya.-$Lambda$3DowF6pLKgVjVrTY9aZKQ2J3cf0.2
        private final /* synthetic */ void $m$0(ChatterNameRetriever chatterNameRetriever) {
            ((GridConnectionService) this).m20lambda$com_lumiyaviewer_lumiya_GridConnectionService_20777(chatterNameRetriever);
        }
    ...
    private static /* synthetic */ int[] m14xc4a7bd01() {
        if (f3x3582025 != null) {
            return f3x3582025;
        }
    ...
    private static /* synthetic */ int[] m15getcomlumiyaviewerlumiyautilsLEDActionSwitchesValues() {
    ...
    private static NotificationSettings notifySettingsByType(NotificationType notificationType) {
        switch (m14xc4a7bd01()[notificationType.ordinal()]) {
            case 1:
                return notifyGroup;
            case 2:
    ...
    public void m18com_lumiyaviewer_lumiya_GridConnectionServicemthref0(CurrentLocationInfo currentLocationInfo) {
        updateOnlineNotification();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onUnreadNotification */
    public void m19com_lumiyaviewer_lumiya_GridConnectionServicemthref1(UnreadNotifications unreadNotifications) {
    ...
    private void showUnreadNotification(UnreadNotifications unreadNotifications) {
        ...
        if (unreadNotifications.notificationGroups().isEmpty()) {
            ...
            for (Integer num : this.shownNotificationIds) {
    ...
    private void showUnreadNotificationSingle(UnreadNotificationInfo unreadNotificationInfo, int i, @Nonnull String str, @Nullable String str2, boolean z, @Nullable String str3) {
        ...
        if (unreadMessageSource3 != null && unreadNotificationInfo.objectPopupInfo().objectPopupsCount() == 0) {
            ...
            if (unreadMessageSource3.unreadMessages().size() > 1) {
                ...
                for (SLChatEvent sLChatEvent : unreadMessageSource3.unreadMessages()) {
                    inboxStyle.addLine(sLChatEvent.getPlainTextMessage(this, unreadMessageSource3.chatterID().getUserManager(), unreadMessageSource3.chatterID().getChatterType() == ChatterID.ChatterType.User, "  ", " "));
                }
            ...
            Iterator<UnreadNotificationInfo.UnreadMessageSource> it2 = unreadNotificationInfo.unreadSources().iterator();
            while (true) {
                if (!it2.hasNext()) {
                    str4 = null;
                    break;
                }
                UnreadNotificationInfo.UnreadMessageSource next = it2.next();
            ...
            for (UnreadNotificationInfo.UnreadMessageSource unreadMessageSource5 : unreadNotificationInfo.unreadSources()) {
                for (SLChatEvent sLChatEvent2 : unreadMessageSource5.unreadMessages()) {
                    inboxStyle2.addLine(sLChatEvent2.getPlainTextMessage(this, unreadMessageSource5.chatterID().getUserManager(), false, "  ", " "));
                }
            }
        ...
        if (str2 == null || (!z)) {
            ...
            if (lEDAction != LEDAction.None) {
                switch (m15getcomlumiyaviewerlumiyautilsLEDActionSwitchesValues()[lEDAction.ordinal()]) {
                    case 1:
    ...
    public void handleConnectEvent(SLLoginResultEvent sLLoginResultEvent) {
        ...
        if (userManager != null) {
            this.unreadNotifySubscription = userManager.getUnreadNotificationManager().getUnreadNotifications().subscribe((Subscribable<Boolean, UnreadNotifications>) UnreadNotificationManager.unreadNotificationKey, UIThreadExecutor.getSerialInstance(), new Subscription.OnData() { // from class: com.lumiyaviewer.lumiya.-$Lambda$3DowF6pLKgVjVrTY9aZKQ2J3cf0.1
                private final /* synthetic */ void $m$0(Object obj) {
                    ((GridConnectionService) this).m19com_lumiyaviewer_lumiya_GridConnectionServicemthref1((UnreadNotifications) obj);
                }
    ...
    public /* synthetic */ void m20lambda$com_lumiyaviewer_lumiya_GridConnectionService_20777(ChatterNameRetriever chatterNameRetriever) {
        updateOnlineNotification();
    }
