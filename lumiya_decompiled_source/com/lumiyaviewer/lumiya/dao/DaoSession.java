...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase sQLiteDatabase, IdentityScopeType identityScopeType, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig> map) {
        ...
        this.cachedResponseDaoConfig = map.get(CachedResponseDao.class).m923clone();
        this.cachedResponseDaoConfig.initIdentityScope(identityScopeType);
        this.cachedAssetDaoConfig = map.get(CachedAssetDao.class).m923clone();
        this.cachedAssetDaoConfig.initIdentityScope(identityScopeType);
        this.moneyTransactionDaoConfig = map.get(MoneyTransactionDao.class).m923clone();
        this.moneyTransactionDaoConfig.initIdentityScope(identityScopeType);
        this.muteListCachedDataDaoConfig = map.get(MuteListCachedDataDao.class).m923clone();
        this.muteListCachedDataDaoConfig.initIdentityScope(identityScopeType);
        this.searchGridResultDaoConfig = map.get(SearchGridResultDao.class).m923clone();
        this.searchGridResultDaoConfig.initIdentityScope(identityScopeType);
        this.groupMemberDaoConfig = map.get(GroupMemberDao.class).m923clone();
        this.groupMemberDaoConfig.initIdentityScope(identityScopeType);
        this.groupMemberListDaoConfig = map.get(GroupMemberListDao.class).m923clone();
        this.groupMemberListDaoConfig.initIdentityScope(identityScopeType);
        this.groupRoleMemberDaoConfig = map.get(GroupRoleMemberDao.class).m923clone();
        this.groupRoleMemberDaoConfig.initIdentityScope(identityScopeType);
        this.groupRoleMemberListDaoConfig = map.get(GroupRoleMemberListDao.class).m923clone();
        this.groupRoleMemberListDaoConfig.initIdentityScope(identityScopeType);
        this.userDaoConfig = map.get(UserDao.class).m923clone();
        this.userDaoConfig.initIdentityScope(identityScopeType);
        this.friendDaoConfig = map.get(FriendDao.class).m923clone();
        this.friendDaoConfig.initIdentityScope(identityScopeType);
        this.userNameDaoConfig = map.get(UserNameDao.class).m923clone();
        this.userNameDaoConfig.initIdentityScope(identityScopeType);
        this.userPicDaoConfig = map.get(UserPicDao.class).m923clone();
        this.userPicDaoConfig.initIdentityScope(identityScopeType);
        this.chatMessageDaoConfig = map.get(ChatMessageDao.class).m923clone();
        this.chatMessageDaoConfig.initIdentityScope(identityScopeType);
        this.chatterDaoConfig = map.get(ChatterDao.class).m923clone();
