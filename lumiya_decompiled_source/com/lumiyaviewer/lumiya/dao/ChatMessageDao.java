...
public class ChatMessageDao extends AbstractDao<ChatMessage, Long> {
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, ChatMessage chatMessage) {
        ...
        if (senderType != null) {
            sQLiteStatement.bindLong(8, senderType.intValue());
        }
        ...
        if (eventState != null) {
            sQLiteStatement.bindLong(13, eventState.intValue());
        }
        Integer origIMType = chatMessage.getOrigIMType();
        if (origIMType != null) {
            sQLiteStatement.bindLong(14, origIMType.intValue());
        }
        ...
        if (assetType != null) {
            sQLiteStatement.bindLong(18, assetType.intValue());
        }
        Integer transactionAmount = chatMessage.getTransactionAmount();
        if (transactionAmount != null) {
            sQLiteStatement.bindLong(19, transactionAmount.intValue());
        }
        Integer newBalance = chatMessage.getNewBalance();
        if (newBalance != null) {
            sQLiteStatement.bindLong(20, newBalance.intValue());
        }
        Integer chatChannel = chatMessage.getChatChannel();
        if (chatChannel != null) {
            sQLiteStatement.bindLong(21, chatChannel.intValue());
        }
        ...
        if (questionMask != null) {
            sQLiteStatement.bindLong(26, questionMask.intValue());
        }
        ...
        if (textBoxButtonIndex != null) {
            sQLiteStatement.bindLong(29, textBoxButtonIndex.intValue());
        }
