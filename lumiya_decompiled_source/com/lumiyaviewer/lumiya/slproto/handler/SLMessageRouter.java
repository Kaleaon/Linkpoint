...
public class SLMessageRouter {
    ...
    public synchronized void unregisterHandler(Object obj) {
        for (HandlerList handlerList : this.messageHandlers.values()) {
            handlerList.deleteAll(obj);
        }
        for (HandlerList handlerList2 : this.eventQueueMessageHandlers.values()) {
            handlerList2.deleteAll(obj);
        }
    }
}
