...
public abstract class SLMessage implements Parcelable {
    ...
    public static int flipBytes(int i) {
        int i2 = (((byte) (i >>> 8)) << 16) & 16711680;
        int i3 = (((byte) (i >>> 16)) << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK;
        return (((byte) (i >>> 24)) & UnsignedBytes.MAX_VALUE) | i3 | i2 | ((((byte) (i >>> 0)) << Ascii.CAN) & ViewCompat.MEASURED_STATE_MASK);
    }
