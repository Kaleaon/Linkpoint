...
public class LLQuaternion {
    ...
    private static final /* synthetic */ int[] f143xae1ac4c9 = null;
    ...
    private static /* synthetic */ int[] m269xd25893a5() {
    ...
    public static LLQuaternion mayaQ(float f, float f2, float f3, Order order) {
        ...
        switch (m269xd25893a5()[order.ordinal()]) {
            case 1:
    ...
    public static LLQuaternion shortestArc(LLVector3 lLVector3, LLVector3 lLVector32) {
        ...
        if (dot >= -0.9999999f) {
            LLQuaternion lLQuaternion = new LLQuaternion();
            lLQuaternion.setQuat((float) Math.acos(dot), cross);
            return lLQuaternion;
        }
