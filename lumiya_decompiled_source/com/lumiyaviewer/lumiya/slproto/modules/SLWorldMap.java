...
public class SLWorldMap extends SLModule {
    ...
    public void HandleFindAgent(FindAgent findAgent) {
        ...
        if (findAgent.LocationBlock_Fields.size() > 0) {
            ...
            if (d != 0.0d || d2 != 0.0d) {
                ...
                int i = floor & 255;
                int i2 = floor2 & 255;
                long j = ((floor & InputDeviceCompat.SOURCE_ANY) << 32) | (floor2 & InputDeviceCompat.SOURCE_ANY & 4294967295L);
    ...
    public void HandleMapBlockReply(MapBlockReply mapBlockReply) {
        ...
        while (true) {
            ...
            String stringFromVariableOEM = SLMessage.stringFromVariableOEM(((MapBlockReply.Data) it.next()).Name);
