...
public class SLUserProfiles extends SLModule {
    ...
    public SLUserProfiles(SLAgentCircuit sLAgentCircuit, SLCaps sLCaps) {
    ...
    public boolean SetHomeLocation() {
        ...
        try {
            LLSDNode PerformRequest = new LLSDXMLRequest().PerformRequest(this.setHomeLocationCap, new LLSDMap(new LLSDMap.LLSDMapEntry("HomeLocation", new LLSDMap(new LLSDMap.LLSDMapEntry("LocationId", new LLSDInt(1)), new LLSDMap.LLSDMapEntry("LocationPos", position.toLLSD()), new LLSDMap.LLSDMapEntry("LocationLookAt", new LLVector3((float) Math.cos(agentHeading), (float) Math.sin(agentHeading), 0.0f).toLLSD())))));
