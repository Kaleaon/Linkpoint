...
public class SerializableResponseCacher<Key, MessageType extends Serializable> extends ResponseCacher<Key, MessageType> {
    ...
    protected byte[] storeCached(@Nonnull MessageType messagetype) {
        try {
    ...
    @Override // com.lumiyaviewer.lumiya.slproto.users.ResponseCacher
    protected /* bridge */ /* synthetic */ byte[] storeCached(@Nonnull Object obj) {
        return storeCached((SerializableResponseCacher<Key, MessageType>) ((Serializable) obj));
    }
}
