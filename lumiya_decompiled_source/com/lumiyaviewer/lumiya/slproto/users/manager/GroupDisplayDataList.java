...
public class GroupDisplayDataList extends ChatterDisplayDataList {
    ...
    protected List<ChatterID> getChatters() {
        ...
        for (AvatarGroupList.AvatarGroupEntry avatarGroupEntry : avatarGroupList.Groups.values()) {
            builder.add((ImmutableList.Builder) ChatterID.getGroupChatterID(this.userManager.getUserID(), avatarGroupEntry.GroupID));
        }
