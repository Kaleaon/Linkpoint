...
public class SLInventoryUDPFetchRequest extends SLInventoryFetchRequest {
    private final Set<UUID> existingChildren;
    private int receivedCount;

    /* JADX INFO: Access modifiers changed from: package-private */
    public SLInventoryUDPFetchRequest(SLInventory sLInventory, UUID uuid) throws SLInventory.NoInventoryItemException {
