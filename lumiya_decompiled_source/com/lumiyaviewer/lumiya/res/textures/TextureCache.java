...
public class TextureCache extends ResourceMemoryCache<DrawableTextureParams, OpenJPEG> {
    ...
    /* loaded from: classes.dex */
    public class TextureDecompressRequest extends ResourceRequest<DrawableTextureParams, OpenJPEG> implements ResourceConsumer, Runnable, HasPriority, Startable {
        ...
        private static /* synthetic */ int[] m127x8a7b09f7() {
        ...
        public int getPriority() {
            ...
            switch (m127x8a7b09f7()[params.textureClass().ordinal()]) {
                case 1:
                    return 2;
                case 2:
                    return 1;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public class TextureLoadRequest extends ResourceRequest<DrawableTextureParams, OpenJPEG> implements Runnable, Startable {
