...
public class TerrainTextureCache extends ResourceMemoryCache<TerrainPatchInfo, OpenJPEG> {
    ...
    /* loaded from: classes.dex */
    public static class TerrainTextureRequest extends ResourceRequest<TerrainPatchInfo, OpenJPEG> implements Runnable, HasPriority {
                ...
                if ((this.layerNeededMask & this.layerReadyMask) == this.layerNeededMask) {
                    ...
                    while (true) {
                        if (i2 >= 4) {
                            z = true;
                            break;
                        } else if ((this.layerNeededMask & (1 << i2)) != 0 && this.rawTextures[i2] == null) {
