...
public class VoiceStatusView extends FrameLayout {
    ...
    private static /* synthetic */ int[] m875xc8b7c355() {
    ...
    private static /* synthetic */ int[] m876x6f23bddb() {
    ...
    public VoiceStatusView(Context context) {
        ...
        this.voiceAudioProperties = new SubscriptionData<>(UIThreadExecutor.getInstance(), new Subscription.OnData() { // from class: com.lumiyaviewer.lumiya.ui.voice.-$Lambda$LRu9qjGWbEJmZF4NfrRGigLGXl8.1
            private final /* synthetic */ void $m$0(Object obj) {
                ((VoiceStatusView) this).m878com_lumiyaviewer_lumiya_ui_voice_VoiceStatusViewmthref0((VoiceAudioProperties) obj);
            }
        ...
        this.voiceChatInfo = new SubscriptionData<>(UIThreadExecutor.getInstance(), new Subscription.OnData() { // from class: com.lumiyaviewer.lumiya.ui.voice.-$Lambda$LRu9qjGWbEJmZF4NfrRGigLGXl8.2
            private final /* synthetic */ void $m$0(Object obj) {
                ((VoiceStatusView) this).m879com_lumiyaviewer_lumiya_ui_voice_VoiceStatusViewmthref1((VoiceChatInfo) obj);
            }
        ...
        this.onActiveSpeakerNameUpdated = new ChatterNameRetriever.OnChatterNameUpdated() { // from class: com.lumiyaviewer.lumiya.ui.voice.-$Lambda$LRu9qjGWbEJmZF4NfrRGigLGXl8.9
            private final /* synthetic */ void $m$0(ChatterNameRetriever chatterNameRetriever) {
                ((VoiceStatusView) this).m880lambda$com_lumiyaviewer_lumiya_ui_voice_VoiceStatusView_24065(chatterNameRetriever);
            }
    ...
    public static /* synthetic */ boolean m877lambda$com_lumiyaviewer_lumiya_ui_voice_VoiceStatusView_6407(OnHoverListenerCompat onHoverListenerCompat, View view, MotionEvent motionEvent) {
    ...
    public void m878com_lumiyaviewer_lumiya_ui_voice_VoiceStatusViewmthref0(VoiceAudioProperties voiceAudioProperties) {
    ...
    public void m879com_lumiyaviewer_lumiya_ui_voice_VoiceStatusViewmthref1(VoiceChatInfo voiceChatInfo) {
        updateVoiceState();
    }
    ...
    private void updateVoiceState() {
        ...
        if (data == null || !(!data.state.equals(VoiceChatInfo.VoiceChatState.None))) {
            ...
            if (str == null) {
                switch (m876x6f23bddb()[data.state.ordinal()]) {
                    case 1:
        ...
        if (data2 != null) {
            ...
            switch (m875xc8b7c355()[data2.bluetoothState.ordinal()]) {
                case 1:
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            View.OnHoverListener onHoverListener = new View.OnHoverListener() { // from class: com.lumiyaviewer.lumiya.ui.voice.-$Lambda$LRu9qjGWbEJmZF4NfrRGigLGXl8
                private final /* synthetic */ boolean $m$0(View view, MotionEvent motionEvent) {
                    return VoiceStatusView.m877lambda$com_lumiyaviewer_lumiya_ui_voice_VoiceStatusView_6407((OnHoverListenerCompat) onHoverListenerCompat, view, motionEvent);
                }
    ...
    public /* synthetic */ void m880lambda$com_lumiyaviewer_lumiya_ui_voice_VoiceStatusView_24065(ChatterNameRetriever chatterNameRetriever) {
