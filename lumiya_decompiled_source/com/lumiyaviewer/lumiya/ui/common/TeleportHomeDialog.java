...
public class TeleportHomeDialog {
    ...
    public static /* synthetic */ void m556lambda$com_lumiyaviewer_lumiya_ui_common_TeleportHomeDialog_956(Activity activity, UserManager userManager, SLAgentCircuit sLAgentCircuit, DialogInterface dialogInterface, int i) {
    ...
    public static void show(final Activity activity) {
        ...
        new AlertDialog.Builder(activity).setMessage(R.string.teleport_home_confirm_title).setPositiveButton("Yes", new DialogInterface.OnClickListener() { // from class: com.lumiyaviewer.lumiya.ui.common.-$Lambda$sKhJxooMqZpn4u0mFmtSpF7hGx8.1
            private final /* synthetic */ void $m$0(DialogInterface dialogInterface, int i) {
                TeleportHomeDialog.m556lambda$com_lumiyaviewer_lumiya_ui_common_TeleportHomeDialog_956((Activity) activity, (UserManager) userManager, (SLAgentCircuit) activeAgentCircuit, dialogInterface, i);
            }
