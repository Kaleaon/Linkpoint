...
public class ImageAssetView extends View {
    ...
    /* loaded from: classes.dex */
    public class LoadAssetImageTask extends AsyncTask<UUID, Void, Bitmap> implements ResourceConsumer {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int round2 = Math.round(width2 / max);
        int i = (width / 2) - (round2 / 2);
        int round3 = this.alignTop ? 0 : (height / 2) - (Math.round(height2 / max) / 2);
        this.bitmapDestRect.left = i + 1;
        this.bitmapDestRect.top = round3 + 1;
        this.bitmapDestRect.right = (round2 + i) - 1;
        this.bitmapDestRect.bottom = (round3 + round) - 1;
    ...
    public void setAssetID(UUID uuid) {
        ...
        if (this.assetID != null) {
            ...
            this.loadTask = new LoadAssetImageTask(this, null);
