...
public class AvatarPickerForInvite extends AvatarPickerFragment {
    ...
    protected void onAvatarSelected(ChatterID chatterID, @Nullable String str) {
        ...
        if (view != null) {
            ...
            Toast.makeText(getContext(), (int) R.string.group_invitation_sent, 1).show();
    ...
    public void onStart() {
        ...
        View view = getView();
        if (view != null) {
            ((Spinner) view.findViewById(R.id.role_picker_spinner)).setAdapter((SpinnerAdapter) new ArrayAdapter(getContext(), 17367049, build));
        }
    }
}
