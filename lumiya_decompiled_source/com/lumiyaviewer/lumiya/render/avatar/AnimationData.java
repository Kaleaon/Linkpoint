...
public class AnimationData {
    ...
    /* loaded from: classes.dex */
    public static class AnimationJointData {
        ...
        AnimationJointData(LittleEndianDataInputStream littleEndianDataInputStream, float f) throws IOException {
            ...
            readInt = (readInt < 0 || readInt > 10000) ? 0 : 0;
            ...
            readInt2 = (readInt2 < 0 || readInt2 > 10000) ? 0 : 0;
    ...
    /* loaded from: classes.dex */
    public static class AnimationJointSet {
        private final float animLength;
        private final UUID animationUUID;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static abstract class AnimationKeyframe<T> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static class AnimationPosKeyframe extends AnimationKeyframe<LLVector3> {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static class AnimationRotKeyframe extends AnimationKeyframe<LLQuaternion> {
    ...
    private float getInAnimationTime(float f, float f2) {
        ...
        if (this.loop) {
            ...
            if (this.outPoint > this.inPoint) {
                float f4 = f - f2;
                f3 = (f4 - (((float) Math.floor((f4 - this.inPoint) / (this.outPoint - this.inPoint))) * (this.outPoint - this.inPoint))) + f2;
            } else {
                f3 = this.outPoint + f2;
            }
