...
public class SpatialObjectIndex {
    ...
    private final DrawListTerrainEntry[][] terrain = (DrawListTerrainEntry[][]) Array.newInstance(DrawListTerrainEntry.class, 16, 16);
    ...
    /* loaded from: classes.dex */
    public class ObjectsUpdateTask implements Runnable {
