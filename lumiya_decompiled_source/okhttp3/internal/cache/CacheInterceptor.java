...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.headers(), Okio.buffer(new Source() { // from class: okhttp3.internal.cache.CacheInterceptor.1
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        Response response = this.cache == null ? null : this.cache.get(chain.request());
        ...
        if (request != null) {
            try {
                ...
                return !okhttp3.internal.http.HttpHeaders.hasBody(build2) ? build2 : cacheWritingResponse(maybeCache(build2, proceed.request(), this.cache), build2);
            } catch (Throwable th) {
