...
public final class Address {
    ...
    public int hashCode() {
        return (((this.hostnameVerifier == null ? 0 : this.hostnameVerifier.hashCode()) + (((this.sslSocketFactory == null ? 0 : this.sslSocketFactory.hashCode()) + (((this.proxy == null ? 0 : this.proxy.hashCode()) + ((((((((((((this.url.hashCode() + 527) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31)) * 31)) * 31)) * 31) + (this.certificatePinner != null ? this.certificatePinner.hashCode() : 0);
    }
