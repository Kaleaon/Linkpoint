    ...
    public static Handshake get(SSLSession sSLSession) {
        ...
        if (cipherSuite != null) {
            ...
            if (protocol != null) {
                ...
                List emptyList = certificateArr == null ? Collections.emptyList() : Util.immutableList(certificateArr);
                Certificate[] localCertificates = sSLSession.getLocalCertificates();
                return new Handshake(forJavaName2, forJavaName, emptyList, localCertificates == null ? Collections.emptyList() : Util.immutableList(localCertificates));
            }
