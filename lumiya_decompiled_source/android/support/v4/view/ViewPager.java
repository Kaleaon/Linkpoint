...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        for (int i12 = i - 1; i12 >= 0; i12--) {
            ...
            while (i11 > itemInfo7.position) {
                f9 -= this.mAdapter.getPageWidth(i11) + f;
                i11--;
            }
            f8 = f9 - (itemInfo7.widthFactor + f);
            itemInfo7.offset = f8;
        ...
        for (int i14 = i + 1; i14 < size2; i14++) {
            ...
            while (i13 < itemInfo8.position) {
                f11 = this.mAdapter.getPageWidth(i13) + f + f11;
                i13++;
            }
            ...
            f10 = f11 + itemInfo8.widthFactor + f;
            i13++;
        }
        this.mNeedCalculatePageOffsets = false;
    }
    ...
    */
    ...
    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        ...
        int min = (int) ((infoForPosition == null ? 0.0f : Math.min(infoForPosition.offset, this.mLastOffset)) * ((i - getPaddingLeft()) - getPaddingRight()));
        if (min == getScrollX()) {
            return;
        }
    ...
    private void scrollToItem(int i, boolean z, int i2, boolean z2) {
        ...
        if (infoForPosition == null) {
            ...
            max = (int) (Math.max(this.mFirstOffset, Math.min(infoForPosition.offset, this.mLastOffset)) * getClientWidth());
        }
        if (z) {
    ...
    public void fakeDragBy(float f) {
        ...
        if (this.mAdapter != null) {
            ...
            ItemInfo itemInfo = this.mItems.get(0);
            ItemInfo itemInfo2 = this.mItems.get(this.mItems.size() - 1);
            float f4 = itemInfo.position == 0 ? f2 : itemInfo.offset * clientWidth;
            float f5 = itemInfo2.position == this.mAdapter.getCount() + (-1) ? f3 : itemInfo2.offset * clientWidth;
            if (scrollX >= f4) {
    ...
    void populate(int i) {
        ...
        if (this.mAdapter == null) {
            ...
            if (addNewItem != null) {
                ...
                int clientWidth = getClientWidth();
                float paddingLeft = clientWidth > 0 ? (2.0f - addNewItem.widthFactor) + (getPaddingLeft() / clientWidth) : 0.0f;
                float f = 0.0f;
                int i6 = i2;
                int i7 = i5;
                for (int i8 = this.mCurItem - 1; i8 >= 0; i8--) {
                    if (f >= paddingLeft && i8 < max) {
                        if (itemInfo3 == null) {
                            ...
                            i7--;
                            i6--;
                            itemInfo3 = i7 < 0 ? null : this.mItems.get(i7);
                        }
                ...
                int i9 = i6 + 1;
                if (f2 < 2.0f) {
                    ItemInfo itemInfo4 = i9 >= this.mItems.size() ? null : this.mItems.get(i9);
                    ...
                    while (i11 < count) {
                        if (f3 >= paddingRight && i11 > min) {
                            if (itemInfo4 == null) {
                                break;
                            } else if (i11 == itemInfo4.position && !itemInfo4.scrolling) {
                                this.mItems.remove(i10);
                                this.mAdapter.destroyItem((ViewGroup) this, i11, itemInfo4.object);
                                itemInfo4 = i10 >= this.mItems.size() ? null : this.mItems.get(i10);
                            }
                            ...
                            ItemInfo addNewItem2 = addNewItem(i11, i10);
                            i10++;
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs <= 0 ? (int) (((Math.abs(i5) / ((clientWidth * this.mAdapter.getPageWidth(this.mCurItem)) + this.mPageMargin)) + 1.0f) * 100.0f) : Math.round(Math.abs(distanceInfluenceForSnapDuration / abs) * 1000.0f) * 4, (int) MAX_SETTLE_DURATION);
