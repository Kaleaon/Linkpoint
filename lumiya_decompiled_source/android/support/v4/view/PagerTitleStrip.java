...
public class PagerTitleStrip extends ViewGroup {
    ...
    protected void onAttachedToWindow() {
        ...
        updateAdapter(this.mWatchingAdapter == null ? null : this.mWatchingAdapter.get(), adapter);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            size = Math.max(getMinHeight(), paddingTop + this.mCurrText.getMeasuredHeight());
        } else {
            size = View.MeasureSpec.getSize(i2);
        }
        setMeasuredDimension(size2, View.resolveSizeAndState(size, i2, this.mCurrText.getMeasuredState() << 16));
    }
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        this.mPrevText.setText((i >= 1 && pagerAdapter != null) ? pagerAdapter.getPageTitle(i - 1) : null);
        this.mCurrText.setText((pagerAdapter != null && i < count) ? pagerAdapter.getPageTitle(i) : null);
