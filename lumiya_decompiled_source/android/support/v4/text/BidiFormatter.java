...
public final class BidiFormatter {
    ...
    public CharSequence unicodeWrap(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat, boolean z) {
        if (charSequence != null) {
            ...
            if (getStereoReset() && z) {
                spannableStringBuilder.append((CharSequence) markBefore(charSequence, !isRtl ? TextDirectionHeuristicsCompat.LTR : TextDirectionHeuristicsCompat.RTL));
            }
            ...
            if (z) {
                spannableStringBuilder.append((CharSequence) markAfter(charSequence, !isRtl ? TextDirectionHeuristicsCompat.LTR : TextDirectionHeuristicsCompat.RTL));
            }
