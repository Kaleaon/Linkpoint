...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((((int) (((SwipeRefreshLayout.this.mUsingCustomStart ? SwipeRefreshLayout.this.mSpinnerOffsetEnd : SwipeRefreshLayout.this.mSpinnerOffsetEnd - Math.abs(SwipeRefreshLayout.this.mOriginalOffsetTop)) - SwipeRefreshLayout.this.mFrom) * f)) + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    private void moveSpinner(float f) {
        ...
        float f2 = !this.mUsingCustomStart ? this.mSpinnerOffsetEnd : this.mSpinnerOffsetEnd - this.mOriginalOffsetTop;
        ...
        this.mProgress.setStartEndTrim(0.0f, Math.min((float) MAX_PROGRESS_ANGLE, MAX_PROGRESS_ANGLE * max));
        this.mProgress.setArrowScale(Math.min(1.0f, max));
        this.mProgress.setProgressRotation((((0.4f * max) - 0.25f) + (DECELERATE_INTERPOLATION_FACTOR * pow)) * 0.5f);
    ...
    public boolean canChildScrollUp() {
        return this.mChildScrollUpCallback == null ? !(this.mTarget instanceof ListView) ? this.mTarget.canScrollVertically(-1) : ListViewCompat.canScrollList((ListView) this.mTarget, -1) : this.mChildScrollUpCallback.canChildScrollUp(this, this.mTarget);
    }
    ...
    protected int getChildDrawingOrder(int i, int i2) {
        return this.mCircleViewIndex >= 0 ? i2 != i + (-1) ? i2 < this.mCircleViewIndex ? i2 : i2 + 1 : this.mCircleViewIndex : i2;
    }
