...
public class TintTypedArray {
    ...
    public Drawable getDrawable(int i) {
        int resourceId;
        return (this.mWrapped.hasValue(i) && (resourceId = this.mWrapped.getResourceId(i, 0)) != 0) ? AppCompatResources.getDrawable(this.mContext, resourceId) : this.mWrapped.getDrawable(i);
    }
