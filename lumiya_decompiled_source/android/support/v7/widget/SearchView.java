...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            return createIntent(columnString2, columnString3 != null ? Uri.parse(columnString3) : null, SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        String string2 = searchableInfo.getVoicePromptTextId() == 0 ? null : resources.getString(searchableInfo.getVoicePromptTextId());
        String string3 = searchableInfo.getVoiceLanguageId() == 0 ? null : resources.getString(searchableInfo.getVoiceLanguageId());
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        this.mSearchSrcTextView.setDropDownHorizontalOffset(!isLayoutRtl ? paddingLeft - (rect.left + dimensionPixelSize) : -rect.left);
    ...
    public CharSequence getQueryHint() {
        return this.mQueryHint == null ? (this.mSearchable == null || this.mSearchable.getHintId() == 0) ? this.mDefaultQueryHint : getContext().getText(this.mSearchable.getHintId()) : this.mQueryHint;
    }
    ...
    public void onActionViewExpanded() {
        ...
        this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | SLMoveEvents.AGENT_CONTROL_TURN_LEFT);
    ...
    boolean onSuggestionsKey(View view, int i, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            ...
            if (i == 21 || i == 22) {
                this.mSearchSrcTextView.setSelection(i != 21 ? this.mSearchSrcTextView.length() : 0);
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        if (this.mSuggestionsAdapter instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) this.mSuggestionsAdapter).setQueryRefinement(!z ? 1 : 2);
        }
    }
    ...
    void updateFocusedState() {
        int[] iArr = !this.mSearchSrcTextView.hasFocus() ? EMPTY_STATE_SET : FOCUSED_STATE_SET;
