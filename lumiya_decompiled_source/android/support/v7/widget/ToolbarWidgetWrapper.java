...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    private void updateToolbarLogo() {
        this.mToolbar.setLogo((this.mDisplayOpts & 2) != 0 ? (this.mDisplayOpts & 1) == 0 ? this.mIcon : this.mLogo == null ? this.mIcon : this.mLogo : null);
    }
    ...
    public void setIcon(int i) {
        setIcon(i == 0 ? null : AppCompatResources.getDrawable(getContext(), i));
    }
    ...
    public void setLogo(int i) {
        setLogo(i == 0 ? null : AppCompatResources.getDrawable(getContext(), i));
    }
    ...
    public void setNavigationIcon(int i) {
        setNavigationIcon(i == 0 ? null : AppCompatResources.getDrawable(getContext(), i));
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i, long j) {
        return ViewCompat.animate(this.mToolbar).alpha(i != 0 ? 0.0f : 1.0f).setDuration(j).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.widget.ToolbarWidgetWrapper.2
