...
public class Toolbar extends ViewGroup {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            if (z2) {
                ...
                if (shouldLayout) {
                    ...
                    i7 = measuredHeight2 + ((LayoutParams) this.mTitleTextView.getLayoutParams()).bottomMargin;
                    i8 = i19;
                } else {
                    i8 = max2;
                }
                if (shouldLayout2) {
                    ...
                    int i20 = layoutParams5.topMargin + i7;
                ...
                int i22 = (!z3 ? 0 : this.mTitleMarginStart) - iArr[0];
                i6 += Math.max(0, i22);
                ...
                if (shouldLayout) {
                    ...
                    int i23 = ((LayoutParams) this.mTitleTextView.getLayoutParams()).bottomMargin + measuredHeight3;
                ...
                if (shouldLayout2) {
                    ...
                    int i24 = i11 + layoutParams6.topMargin;
                    int measuredWidth3 = this.mSubtitleTextView.getMeasuredWidth() + i6;
                    this.mSubtitleTextView.layout(i6, i24, measuredWidth3, this.mSubtitleTextView.getMeasuredHeight() + i24);
        ...
        for (int i27 = 0; i27 < size; i27++) {
            i26 = layoutChildLeft(this.mTempViews.get(i27), i26, iArr, min);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i28 = 0; i28 < size2; i28++) {
            layoutChildRight2 = layoutChildRight(this.mTempViews.get(i28), layoutChildRight2, iArr, min);
        }
        addCustomViewsWithGravity(this.mTempViews, 1);
        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
        int i29 = ((((width - paddingLeft) - paddingRight) / 2) + paddingLeft) - (viewListMeasuredWidth / 2);
        int i30 = viewListMeasuredWidth + i29;
        if (i29 < i26) {
            i29 = i26;
        } else if (i30 > layoutChildRight2) {
            i29 -= i30 - layoutChildRight2;
        }
        int size3 = this.mTempViews.size();
        int i31 = i29;
        for (int i32 = 0; i32 < size3; i32++) {
            i31 = layoutChildLeft(this.mTempViews.get(i32), i31, iArr, min);
        }
