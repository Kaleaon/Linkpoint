...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        if (view4 == null) {
            ...
            int i11 = i5 - i4;
            int min = Math.min(i10, measuredHeight);
            if (min <= 0) {
                i7 = i10;
            } else {
                i7 = i10 - min;
            ...
            i10 = i7;
            measuredHeight2 = i11 + view4.getMeasuredHeight();
        }
        if (view5 != null && i10 > 0) {
            view5.measure(i, View.MeasureSpec.makeMeasureSpec(i6 + i10, mode));
        ...
        setMeasuredDimension(View.resolveSizeAndState(i12 + getPaddingLeft() + getPaddingRight(), i, combineMeasuredStates5), View.resolveSizeAndState(measuredHeight2, i2, 0));
        if (mode2 == 1073741824) {
            return true;
        }
