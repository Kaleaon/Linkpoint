...
public class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                listAdapter = this.mCursor != null ? new CursorAdapter(this.mContext, this.mCursor, false) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                } : new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                ...
                int i = !this.mIsSingleChoice ? alertController.mListItemLayout : alertController.mSingleChoiceItemLayout;
                listAdapter = this.mCursor == null ? this.mAdapter == null ? new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems) : this.mAdapter : new SimpleCursorAdapter(this.mContext, i, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setHasDecor(boolean z, boolean z2) {
            ...
            setPadding(getPaddingLeft(), !z ? this.mPaddingTopNoTitle : getPaddingTop(), getPaddingRight(), !z2 ? this.mPaddingBottomNoButtons : getPaddingBottom());
        }
    }
    ...
    private ViewGroup resolvePanel(@Nullable View view, @Nullable View view2) {
        if (view == null) {
            return (ViewGroup) (!(view2 instanceof ViewStub) ? view2 : ((ViewStub) view2).inflate());
        }
        if (view2 != null) {
        ...
        return (ViewGroup) (!(view instanceof ViewStub) ? view : ((ViewStub) view).inflate());
    }
    ...
    private void setupView() {
        ...
        } else if (resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(R.id.textSpacerNoTitle)) != null) {
        ...
        if (!z) {
            View view = this.mListView == null ? this.mScrollView : this.mListView;
            if (view != null) {
                setScrollIndicators(resolvePanel2, view, (!z2 ? 0 : 1) | (z3 ? 2 : 0), 3);
            }
        }
