...
public abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    public final Context getActionBarThemedContext() {
        ...
        return themedContext != null ? themedContext : this.mContext;
    }
    ...
    public final CharSequence getTitle() {
        return !(this.mOriginalWindowCallback instanceof Activity) ? this.mTitle : ((Activity) this.mOriginalWindowCallback).getTitle();
    }
