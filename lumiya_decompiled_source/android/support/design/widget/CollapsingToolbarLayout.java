...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            int systemWindowInsetTop = CollapsingToolbarLayout.this.mLastInsets == null ? 0 : CollapsingToolbarLayout.this.mLastInsets.getSystemWindowInsetTop();
    ...
    private void animateScrim(int i) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setInterpolator(i <= this.mScrimAlpha ? AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR : AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR);
    ...
    public int getScrimVisibleHeightTrigger() {
        if (this.mScrimVisibleHeightTrigger < 0) {
            ...
            return minimumHeight <= 0 ? getHeight() / 3 : Math.min(systemWindowInsetTop + (minimumHeight * 2), getHeight());
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
            ...
            if (this.mDrawCollapsingTitle) {
                ...
                this.mCollapsingTextHelper.setCollapsedBounds(this.mTmpRect.left + (!z2 ? this.mToolbar.getTitleMarginStart() : this.mToolbar.getTitleMarginEnd()), this.mToolbar.getTitleMarginTop() + this.mTmpRect.top + maxOffsetForPinChild, (!z2 ? this.mToolbar.getTitleMarginEnd() : this.mToolbar.getTitleMarginStart()) + this.mTmpRect.right, (maxOffsetForPinChild + this.mTmpRect.bottom) - this.mToolbar.getTitleMarginBottom());
                this.mCollapsingTextHelper.setExpandedBounds(!z2 ? this.mExpandedMarginStart : this.mExpandedMarginEnd, this.mTmpRect.top + this.mExpandedMarginTop, (i3 - i) - (!z2 ? this.mExpandedMarginEnd : this.mExpandedMarginStart), (i4 - i2) - this.mExpandedMarginBottom);
