...
public class ChangeBounds extends Transition {
    ...
    /* JADX WARN: Type inference failed for: r1v20, types: [android.animation.AnimatorSet] */
    /* JADX WARN: Type inference failed for: r1v38, types: [android.animation.Animator] */
    @Override // android.support.transition.Transition
    @Nullable
    public Animator createAnimator(@NonNull final ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (this.mResizeClip) {
            ...
            ObjectAnimator ofPointF2 = (i == i2 && i3 == i4) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i, i3, i2, i4));
            ...
            if (r2 != 2) {
                ofPointF = (i == i2 && i3 == i4) ? ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i5, i7, i6, i8)) : ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i, i3, i2, i4));
            } else if (i9 == i11 && i10 == i12) {
                ofPointF = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i, i3, i2, i4));
            } else {
                final ViewBounds viewBounds = new ViewBounds(view);
                ObjectAnimator ofPointF3 = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i, i3, i2, i4));
                ObjectAnimator ofPointF4 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i5, i7, i6, i8));
