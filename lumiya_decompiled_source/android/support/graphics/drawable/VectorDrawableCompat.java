...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VGroup {
        ...
        /* JADX WARN: Type inference failed for: r2v10, types: [android.support.graphics.drawable.VectorDrawableCompat$VClipPath] */
    ...
    public static class VPath {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                int i2 = 0;
                while (i2 < pathDataNodeArr[i].mParams.length) {
