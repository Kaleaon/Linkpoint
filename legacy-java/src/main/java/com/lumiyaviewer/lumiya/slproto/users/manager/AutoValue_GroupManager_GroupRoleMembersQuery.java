...
public final class AutoValue_GroupManager_GroupRoleMembersQuery extends GroupManager.GroupRoleMembersQuery {
    private final UUID groupID;
    private final UUID requestID;
    private final UUID roleID;

    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_GroupManager_GroupRoleMembersQuery(UUID uuid, UUID uuid2, UUID uuid3) {
        if (uuid == null) {
