...
public final class CipherSuite
{
    ...
    static {
        INSTANCES = new ConcurrentHashMap<String, CipherSuite>();
    ...
    public static CipherSuite forJavaName(final String s) {
        final CipherSuite cipherSuite = CipherSuite.INSTANCES.get(s);
        CipherSuite cipherSuite2;
        if (cipherSuite != null) {
            cipherSuite2 = cipherSuite;
        }
        else {
            final CipherSuite cipherSuite3 = new CipherSuite(s);
            if ((cipherSuite2 = CipherSuite.INSTANCES.putIfAbsent(s, cipherSuite3)) == null) {
                cipherSuite2 = cipherSuite3;
            }
        }
        return cipherSuite2;
    }
