...
class AlertController
{
        ...
        this.mButtonHandler = (View$OnClickListener)new View$OnClickListener() {
            public void onClick(final View view) {
                ...
                if (view == AlertController.this.mButtonPositive && AlertController.this.mButtonPositiveMessage != null) {
                    message2 = Message.obtain(AlertController.this.mButtonPositiveMessage);
                }
                else if (view == AlertController.this.mButtonNegative && AlertController.this.mButtonNegativeMessage != null) {
                    message2 = Message.obtain(AlertController.this.mButtonNegativeMessage);
                }
                    ...
                    message2 = message;
                    if (AlertController.this.mButtonNeutralMessage != null) {
                        message2 = Message.obtain(AlertController.this.mButtonNeutralMessage);
                    }
                }
                if (message2 != null) {
    ...
    @Nullable
    private ViewGroup resolvePanel(@Nullable View view, @Nullable final View view2) {
        if (view != null) {
            if (view2 != null) {
    ...
    private void setupView() {
        ...
        final boolean b = resolvePanel != null && resolvePanel.getVisibility() != 8;
        final boolean b2 = resolvePanel3 != null && resolvePanel3.getVisibility() != 8;
        ...
        if (!b) {
            if (resolvePanel2 != null) {
                final View viewById9 = resolvePanel2.findViewById(R.id.textSpacerNoTitle);
                if (viewById9 != null) {
            ...
            if (this.mMessage == null && this.mListView == null) {
                ...
                viewById10 = resolvePanel.findViewById(R.id.titleDividerNoCustom);
            }
            if (viewById10 != null) {
        ...
        if (this.mListView instanceof RecycleListView) {
            ((RecycleListView)this.mListView).setHasDecor(b, b2);
        }
        if (n2 == 0) {
            Object o;
            if (this.mListView == null) {
            ...
            if (o != null) {
                ...
                this.setScrollIndicators(resolvePanel2, (View)o, (b3 ? 1 : 0) | n, 3);
            }
        }
            ...
            if (!this.mIsMultiChoice) {
                ...
                mAdapter = new CursorAdapter(this.mContext, this.mCursor, false) {
                    ...
                    public void bindView(final View view, final Context context, final Cursor cursor) {
                        ...
                        mListView.setItemChecked(cursor.getPosition(), cursor.getInt(this.mIsCheckedIndex) == 1);
                    }
