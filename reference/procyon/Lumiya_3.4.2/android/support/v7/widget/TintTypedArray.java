...
public class TintTypedArray
{
    ...
    @Nullable
    public Typeface getFont(@StyleableRes int resourceId, final int n, @NonNull final TextView textView) {
        resourceId = this.mWrapped.getResourceId(resourceId, 0);
        if (resourceId != 0) {
            if (this.mTypedValue == null) {
                this.mTypedValue = new TypedValue();
            }
            return ResourcesCompat.getFont(this.mContext, resourceId, this.mTypedValue, n, textView);
        }
        return null;
    }
