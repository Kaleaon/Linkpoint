...
abstract class AbsActionBarView extends ViewGroup
{
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int n, final long n2) {
        ...
        if (n != 0) {
            final ViewPropertyAnimatorCompat alpha = ViewCompat.animate((View)this).alpha(0.0f);
        ...
        final ViewPropertyAnimatorCompat alpha2 = ViewCompat.animate((View)this).alpha(1.0f);
