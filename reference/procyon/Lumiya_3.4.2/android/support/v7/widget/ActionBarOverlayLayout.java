...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent
{
    ...
    protected boolean fitSystemWindows(final Rect rect) {
        ...
        int applyInsets = this.applyInsets((View)this.mActionBarTop, rect, true, true, false, true) ? 1 : 0;
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        final int max2 = Math.max(0, layoutParams.bottomMargin + (this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin));
        ...
        final int max4 = Math.max(max2, layoutParams2.bottomMargin + (this.mContent.getMeasuredHeight() + layoutParams2.topMargin));
    ...
    public void setOverlayMode(final boolean mOverlayMode) {
        ...
        if (!(this.mOverlayMode = mOverlayMode)) {
            mIgnoreWindowContentOverlay = b;
        }
        else {
            mIgnoreWindowContentOverlay = b;
