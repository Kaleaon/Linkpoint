        ...
        public View$AccessibilityDelegate newAccessibilityDelegateBridge(final AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return new View$AccessibilityDelegate() {
                ...
                public AccessibilityNodeProvider getAccessibilityNodeProvider(final View view) {
                    final AccessibilityNodeProvider accessibilityNodeProvider = null;
                    final AccessibilityNodeProviderCompat accessibilityNodeProvider2 = accessibilityDelegateCompat.getAccessibilityNodeProvider(view);
                    AccessibilityNodeProvider accessibilityNodeProvider3;
                    if (accessibilityNodeProvider2 == null) {
                        accessibilityNodeProvider3 = accessibilityNodeProvider;
                    }
                    else {
                        accessibilityNodeProvider3 = (AccessibilityNodeProvider)accessibilityNodeProvider2.getProvider();
                    }
