...
class MediaSessionCompatApi21
{
    ...
    public static boolean hasCallback(Object value) {
        boolean b = false;
        try {
            final Field declaredField = value.getClass().getDeclaredField("mCallback");
    ...
    interface Callback
    {
        ...
        void onSetRating(final Object p0, final Bundle p1);
