...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild
{
    ...
    public SwipeRefreshLayout(final Context context, final AttributeSet set) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(final float n, final Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((int)((mSpinnerOffsetEnd - SwipeRefreshLayout.this.mFrom) * n) + SwipeRefreshLayout.this.mFrom - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    private void moveSpinner(final float a) {
        ...
        this.mProgress.setStartEndTrim(0.0f, Math.min(0.8f, 0.8f * b));
        this.mProgress.setArrowScale(Math.min(1.0f, b));
        this.mProgress.setProgressRotation((0.4f * b - 0.25f + 2.0f * n2) * 0.5f);
        this.setTargetOffsetTopAndBottom(n3 + mOriginalOffsetTop - this.mCurrentTargetOffsetTop);
    }
    ...
    public void onNestedPreScroll(final View view, int n, final int n2, final int[] array) {
        ...
        if (this.dispatchNestedPreScroll(n - array[0], n2 - array[1], mParentScrollConsumed, null)) {
            ...
            n = array[1];
            array[1] = mParentScrollConsumed[1] + n;
        }
    }
    ...
    public void onNestedScroll(final View view, int a, final int n, final int n2, final int n3) {
        ...
        a = this.mParentOffsetInWindow[1] + n3;
