...
public abstract class AutoScrollHelper implements View$OnTouchListener
{
    ...
    boolean shouldAnimate() {
        ...
        if (horizontalDirection != 0) {
            if (this.canTargetScrollHorizontally(horizontalDirection)) {
                return true;
            }
        }
        return b;
    ...
    private static class ClampedScroller
    {
        ...
        private float getValueAt(final long n) {
            ...
            if (n4 == 0) {
                ...
                if (n5 != 0) {
                    return AutoScrollHelper.constrain((n - this.mStopTime) / (float)this.mEffectiveRampDown, 0.0f, 1.0f) * this.mStopValue + (1.0f - this.mStopValue);
                }
            }
