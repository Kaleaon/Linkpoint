...
public class FragmentTabHost extends TabHost implements TabHost$OnTabChangeListener
{
    ...
    @Nullable
    private FragmentTransaction doTabChanged(@Nullable final String s, @Nullable FragmentTransaction beginTransaction) {
    ...
    protected void onAttachedToWindow() {
        ...
        for (int size = this.mTabs.size(), i = 0; i < size; ++i, beginTransaction = fragmentTransaction) {
