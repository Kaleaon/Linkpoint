...
public abstract class FragmentHostCallback<E> extends FragmentContainer
{
    ...
    void dumpLoaders(final String str, final FileDescriptor fileDescriptor, final PrintWriter printWriter, final String[] array) {
        ...
        if (this.mLoaderManager != null) {
            ...
            printWriter.println(":");
            this.mLoaderManager.dump(str + "  ", fileDescriptor, printWriter, array);
        }
    }
    ...
    LoaderManagerImpl getLoaderManager(final String s, final boolean b, final boolean b2) {
        ...
        else if ((loaderManagerImpl3 = loaderManagerImpl) != null) {
            loaderManagerImpl3 = loaderManagerImpl;
