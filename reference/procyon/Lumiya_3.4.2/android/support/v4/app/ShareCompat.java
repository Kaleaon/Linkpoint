...
public final class ShareCompat
{
    ...
    public static String getCallingPackage(final Activity activity) {
        ...
        if (callingPackage != null) {
            stringExtra = callingPackage;
        }
        else {
            stringExtra = activity.getIntent().getStringExtra("android.support.v4.app.EXTRA_CALLING_PACKAGE");
        }
        return stringExtra;
    }
                        ...
                        if (char1 != '&') {
                            if (char1 <= '~' && char1 >= ' ') {
                                ...
                                if (char1 != ' ') {
                                    ...
                                    while (n2 + 1 < n && charSequence.charAt(n2 + 1) == ' ') {
                                        sb.append("&nbsp;");
                                        ++n2;
                                    }
                                    sb.append(' ');
