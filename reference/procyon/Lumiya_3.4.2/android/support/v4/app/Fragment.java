...
public class Fragment implements ComponentCallbacks, View$OnCreateContextMenuListener, LifecycleOwner
{
    ...
    public static Fragment instantiate(final Context context, final String s, @Nullable final Bundle bundle) {
        try {
            final Class clazz = Fragment.sClassMap.get(s);
            Class<?> loadClass;
            if (clazz != null) {
                loadClass = clazz;
            }
            ...
            throw new InstantiationException("Unable to instantiate fragment " + s + ": could not find Fragment constructor", ex4);
        }
        catch (final InvocationTargetException ex5) {
            throw new InstantiationException("Unable to instantiate fragment " + s + ": calling Fragment constructor caused an exception", ex5);
        }
    }
    
    static boolean isSupportFragmentClass(final Context context, final String name) {
        try {
            final Class clazz = Fragment.sClassMap.get(name);
            Class<?> loadClass;
            if (clazz != null) {
                loadClass = clazz;
            }
    ...
    boolean performCreateOptionsMenu(final Menu menu, final MenuInflater menuInflater) {
        ...
        if (!this.mHidden) {
            ...
            b = (n != 0);
            if (this.mChildFragmentManager != null) {
                b = ((n | (this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater) ? 1 : 0)) != 0x0);
            }
        }
        return b;
    }
    ...
    boolean performPrepareOptionsMenu(final Menu menu) {
        ...
        if (!this.mHidden) {
            ...
            b = (n != 0);
            if (this.mChildFragmentManager != null) {
                b = ((n | (this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu) ? 1 : 0)) != 0x0);
            }
        }
        return b;
    }
    ...
    public void setTargetFragment(final Fragment mTarget, final int mTargetRequestCode) {
        ...
        if (mTarget != null) {
            fragmentManager = mTarget.getFragmentManager();
        }
    ...
    public void setUserVisibleHint(final boolean mUserVisibleHint) {
        ...
        if (this.mState < 4 && !mUserVisibleHint) {
            mDeferStart = true;
        }
        this.mDeferStart = mDeferStart;
    }
