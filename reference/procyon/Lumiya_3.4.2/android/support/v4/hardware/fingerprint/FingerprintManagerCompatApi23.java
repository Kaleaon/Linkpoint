...
public final class FingerprintManagerCompatApi23
{
    ...
    static void authenticate(final Context context, final CryptoObject cryptoObject, final int n, final Object o, final AuthenticationCallback authenticationCallback, final Handler handler) {
    ...
    @SuppressLint({ "MissingPermission" })
    static boolean isHardwareDetected(final Context context) {
        boolean b = false;
        final FingerprintManager fingerprintManagerOrNull = getFingerprintManagerOrNull(context);
