...
public class VectorDrawableCompat extends VectorDrawableCommon
{
    ...
    private void inflateInternal(final Resources resources, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) throws XmlPullParserException, IOException {
            ...
            if (n != 2) {
                ...
                if (!"path".equals(name)) {
                    if (!"clip-path".equals(name)) {
                        ...
                        final VClipPath e = new VClipPath();
                    ...
                    final VFullPath e2 = new VFullPath();
        ...
        obj.append("path");
        throw new XmlPullParserException("no " + (Object)obj + " defined");
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        final int b = (int)(abs * this.mTmpBounds.width());
        final int b2 = (int)(abs2 * this.mTmpBounds.height());
    ...
    public boolean isStateful() {
        ...
        if (this.mDelegateDrawable == null) {
            if (!super.isStateful()) {
                ...
                b2 = b;
                if (this.mVectorState.mTint == null) {
                    return b2;
                }
                if (!this.mVectorState.mTint.isStateful()) {
                    b2 = b;
                    return b2;
                }
            }
    ...
    private static class VGroup
    {
        ...
        public VGroup(VGroup vGroup, final ArrayMap<String, Object> arrayMap) {
            ...
            for (int i = 0; i < mChildren.size(); ++i) {
                final Object value = mChildren.get(i);
                if (!(value instanceof VGroup)) {
                    VPath e;
        ...
        private void drawPath(final VGroup vGroup, final VPath vPath, final Canvas canvas, final int n, final int n2, final ColorFilter colorFilter) {
            ...
            if (!vPath.isClipPath()) {
                ...
                if (vFullPath.mStrokeColor != 0) {
                    ...
                    mStrokePaint.setStrokeWidth(matrixScale * min * vFullPath.mStrokeWidth);
