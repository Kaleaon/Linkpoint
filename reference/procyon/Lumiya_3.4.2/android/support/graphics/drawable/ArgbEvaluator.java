...
public class ArgbEvaluator implements TypeEvaluator
{
    ...
    public Object evaluate(final float n, final Object o, final Object o2) {
        ...
        return Math.round((float)Math.pow(n12 + ((float)Math.pow(n9, 2.2) - n12) * n, 0.45454545454545453) * 255.0f) | (Math.round((n2 + (n6 - n2) * n) * 255.0f) << 24 | Math.round((float)Math.pow(n10 + ((float)Math.pow(n7, 2.2) - n10) * n, 0.45454545454545453) * 255.0f) << 16 | Math.round((float)Math.pow(n11 + ((float)Math.pow(n8, 2.2) - n11) * n, 0.45454545454545453) * 255.0f) << 8);
    }
}
