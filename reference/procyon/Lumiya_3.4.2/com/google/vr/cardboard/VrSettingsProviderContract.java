...
public class VrSettingsProviderContract
{
    ...
    public static Uri createUri(final String s, final String s2) {
        final String value = String.valueOf("content://");
        return Uri.parse(new StringBuilder(String.valueOf(value).length() + 1 + String.valueOf(s).length() + String.valueOf(s2).length()).append(value).append(s).append("/").append(s2).toString());
    }
}
