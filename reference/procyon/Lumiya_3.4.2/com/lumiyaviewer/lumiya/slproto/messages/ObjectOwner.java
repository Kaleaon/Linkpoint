...
public class ObjectOwner extends SLMessage
{
    ...
    public void PackPayload(final ByteBuffer byteBuffer) {
        ...
        this.packUUID(byteBuffer, this.HeaderData_Field.OwnerID);
        this.packUUID(byteBuffer, this.HeaderData_Field.GroupID);
    ...
    public void UnpackPayload(final ByteBuffer byteBuffer) {
        ...
        this.HeaderData_Field.OwnerID = this.unpackUUID(byteBuffer);
        this.HeaderData_Field.GroupID = this.unpackUUID(byteBuffer);
