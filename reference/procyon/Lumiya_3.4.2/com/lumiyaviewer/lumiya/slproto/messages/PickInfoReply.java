...
public class PickInfoReply extends SLMessage
{
    ...
    public void PackPayload(final ByteBuffer byteBuffer) {
        ...
        this.packVariable(byteBuffer, this.Data_Field.User, 1);
        this.packVariable(byteBuffer, this.Data_Field.OriginalName, 1);
    ...
    public void UnpackPayload(final ByteBuffer byteBuffer) {
        ...
        this.Data_Field.User = this.unpackVariable(byteBuffer, 1);
        this.Data_Field.OriginalName = this.unpackVariable(byteBuffer, 1);
