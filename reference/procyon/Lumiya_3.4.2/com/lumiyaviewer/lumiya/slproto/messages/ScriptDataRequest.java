...
public class ScriptDataRequest extends SLMessage
{
    ...
    public int CalcPayloadSize() {
        ...
        while (iterator.hasNext()) {
            n += iterator.next().Request.length + 11;
        }
        return n;
    }
    ...
    public void PackPayload(final ByteBuffer byteBuffer) {
        ...
        for (final DataBlock dataBlock : this.DataBlock_Fields) {
            ...
            this.packByte(byteBuffer, (byte)dataBlock.RequestType);
            this.packVariable(byteBuffer, dataBlock.Request, 2);
        }
    }
    ...
    public void UnpackPayload(final ByteBuffer byteBuffer) {
        ...
        for (int i = 0; i < (value & 0xFF); ++i) {
            ...
            e.RequestType = this.unpackByte(byteBuffer);
            e.Request = this.unpackVariable(byteBuffer, 2);
