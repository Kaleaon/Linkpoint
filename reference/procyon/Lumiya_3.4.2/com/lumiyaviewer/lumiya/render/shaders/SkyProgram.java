...
public class SkyProgram extends ShaderProgram
{
    ...
    public SkyProgram(final Shader shader) {
        super(Shader.SkyVertexShader, shader);
    }
    
    public void ApplyWindlight(final RenderContext renderContext) {
        final WindlightPreset windlightPreset = renderContext.windlightPreset;
