...
# Smart Gradle Wrapper for Linkpoint
# Automatically detects architecture and configures environment
...
# Function to detect and setup environment automatically
auto_setup_environment() {
    ...
    echo -e "${BLUE}🤖 Auto-detected environment for $arch${NC}"
    if [ -n "$JAVA_HOME" ]; then
