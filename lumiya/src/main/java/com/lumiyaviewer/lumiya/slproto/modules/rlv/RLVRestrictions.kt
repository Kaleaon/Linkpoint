...
class RLVRestrictions {
    ...
    private class RLVRestrictionList {
        ...
        Boolean isAllowed(com.lumiyaviewer.lumiya.slproto.modules.rlv.RLVRestrictionType.RLVRuleMatchType r6, java.lang.String r7, java.util.UUID r8, java.util.UUID r9) {
            /*
                r5 = this
                r4 = 1
                r3 = 0
