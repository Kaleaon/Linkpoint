...
class ChatterSubscription {
    ...
    private Subscription.OnData<UnreadMessageInfo> onUnreadCount = Subscription.OnData(this) {
        ...
        /* renamed from: -$f0 */
        private /* synthetic */ Any f223$f0

        private /* synthetic */ Unit $m$0(
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$x6PlkRNg0xExeA_EUn8oEJWcOq8.1.$m$0(java.lang.Any):Unit, dex: classes.dex
        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.users.manager.-$Lambda$x6PlkRNg0xExeA_EUn8oEJWcOq8.1.$m$0(java.lang.Any):Unit, class status: UNLOADED
