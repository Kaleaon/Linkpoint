...
class vx_req_account_web_call_t {
     ...
     */
    protected Long getCPtr(vx_req_account_web_call_t vx_req_account_web_call_t2) {
    ...
    Unit setParameter_count(Int n) {
        VxClientProxyJNI.vx_req_account_web_call_t_parameter_count_set(this.swigCPtr, this, n)
    }

    Unit setParameters(SWIGTYPE_p_p_vx_name_value_pair sWIGTYPE_p_p_vx_name_value_pair) {
    ...
    Unit setRelative_path(String string2) {
