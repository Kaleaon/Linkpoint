...
class ObjectIncludeInSearchMessage : SLMessage() {
    ...
    data class ObjectDataBlock(
        ...
        var includeInSearch: Boolean = false
    )
    ...
    override fun packPayload(buffer: ByteBuffer) {
        ...
        objectData.forEach { entry ->
            ...
            packBoolean(buffer, entry.includeInSearch)
        }
    }
    ...
    override fun unpackPayload(buffer: ByteBuffer) {
        ...
        run {
            ...
            repeat(count) {
                ...
                entry.includeInSearch = unpackBoolean(buffer)
                objectData += entry
            }
        }
    }
