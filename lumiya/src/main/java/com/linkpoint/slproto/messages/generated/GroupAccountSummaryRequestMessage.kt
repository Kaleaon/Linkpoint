...
class GroupAccountSummaryRequestMessage : SLMessage() {
    ...
    override fun getMessageID(): Int = 0xFFFF0161.toInt()

    override fun getMessageName(): String = "GroupAccountSummaryRequest"
}
