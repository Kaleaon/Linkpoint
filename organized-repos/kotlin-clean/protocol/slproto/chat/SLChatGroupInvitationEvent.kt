...
val class SLChatGroupInvitationEvent : SLChatYesNoEvent() {
    private val UUID groupID
    private val Int joinFee
    ...
    public /* synthetic */ Unit m143lambda$com_lumiyaviewer_lumiya_slproto_chat_SLChatGroupInvitationEvent_3561(DialogInterface dialogInterface, Int i) {
...
/*
Method generation error in method: com.lumiyaviewer.lumiya.slproto.chat.-$Lambda$hXLxI3fDexZfuKx5RzOoCtsGy3I.1.$m$0(android.content.DialogInterface, Int):Unit, dex: classes.dex
            jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.lumiyaviewer.lumiya.slproto.chat.-$Lambda$hXLxI3fDexZfuKx5RzOoCtsGy3I.1.$m$0(android.content.DialogInterface, Int):Unit, class status: UNLOADED
